...
THEN DO:
   ...
   fCreateDPSubject(giDPId, "CONTFH3G_50").
...
THEN DO:
   fCreateDPSubject(giDPId, "CONTDSL3G"). /* NOT VERIFIED IF THIS IS NEEDED */
   fCreateDPSubject(giDPId, "CONTFH3G_50"). /* NOT VERIFIED IF THIS IS NEEDED */
