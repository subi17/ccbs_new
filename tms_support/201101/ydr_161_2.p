...
def stream sout.
output stream sout to /apps/yoigo/tms_support/201101/ydr_161_2.txt append.
...
FOR EACH MNPOperation WHERE
   ...
   MNPOperation.errordesc = "Cancellation proposal already exists" NO-LOCK, 
