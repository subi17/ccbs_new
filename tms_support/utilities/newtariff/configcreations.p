...
PROCEDURE pRatePlan:
    ...
    FIND FIRST bf_RatePlanCopyFrom WHERE bf_RatePlanCopyFrom.Brand = Syst.CUICommon:gcBrand AND bf_RatePlanCopyFrom.RatePlan = icReferenceRatePlan NO-LOCK NO-ERROR.
    IF AVAIL bf_RatePlanCopyFrom THEN 
    DO:
        FIND FIRST RatePlan WHERE RatePlan.Brand = Syst.CUICommon:gcBrand AND RatePlan.RatePlan = icRatePlan NO-LOCK NO-ERROR.
        ...
        DO:
            ...
            FOR EACH bf_PListConfCopyFrom WHERE bf_PListConfCopyFrom.Brand    = Syst.CUICommon:gcBrand                      AND 
                ...
                DO:
                    ...
                    FIND FIRST PriceList WHERE PriceList.Brand = Syst.CUICommon:gcBrand AND PriceList.PriceList = bf_PListConfCopyFrom.PriceList NO-LOCK NO-ERROR.
                    ...
                    DO:
                        ...
                        FOR EACH Tariff WHERE Tariff.Brand = Syst.CUICommon:gcBrand AND Tariff.PriceList = PriceList.PriceList NO-LOCK:                     
                            CREATE bTariff.
...
PROCEDURE pCustomRates:    
    ...
    FIND FIRST Tariff WHERE Tariff.Brand      = Syst.CUICommon:gcBrand            AND 
...
PROCEDURE pCLIType:
   ...
   IF NOT CAN-FIND(FIRST CLIType WHERE CLIType.Brand = Syst.CUICommon:gcBrand AND CLIType.CLIType = ttCliType.CliType) THEN 
   DO:     
      ...
      DO:   
         FIND FIRST CLIType WHERE CLIType.Brand = Syst.CUICommon:gcBrand AND CLIType.CLIType = ttCLIType.ParentTariff NO-LOCK NO-ERROR.                
      ...
      DO:
         ...
         FOR EACH Requestaction NO-LOCK WHERE Requestaction.Clitype = ttCliType.CopyServicesFromCliType:
             ...
             IF NOT CAN-FIND(FIRST bf_RequestAction WHERE bf_RequestAction.Brand      = Syst.CUICommon:gcBrand                  AND
             ...
             DO:
                 ...
                 ASSIGN     
                    bf_RequestAction.Brand           = Syst.CUICommon:gcBrand
...
PROCEDURE pCTServPac:
   ...
   FOR EACH bf_CTServPac_CopyFrom WHERE bf_CTServPac_CopyFrom.Brand = Syst.CUICommon:gcBrand AND bf_CTServPac_CopyFrom.CLIType = icCopyServicesFromCliType NO-LOCK
       ON ERROR UNDO, THROW:
      ...
      FOR EACH bf_CTServEl_CopyFrom WHERE bf_CTServEl_CopyFrom.Brand = Syst.CUICommon:gcBrand AND bf_CTServEl_CopyFrom.CLIType = bf_CTServPac_CopyFrom.CLIType AND bf_CTServEl_CopyFrom.ServPac = bf_CTServPac_CopyFrom.ServPac NO-LOCK
          ON ERROR UNDO, THROW:
         ...
         FIND ServCom WHERE ServCom.Brand = Syst.CUICommon:gcBrand AND ServCom.ServCom = CTServEl.ServCom NO-LOCK NO-ERROR.
...
PROCEDURE pSLGAnalyse:
    ...
    FIND FIRST bf_CliTypeCF WHERE bf_CliTypeCF.Brand = Syst.CUICommon:gcBrand AND bf_CliTypeCF.ClIType = icCliTypeCopyFrom NO-LOCK NO-ERROR.    
       ...
       ON ERROR UNDO, THROW:
        ...
        DO liCnt = 1 TO NUM-ENTRIES(lcConvergentBillCodeList)
           ON ERROR UNDO, THROW:
            ...
            FIND FIRST bf_SLGAnalyse WHERE bf_SLGAnalyse.Brand             = Syst.CUICommon:gcBrand                               AND 
        ...
        DO liCnt = 1 TO NUM-ENTRIES(lcConvergentBillCodeList)
           ON ERROR UNDO, THROW:
            ...
            IF AVAIL bf_SLGAnalyse THEN
            DO:
                IF NOT CAN-FIND(FIRST SLGAnalyse WHERE SLGAnalyse.Brand             = Syst.CUICommon:gcBrand                AND
        ...
        DO:
            ...
            FOR EACH bf_SLGAnalyse WHERE bf_SLGAnalyse.Brand             = Syst.CUICommon:gcBrand                         AND 
...
PROCEDURE pDayCampaign:
   ...
   IF NOT CAN-FIND(FIRST DayCampaign WHERE DayCampaign.Brand = Syst.CUICommon:gcBrand AND DayCampaign.DCEvent = ttDayCampaign.DCEvent) THEN
   DO:
      CREATE DayCampaign.
      ASSIGN 
...
PROCEDURE pFeeModel:
   ...
   FIND FIRST FeeModel WHERE FeeModel.Brand = Syst.CUICommon:gcBrand AND FeeModel.FeeModel = icFeeModel NO-LOCK NO-ERROR.    
...
PROCEDURE pFMItem:   
   ...
   DO:
       ...
       FIND FIRST RatePlan WHERE RatePlan.Brand = Syst.CUICommon:gcBrand AND RatePlan.RatePlan = lcRatePlan NO-LOCK NO-ERROR.           
       IF AVAIL RatePlan THEN   
          FIND FIRST PListConf WHERE PListConf.Brand = Syst.CUICommon:gcBrand AND PListConf.RatePlan = RatePlan.RatePlan AND PListConf.PriceList BEGINS "CONTRATO" NO-LOCK NO-ERROR.   
   END.
...
PROCEDURE pServiceLimitGroup:
   ...
   FIND FIRST ServiceLimitGroup WHERE ServiceLimitGroup.Brand = Syst.CUICommon:gcBrand AND ServiceLimitGroup.GroupCode = ttServiceLimitGroup.GroupCode NO-LOCK NO-ERROR.
...
PROCEDURE pBDestination:
    ...
    FIND FIRST BDest WHERE BDest.Brand = Syst.CUICommon:gcBrand AND BDest.BDest = ttBDest.BDest NO-LOCK NO-ERROR. 
...
PROCEDURE pRequestAction:
   ...
   FIND FIRST CliType WHERE ClIType.Brand = Syst.CUICommon:gcBrand AND CliType.ClIType = icCLIType NO-LOCK NO-ERROR.
   ...
   DO liCount = 1 TO NUM-ENTRIES(lcRequestTypeList)
      ...
      FIND FIRST RequestAction WHERE RequestAction.Brand      = Syst.CUICommon:gcBrand         AND
...
PROCEDURE pMatrix:
   ...
   FIND FIRST Matrix WHERE Matrix.Brand = Syst.CUICommon:gcBrand AND Matrix.MXKey = "PERCONTR" AND Matrix.MxName = icCLIType NO-LOCK NO-ERROR.
...
PROCEDURE pUpdateTMSParam:
   ...
   FIND FIRST TMSParam WHERE TMSParam.Brand = Syst.CUICommon:gcBrand  AND TMSParam.ParamCode EQ icParamCode NO-LOCK NO-ERROR.
