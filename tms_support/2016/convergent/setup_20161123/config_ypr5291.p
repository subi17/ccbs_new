...
END.
ELSE DO:
   create_mxitem("SubsTypeTo","CONTFH40_50",matrix.MxSeq).
END.
RELEASE matrix.
...
END.
ELSE DO:
   create_mxitem("SubsTypeTo","CONTFH50_300",matrix.MxSeq).
END.
RELEASE matrix.

/*Mobile part matrix*/

liSeq = create_matrix("PERCONTR", "Convergent 1.2GB  mobile").
create_mxitem("PerContract","CONT9",liSeq).
create_mxitem("PerContract","DATA6",liSeq).
create_mxitem("SubsTypeTo","CONTDSL40",liSeq).
...
IF LOOKUP("CONTDSL40", TMSParam.charval) = 0 THEN
TMSParam.charval = tmsParam.charval + ",CONTDSL40,CONTFH40_50," +
                   "CONTFH50_300".
...
/*requestaction*/
         /*BASE        TYPE*/
create_ra("CONTDSL45","CONTDSL40",liExec).
create_ra("CONTFH45_50","CONTFH40_50",liExec).
create_ra("CONTFH55_300","CONTFH50_300",liExec).

create_ra_mob("CONTDSL45","CONTDSL40","CONT9",liExec).
create_ra_mob("CONTFH45_50","CONTFH40_50","CONT9",liExec).
create_ra_mob("CONTFH55_300","CONTFH50_300","CONT9",liExec).

/*clean services */
fCleanServicePac("CONTDSL40").
fCleanServicePac("CONTFH40_50").
fCleanServicePac("CONTFH50_300").
...
fAddServEl("CONTDSL40","CONT9").
fAddServEl("CONTFH40_50","CONT9").
fAddServEl("CONTFH50_300","CONT9").
