...
/*function removes sertvices that are available for CONTDSL45*/
...
END.
ELSE DO:
   create_mxitem("SubsTypeTo","CONTFH58_50",matrix.MxSeq).
END.
RELEASE matrix.
...
END.
ELSE DO:
   create_mxitem("SubsTypeTo","CONTFH68_300",matrix.MxSeq).
END.
RELEASE matrix.

liSeq = create_matrix("PERCONTR", "Convergent 20GB mobile").
create_mxitem("PerContract","CONT24",liSeq).
create_mxitem("PerContract","DATA6",liSeq).
create_mxitem("SubsTypeTo","CONTDSL58",liSeq).
create_mxitem("SubsTypeTo","CONTFH58_50",liSeq).
create_mxitem("SubsTypeTo","CONTFH68_300",liSeq).
...
IF LOOKUP("CONTDSL58", TMSParam.charval) = 0 THEN
TMSParam.charval = tmsParam.charval + ",CONTDSL58,CONTFH58_50," +
                   "CONTFH68_300".
...
/*requestaction*/
create_ra("CONTDSL45","CONTDSL58",liExec).
create_ra("CONTFH45_50","CONTFH58_50",liExec).
create_ra("CONTFH55_300","CONTFH68_300",liExec).

create_ra_mob("CONTDSL45","CONTDSL58","CONT24",liExec).
create_ra_mob("CONTFH45_50","CONTFH58_50","CONT24",liExec).
create_ra_mob("CONTFH55_300","CONTFH68_300","CONT24",liExec).

/*clean services */
fCleanServicePac("CONTDSL58").
fCleanServicePac("CONTFH58_50").
fCleanServicePac("CONTFH68_300").
