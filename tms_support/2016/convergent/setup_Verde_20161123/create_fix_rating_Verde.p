...
create_tmritem("CONT15_DATA_IN,CONTDSL48",14).
create_tmritem("CONT15_DATA_IN,CONTFH48_50",14).
create_tmritem("CONT15_DATA_IN,CONTFH58_300",14).
...
fcreateSLGAnalyse("CONTDSL45","CONTDSL48",ldaFrom,"CONTDSL48",liMode,
                  "CONTS2GB","CONT15").
fcreateSLGAnalyse("CONTFH45_50","CONTFH48_50",ldaFrom,"CONTFH48_50",liMode,
                  "CONTS2GB","CONT15").
fcreateSLGAnalyse("CONTFH55_300","CONTFH58_300",ldaFrom,"CONTFH58_300",liMode,
                  "CONTS2GB","CONT15").
