...
DEFINE VARIABLE ldeDumpStart AS DECIMAL NO-UNDO.
DEFINE VARIABLE ldeDumpEnd AS DECIMAL NO-UNDO. 

DEF STREAM sLogInvGrain.
DEF STREAM sduration.
OUTPUT STREAM sduration TO "/home/jannetou/Friday_12122014_BillingItemsTotal_duration.log".
...
ldeDumpStart = Func.Common:mMakeTS().
...
/*
lcInvGrainFile = "/home/jannetou/invoice_row_dump_test_#DATE.txt".
...
icFileName = "/home/jannetou/billing_item_totals_#DATE.log".
...
*/
/*  friday 12122014 commented out ends here
PUT STREAM sLogInvGrain UNFORMATTED SKIP.
...
ldeDumpEnd = Func.Common:mMakeTS().
PUT STREAM sduration UNFORMATTED
"Dump Friday 12122014 BillItem_Totals_DUMP started: " Func.Common:mTS2HMS(ldeDumpStart) SKIP
"Dump Friday 12122014 BillItem_Totals_DUMP ended: " Func.Common:mTS2HMS(ldeDumpEnd) SKIP.
