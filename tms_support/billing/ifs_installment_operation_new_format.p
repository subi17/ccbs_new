...
DEFINE VARIABLE ldaFrom AS DATE NO-UNDO INIT 03/17/2014.
DEFINE VARIABLE ldaTo AS DATE NO-UNDO INIT 03/24/2014.
...
FOR EACH ttInstallment:
   ...
   PUT STREAM sLog UNFORMATTED
      ...
      ttInstallment.ResidualAmount lcDelimiter
      SKIP.
END.
...
PROCEDURE pCollectActivations:
   ...
   FOR EACH MsRequest NO-LOCK WHERE
      ...
      ASSIGN
         ...
         ttInstallment.ResidualAmount = (IF AVAIL SingleFee THEN SingleFee.Amt ELSE 0).
