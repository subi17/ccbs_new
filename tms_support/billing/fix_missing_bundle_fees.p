...
def stream sout.
output stream sout to /apps/yoigo/tms_support/billing/fix_missing_bundle_fees.log append.
   ...
   FOR EACH mservicelimit where
      ...
      IF NOT AVAIL fixedfee then do:
         ...
         do trans:
            ...
            bMServicelimit.Fromts = stcrequest.donestamp.
            ...
            RUN Mc/creasfee.p (mobsub.CustNum,
                          ...
                          9,
                          ?,
                          servicelimit.groupcode + " created " + 
                             STRING(TODAY,"99.99.9999") +  /* memo */
                          "¤" + servicelimit.groupcode,    /* calcobject */
                          FALSE,              /* no messages to screen */
                          OUTPUT lcReqChar).  
             put stream sout unformatted "|" lcReqChar skip.
             i = i + 1.
             disp i. 
             pause 0.
         end.
