...
def stream sread.
input stream sread from /apps/snet/200808/credit_080828.txt.

def stream slog.
output stream slog to /apps/snet/200808/aam_ycm839.log append.
...
repeat:
   ...
   assign
      lcinv = entry(1,lcline,chr(9))
      lccli = entry(3,lcline,chr(9)).
   ...
   if invoice.invdate ne 8/1/8 or
      invoice.invtype ne 1 or
      invoice.cli ne lccli 
   then do:
