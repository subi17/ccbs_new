...
def stream sread.
input stream sread from credit_fraud_orders_201008.csv.

def stream slog.
output stream slog to credit_fraud_orders_201008.log.
...
repeat:
   ...
   liorderid = integer(entry(2,lcline,"|")) no-error.
   ...
   assign Memo.Brand     = "1"
          ...
          Memo.MemoText  = "Credited by Yoigo, YOT-889".
