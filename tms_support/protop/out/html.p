...
procedure html_display:
  ...
  if cHtmlDir <> gcPrevHtmlDir then RUN tms_support/protop/out/html_init.
  ...
  for each tt_ui-hdr no-lock 
      ...
      RUN tms_support/protop/out/html_blank ( cHtmlDir + substitute('&1_&2.html'
   ...
   */
  RUN tms_support/protop/out/html_blank ( cHtmlDir + 'blank.html').
  ...
  for each tt_ui-hdr no-lock 
    ...
    do:
      ...
      RUN tms_support/protop/out/html_header.
    ...
    do:
      ...
      RUN tms_support/protop/out/html_links.
      ...
      RUN tms_support/protop/out/html_rename ( input cHtmlDir + 'temp.html',
...
procedure html_init:
  /* write static pages */
  RUN tms_support/protop/out/html_css.
  RUN tms_support/protop/out/html_framesets.
  RUN tms_support/protop/out/html_title.
...
RUN tms_support/protop/out/html_init.
return.
