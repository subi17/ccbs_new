...
procedure mon-init:
  ...
  /* define labels (experimental -- still needs lots of work)
   *
   * display type
   * variation#
   * field number
  ...
  x_ui-define-label( support, 1,  1, "xid",        "Id",        3, "r", "i,#", "" ).
  x_ui-define-label( support, 1,  2, "xname",      "Resource", 20, "l", "r",   "" ).
  x_ui-define-label( support, 1,  5, "stat1",      "Locks",    10, "r", "l",   "descending" ).
  x_ui-define-label( support, 1,  6, "stat2",      "Waits",    10, "r", "w",   "descending" ).
  x_ui-define-label( support, 1,  8, "stat-ratio", "%Lock",     7, "r", "%",   "descending" ).
