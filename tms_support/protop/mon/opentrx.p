 ...
 *
 *
 * Open trx monitoring (ALL transactions -- including "allocated").
 *
 *
 * Author:
 *
...
procedure mon-update:
  ...
  do-display( support, 1, 100, 11, 1, "Open Transactions" ).
  ...
  do while true:
    ...
    if tt_trx.trx-st = "Allocated" then
      ui-det( support, 1, i, 4, "TrxRL", string( "       -", "x(8)" )).
     else
