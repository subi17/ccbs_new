 ...
 ***/
  ...
  if not available tt_index then
    do:
      ...
      if available _IndexStat then		/* _IndexStat range may not be active...	*/
        assign
          {protop/lib/init-xrec.i tt_index.idx-blkdel _IndexStat-blockdelete}
          {protop/lib/init-xrec.i tt_index.idx-cre    _IndexStat-create}
          {protop/lib/init-xrec.i tt_index.idx-del    _IndexStat-delete}
          {protop/lib/init-xrec.i tt_index.idx-rd     _IndexStat-read}
          {protop/lib/init-xrec.i tt_index.idx-split  _IndexStat-split}
        .
    end.
   else
    tt_index.xvalid = yes.
  ...
  if available _IndexStat then		/* _IndexStat range may not be active...	*/
    assign
      {protop/lib/upd-xrec.i tt_index.idx-blkdel _IndexStat-blockdelete}
      {protop/lib/upd-xrec.i tt_index.idx-cre    _IndexStat-create}
      {protop/lib/upd-xrec.i tt_index.idx-del    _IndexStat-delete}
      {protop/lib/upd-xrec.i tt_index.idx-rd     _IndexStat-read}
      {protop/lib/upd-xrec.i tt_index.idx-split  _IndexStat-split}
    .
...
/***
 ***
        {protop/lib/upd-xrec.i tt_index.stat1 tt_index.stat1[3]}
        {protop/lib/upd-xrec.i tt_index.stat2 tt_index.stat2[3]}
        {protop/lib/upd-xrec.i tt_index.stat3 tt_index.stat3[3]}
