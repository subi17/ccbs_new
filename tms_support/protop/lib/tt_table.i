 ...
 **/
  ...
  if not available tt_table then
    do:
      ...
      if available _TableStat then		/* _TableStat range may not be active...	*/
        assign
          {tms_support/protop/lib/init-xrec.i tt_table.tbl-cre _TableStat-create}
          {tms_support/protop/lib/init-xrec.i tt_table.tbl-rd  _TableStat-read}
          {tms_support/protop/lib/init-xrec.i tt_table.tbl-upd _TableStat-update}
          {tms_support/protop/lib/init-xrec.i tt_table.tbl-del _TableStat-delete}
        .
    end.
   else
    tt_table.xvalid = yes.
  ...
  if available _TableStat then		/* _TableStat range may not be active...	*/
    do:
      ...
      assign
        {tms_support/protop/lib/upd-xrec.i tt_table.tbl-cre _TableStat-create}
        {tms_support/protop/lib/upd-xrec.i tt_table.tbl-rd  _TableStat-read}
        {tms_support/protop/lib/upd-xrec.i tt_table.tbl-upd _TableStat-update}
        {tms_support/protop/lib/upd-xrec.i tt_table.tbl-del _TableStat-delete}
      .
...
/***
 ***
        {tms_support/protop/lib/upd-xrec.i tt_table.stat1 tt_table.stat1[3]}
        {tms_support/protop/lib/upd-xrec.i tt_table.stat2 tt_table.stat2[3]}
        {tms_support/protop/lib/upd-xrec.i tt_table.stat3 tt_table.stat3[3]}
