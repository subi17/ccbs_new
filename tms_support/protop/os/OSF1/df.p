 ...
 *
 *
 * Free disk space (Specific to Tru64).
 *
 * $ df -k
 * Filesystem                   1024-blocks        Used   Available Capacity  Mounted on
 * cluster_root#root                9437184     2257051     7167504    24%    /
 * root1_domain#root                 262144       45773      211392    18%    /cluster/members/member1/boot_partition
 * home_domain#home                10485760      610218     9866704     6%    /home
 * oraexport_domain#oraexport      31457280    14291227    17159136    46%    /oraexport
 * standby_domain#standby          83886080    79637415     4239936    95%    /standby
 * data1_domain#data1              41943040    30533794    11392896    73%    /data1 
 *
 * Author:
 *
...
procedure mon-update:
  ...
  repeat:
    ...
    if xfs-size = 0 and xmnt = "" then					/* device name is too long, line is broken...	*/
      import xfs-size ^ xfs-free ^ xmnt no-error.
