...
output stream slog to /apps/snet/200904/wrong_custid_move.log append.

input stream sread from 
   /apps/snet/200904/as_ycm1463_move_input.txt.

ldactstamp = 20090301.00001. 
...
/*   RELEASE bOwner.     */
   ...
   IF MobSub.PayType THEN RUN pPrepaidRate(3/1/9,mobsub.cli).
   ELSE RUN pReRate(3/1/9,mobsub.cli).
