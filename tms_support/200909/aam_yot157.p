...
def stream sread.
input stream sread from /apps/snet/200909/2009ClosedOrders_MNPNumbers.csv.

def stream slog.
output stream slog to /apps/snet/200909/aam_yot157_2009.log append.
...
repeat:
   ...
   */
   ...
   assign Memo.Brand     = "1"
          ...
          Memo.MemoText  = "Credited by Yoigo, YOT-156".
