...
if sysversion == 'hebe' or sysversion == 'pallas' or sysversion == 'yoigodev':
   address = 'http://localhost:3001/fcgiproxy_xfera/'
elif sysversion == 'sadachbia' or sysversion == 'alpheratz' or sysversion == 'angetenar' or sysversion == 'yanai' or sysversion == 'barbatus':
