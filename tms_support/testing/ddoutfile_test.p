...
PROCEDURE pInitialize:
   ...
   END.
   IF LENGTH(lcCompanyBank) < 24 THEN RETURN "ERROR:Invalid bank account".
...
PROCEDURE pPrintHeader:
   ...
   FILL(" ",20)                                       /* free      */
   SUBSTRING(lcCompanyBank,5,4)                       /* bank code */
   SUBSTRING(lcCompanyBank,9,4)                       /* bank office */
   FILL(" ",12)                                       /* free      */
   FILL(" ",40)                                       /* free      */
   FILL(" ",14)                                       /* free      */
   lcNewLine
   ...
   STRING(Company.CompName,"X(40)")                   /* name      */
   STRING(SUBSTRING(lcCompanyBank,5),"X(20)")         /* bank code (4) +    */
                                                      /* bank office (4) +  */
                                                      /* control digits (2) + */
                                                      /* bank account (10)  */
   FILL(" ",8)                                        /* free      */
...
PROCEDURE pPrintInvoices:
   ...
   BY SUBSTRING(Customer.BankAcc,5)
   BY Invoice.ExtInvID:
      ...
      STRING(SUBSTRING(Customer.BankAcc,5),"X(20)")                /* bank code (4) +    */
                                                      /* bank office (4) +  */
                                                      /* control digits (2) + */
                                                      /* bank account (10)  */
