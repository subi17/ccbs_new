...
pcInputFile = "yot_412.input".
pcOutputFile = "yot_412.log". 
llSimulated = FALSE.
...
REPEAT:
   ...
   liCustNum = INT(ENTRY(2,cLine,chr(9))).
   lcCLI  = ENTRY(3,cLine,chr(9)).
   lcCrStamp = ENTRY(4,cLine,chr(9)).
   lcActStamp = ENTRY(5,cLine,chr(9)).
   lcOrdereridType = "NIF".
   lcOrdererId = ENTRY(7,cLine,chr(9)).
   lcCustomerIdType = "CIF".
   lcCustomerId = ENTRY(8,cLine,chr(9)).
   ...
   FIND bCustNIF NO-LOCK WHERE
        bCustNIF.Brand = Syst.Var:gcBrand AND
