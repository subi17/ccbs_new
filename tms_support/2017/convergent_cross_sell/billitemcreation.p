...
icIncDir = "../tms_support/2017/convergent_cross_sell/".
icSpoolDir = "../tms_support/2017/convergent_cross_sell/".
...
REPEAT:
   ...
   ASSIGN ttBillItem.BillItem   = TRIM(ENTRY(1,lcLine,";"))
          ...
          ttBillItem.ItemType   = INT(ENTRY(8,lcLine,";")) NO-ERROR.
...
REPEAT:
   ...
   IF ERROR-STATUS:ERROR THEN DO:
       MESSAGE lcLine lcInputFile VIEW-AS ALERT-BOX.
