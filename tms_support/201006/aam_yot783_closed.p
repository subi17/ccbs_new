...
input stream sread from 
       /apps/yoigo/tms_support/201006/credit_closed_orders_201006.txt.

def stream slog.
output stream slog to 
   /apps/yoigo/tms_support/201006/credit_closed_orders_201006.log append.
...
repeat:
   ...
   liorderid = integer(entry(1,lcline,chr(9))) no-error.
   ...
   assign Memo.Brand     = "1"
          ...
          Memo.MemoTitle = "CLOSED ORDER"
          Memo.MemoText  = "Credited by Yoigo, YOT-782".
