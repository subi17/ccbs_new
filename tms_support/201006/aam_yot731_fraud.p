...
input stream sread from 
       /apps/yoigo/tms_support/201006/credit_fraud_orders_201005.txt.

def stream slog.
output stream slog to 
   /apps/yoigo/tms_support/201006/credit_fraud_orders.log append.
...
repeat:
   ...
   assign Memo.Brand     = "1"
          ...
          Memo.MemoText  = "Credited by Yoigo, YOT-728".
