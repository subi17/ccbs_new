...
def stream slog.
output stream slog to /apps/yoigo/tms_support/201005/aam_yts2206_july.log append.

for each msrequest no-lock where
         msrequest.brand = "1" and
         msrequest.reqtype = 0 and
         msrequest.reqstat = 2 and
         msrequest.actstamp >= 20100701 and
         msrequest.actstamp < 20100702 and
