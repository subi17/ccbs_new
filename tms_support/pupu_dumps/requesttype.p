...
ASSIGN lcLogFile = lcSpoolDir + "/requesttype_" +
...
FOR EACH RequestType NO-LOCK WHERE
   ...
   IF NOT SESSION:BATCH AND liEvents MOD 10 = 0 THEN DO:
      PAUSE 0.
      DISP liEvents LABEL "RequestType" 
