...
ASSIGN lcLogFile = lcSpoolDir + "/natholiday_" +
...
FOR EACH NatHoliday NO-LOCK:

   liEvents = liEvents + 1.

   IF NOT SESSION:BATCH AND liEvents MOD 100 = 0 THEN DO:
      PAUSE 0.
      DISP liEvents LABEL "NatHoliday" 
