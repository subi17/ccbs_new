...
ASSIGN lcLogFile = lcSpoolDir + "/servpac_" +
...
FOR EACH ServPac WHERE ServPac.Brand = gcBrand NO-LOCK:

   liEvents = liEvents + 1.

   IF NOT SESSION:BATCH AND liEvents MOD 100 = 0 THEN DO:
      PAUSE 0.
      DISP liEvents LABEL "ServPac" 
