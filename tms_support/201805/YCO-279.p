/*----------------------------------------- 
YCO-279. Creating 16 new discounts 
/tms_support/201805/YCO-279.p
jotorres 19.05.2018
-----------------------------------------*/
...
RUN pCreateDiscount (INPUT "RETDISC_MOB_10_12",
                     INPUT "10% discount for 12 months - Mobile Line",
                     INPUT "Percentage",                      
                     INPUT 10,
                     INPUT 12,
                     INPUT lcDPSubjects,
...
RUN pCreateDiscount (INPUT "RETDISC_MOB_20_12",
                     INPUT "20% discount for 12 months - Mobile Line",
                     INPUT "Percentage",                     
                     INPUT 20,
                     INPUT 12,
                     INPUT lcDPSubjects,
...
RUN pCreateDiscount (INPUT "RETDISC_MOB_30_12",
                     INPUT "30% discount for 12 months - Mobile Line",
                     INPUT "Percentage",                     
                     INPUT 30,
                     INPUT 12,
                     INPUT lcDPSubjects,
...
RUN pCreateDiscount (INPUT "RETDISC_MOB_50_12",
                     INPUT "50% discount for 12 months - Mobile Line",
                     INPUT "Percentage",                                          
                     INPUT 50,
                     INPUT 12,
                     INPUT lcDPSubjects,
...
RUN pCreateDiscount (INPUT "RETDISC_MOB_10_24",
                     INPUT "10% discount for 24 months - Mobile Line",
                     INPUT "Percentage",                     
                     INPUT 10,
                     INPUT 24,
                     INPUT lcDPSubjects,
...
RUN pCreateDiscount (INPUT "RETDISC_MOB_20_24",
                     INPUT "20% discount for 24 months - Mobile Line",
                     INPUT "Percentage",                     
                     INPUT 20,
                     INPUT 24,
                     INPUT lcDPSubjects,
...
RUN pCreateDiscount (INPUT "RETDISC_MOB_30_24",
                     INPUT "30% discount for 24 months - Mobile Line",
                     INPUT "Percentage",                     
                     INPUT 30,
                     INPUT 24,
                     INPUT lcDPSubjects,
...
RUN pCreateDiscount (INPUT "RETDISC_MOB_50_24",
                     INPUT "50% discount for 24 months - Mobile Line",
                     INPUT "Percentage",                     
                     INPUT 50,
                     INPUT 24,
                     INPUT lcDPSubjects,
...
RUN pCreateDiscount (INPUT "RETDISC_CONV_10_12",
                     INPUT "10% discount for 12 months - Convergent Line",
                     INPUT "Percentage",                     
                     INPUT 10,
                     INPUT 12,
                     INPUT lcDPSubjects,
...
RUN pCreateDiscount (INPUT "RETDISC_CONV_20_12",
                     INPUT "20% discount for 12 months - Convergent Line",
                     INPUT "Percentage",                     
                     INPUT 20,
                     INPUT 12,
                     INPUT lcDPSubjects,
...
RUN pCreateDiscount (INPUT "RETDISC_CONV_30_12",
                     INPUT "30% discount for 12 months - Convergent Line",
                     INPUT "Percentage",                     
                     INPUT 30,
                     INPUT 12,
                     INPUT lcDPSubjects,
...
RUN pCreateDiscount (INPUT "RETDISC_CONV_50_12",
                     INPUT "50% discount for 12 months - Convergent Line",
                     INPUT "Percentage",                     
                     INPUT 50,
                     INPUT 12,
                     INPUT lcDPSubjects,
...
RUN pCreateDiscount (INPUT "RETDISC_CONV_10_24",
                     INPUT "10% discount for 24 months - Convergent Line",
                     INPUT "Percentage",                     
                     INPUT 10,
                     INPUT 24,
                     INPUT lcDPSubjects,
...
RUN pCreateDiscount (INPUT "RETDISC_CONV_20_24",
                     INPUT "20% discount for 24 months - Convergent Line",
                     INPUT "Percentage",                     
                     INPUT 20,
                     INPUT 24,
                     INPUT lcDPSubjects,
...
RUN pCreateDiscount (INPUT "RETDISC_CONV_30_24",
                     INPUT "30% discount for 24 months - Convergent Line",
                     INPUT "Percentage",                     
                     INPUT 30,
                     INPUT 24,
                     INPUT lcDPSubjects,
...
RUN pCreateDiscount (INPUT "RETDISC_CONV_50_24",
                     INPUT "50% discount for 24 months - Convergent Line",
                     INPUT "Percentage",                     
                     INPUT 50,
                     INPUT 24,
                     INPUT lcDPSubjects,
