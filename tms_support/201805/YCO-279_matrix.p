/*----------------------------------------------
YCO-279. 
tms_support/201805/YCO-279_matrix.p
...
INPUT FROM VALUE("/tmp/YCO-279_Incomp_Matrix.txt"). 
REPEAT:
...
END. 
INPUT CLOSE.
OUTPUT TO VALUE("/tmp/YCO-279_matrix_1.log").
...
END. 
OUTPUT CLOSE.
OUTPUT TO VALUE("/tmp/YCO-279_matrix_2.log").
