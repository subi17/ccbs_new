...
PROCEDURE ipModifyMenuTree:
    ...
    ASSIGN MenuTree.Module = "Mc/tmsrelation_run.p".
...
PROCEDURE ipCreateUpsellMenu:
    ...
    CREATE MenuText.
    ASSIGN MenuText.MenuNum   = 9858
           MenuText.MenuText  = "UPSELL".
           
    MESSAGE "New menu for UPSELL got created." SKIP "Script Completed."
    VIEW-AS ALERT-BOX.
