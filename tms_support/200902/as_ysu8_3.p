...
output stream slog to /apps/snet/200901/as_ysu8_3.log.
...
repeat:
   ...
   */
   ...
   IF AVAIL mobsub THEN DO:
     fGetLimit(mobsub.custnum, mobsub.msseq, 3, 0, 0, TODAY).
   ...
   ELSE DO:
     ...
     fGetLimit(termmobsub.custnum, termmobsub.msseq, 3, 0, 0, TODAY).
     if limit.limitamt = 0 then next.
