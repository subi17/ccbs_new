...
def stream sread.
input stream sread from as_yot1092_PedidosNoEntregadosTransRetrocedida.txt.

def stream slog.
output stream slog to PedidosNoEntregadosTransRetrocedida.log.
