...
DEFINE VARIABLE lcTask AS CHARACTER NO-UNDO. 
...
def stream sread.
input stream sread from as_yot1070_extra.txt.

def stream slog.
output stream slog to as_yot1070_extra.log.
...
repeat:
   ...
   assign Memo.Brand     = "1"
          ...
          Memo.MemoTitle = "ORDER CREDIT NOTE"
          Memo.MemoText  = "Credited by Yoigo, " + lcTask.
