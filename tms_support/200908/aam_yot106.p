...
def stream sread.
input stream sread from /apps/snet/200908/CreditNotes20090624-20090819.csv.

def stream slog.
output stream slog to /apps/snet/200908/aam_yot106.log append.
...
repeat:
   ...
   */
   ...
   if order.crstamp < 20090624 then do:
      fwlog("Older than 20090624").
      next.
   end.
   ...
   */
   ...
   assign Memo.Brand     = "1"
          ...
          Memo.MemoText  = "Credited by Yoigo, YOT-104".
