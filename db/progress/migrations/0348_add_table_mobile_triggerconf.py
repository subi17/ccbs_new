...
class AddTableTriggerConf(Migration):
    ...
    def up(self):
        ...
        t.column('ValidFrom', 'date', format="99-99-99", max_width=4, label="ValidFrom", column_label="ValidFrom", position=5, order=40, help="The date FROM which this TriggerConf will be used")
        t.column('ValidTo', 'date', format="99-99-99", max_width=4, label="ValidTo", column_label="ValidTo", position=6, order=50, help="The date TO which this Trigger Configuration will be used")
