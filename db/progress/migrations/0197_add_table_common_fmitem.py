...
class AddTableFMItem(Migration):
    ...
    def up(self):
        ...
        t.column('FFEndDate', 'date', format="99-99-99", max_width=4, label="Fixed Fee End", column_label="FF End", position=11, order=100, help="End date for fixed fee")
        ...
        t.column('FromDate', 'date', format="99-99-99", max_width=4, label="From Date", column_label="From", position=14, order=130, help="First effective date")
        t.column('ToDate', 'date', format="99-99-99", max_width=4, label="To Date", column_label="To", position=15, order=140, help="Last effective date")
