...
class AddTableDumpHPD(Migration):
    ...
    def up(self):
        ...
        t.column('UnitsToDump', 'integer', format=">>>>>>>9", initial="0", max_width=4, label="Units to dump", column_label="UnitsToDump", position=7, order=60, help="How many units to dump. Zero value means no restriction.")
