...
''')
        ...
        t.column('FromDate', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="Effective date", column_label="Eff.date", position=3, order=20, help="Date when rule becomes effective")
