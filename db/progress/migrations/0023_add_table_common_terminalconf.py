...
class AddTableTerminalConf(Migration):
    ...
    def up(self):
        t = self.table('TerminalConf', area="Sta_Data_128", multitenant="yes", label="TerminalConf", dump_name="terminalconf", desc="Terminal Configurations")
        ...
        t.column('ValidFrom', 'date', format="99-99-9999", initial=self.unknown, max_width=4, label="Valid From", column_label="ValidFrom", position=4, order=30, help="First effective day")
        t.column('ValidTo', 'date', format="99-99-9999", initial=self.unknown, max_width=4, label="Valid To", column_label="ValidTo", position=5, order=40, help="Last effective day")
