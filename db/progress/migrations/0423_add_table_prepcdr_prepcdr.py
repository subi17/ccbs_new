...
class AddTablePrepCDR(Migration):
    ...
    def up(self):
        t = self.table('PrepCDR', area="Dyn_Data_64", multitenant="yes", label="PrePaid CDR", dump_name="prepcdr")
...
''')
        ...
        t.column('ReadDate', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="Read In Date", column_label="Read", position=200, order=2480, help="Read in date")
