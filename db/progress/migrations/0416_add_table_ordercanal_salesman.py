...
class AddTableSalesman(Migration):
    ...
    def up(self):
        t = self.table('Salesman', area="Sta_Data_2_64", multitenant="yes", label="Salesman", dump_name="salesman", desc="Salesman")
        ...
        t.index('Salesman', [['Brand'], ['Salesman'], ['SmName']], area="Sta_Index_3", primary=True, unique=True)
        t.index('CustNum', [['Brand'], ['CustNum'], ['Salesman']], area="Sta_Index_3")
        t.index('Reseller', [['Brand'], ['Reseller'], ['RsLevel'], ['Salesman']], area="Sta_Index_3")
        t.index('SalesOffice', [['Brand'], ['SalesOffice'], ['Salesman']], area="Sta_Index_3", unique=True)
        t.index('SmName', [['Brand'], ['SmName'], ['SalesOffice']], area="Sta_Index_3")
