...
class AddTableActivityCounter(Migration):
    ...
    def up(self):
        t = self.table('ActivityCounter', area="Sta_Data_256", multitenant="yes", dump_name="activitycounter")
        ...
        t.column('AcDate', 'date', format="99-99-9999", initial=self.unknown, max_width=4, label="ActDate", column_label="ActDate", position=3, order=20)
