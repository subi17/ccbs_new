...
class AddTableTMSPass(Migration):
    ...
    def up(self):
        t = self.table('TMSPass', area="Sta_Data_32", multitenant="yes", label="TMS Passwords", dump_name="tmspass", desc="TMS Passwords")
        ...
        t.index('UserCode', [['UserCode'], ['CreateTS', 'DESC']], area="Sta_Index_3", primary=True, unique=True)
