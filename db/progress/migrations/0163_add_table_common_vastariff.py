...
class AddTableVASTariff(Migration):
    ...
    def up(self):
        ...
        t.column('FromDate', 'date', format="99-99-99", max_width=4, label="Tariff from", column_label="Tariff from", position=7, order=60, help="First effective date")
        t.column('ToDate', 'date', format="99-99-99", max_width=4, label="To Date", column_label="To Date", position=8, order=70, help="Last effective date")
