...
class AddTableAccPeriod(Migration):
    ...
    def up(self):
        ...
        t.column('FromDate', 'date', format="99-99-99", max_width=4, label="From", position=3, order=20, help="Beginning of period")
        t.column('ToDate', 'date', format="99-99-99", max_width=4, label="To", position=4, order=30, help="End of period")
