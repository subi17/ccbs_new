...
class AddTableRerateLog(Migration):
    ...
    def up(self):
        ...
        t.column('PeriodBegin', 'date', format="99-99-9999", max_width=4, label="Period Begin", column_label="Begin", position=6, order=50, help="Begin date for period")
        t.column('PeriodEnd', 'date', format="99-99-9999", max_width=4, label="Period End", column_label="End", position=7, order=60, help="End date for period")
        ...
        t.column('StartDate', 'date', format="99-99-99", max_width=4, label="Start Date", column_label="Started", position=11, order=100, help="Starting date")
