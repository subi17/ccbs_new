...
class AddTableWInvPwd(Migration):
    ...
    def up(self):
        ...
        t.column('ValidFrom', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="ValidFrom", column_label="ValidFrom", position=5, order=40, help="Valid from date")
