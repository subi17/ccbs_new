...
class AddTableRepText(Migration):
    ...
    def up(self):
        t = self.table('RepText', area="Sta_Data_128", label="Report Texts", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-reptext.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-reptext.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="reptext", desc="Report texts")
