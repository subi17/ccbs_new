...
class AddTableRepText(Migration):
    ...
    def up(self):
        ...
        t.column('FromDate', 'date', format="99-99-99", max_width=4, label="From", position=9, order=80, help="Date when text becomes effective")
        t.column('ToDate', 'date', format="99-99-99", max_width=4, label="To", position=10, order=90, help="Date when text expires")
