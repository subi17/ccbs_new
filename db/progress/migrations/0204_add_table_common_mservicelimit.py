...
class AddTableMServiceLimit(Migration):
    ...
    def up(self):
        t = self.table('MServiceLimit', area="Sta_Data_128", table_trigger=[{'crc': '?', 'procedure': 'rd-mservicelimit.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'rw-mservicelimit.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="mservice")
