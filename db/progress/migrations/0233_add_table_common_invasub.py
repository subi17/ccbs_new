...
class AddTableInvASub(Migration):
    ...
    def up(self):
        ...
        t.column('FromDate', 'date', format="99-99-99", max_width=4, label="DateFrom", column_label="DateFrom", position=13, order=630, help="FROM date (oldest call date)")
        t.column('ToDate', 'date', format="99-99-99", max_width=4, label="DateTo", column_label="DateTo", position=14, order=640, help="TO date (latest call date)")
