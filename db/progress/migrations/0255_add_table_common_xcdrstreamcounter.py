...
class AddTablexCDRStreamCounter(Migration):

    database = "common"

    def up(self):
        t = self.table('xCDRStreamCounter', area="Dyn_Data_128", label="CDR Stream Counter", dump_name="cdrstreamcounter", desc="CDR Stream Counter")
    ...
    def down(self):
        self.drop_table('xCDRStreamCounter')
