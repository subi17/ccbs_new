...
class AddTableOrder(Migration):
    ...
    def up(self):
        t = self.table('Order', area="Sta_Data_32", multitenant="yes", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-order.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-order.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="order")
        ...
        t.column('CLIType', 'character', format="x(13)", initial="", help="CLI Type", max_width=16, label="CLIType", column_label="CLIType", position=11, order=110, description="CLI Type")
        ...
        t.column('TupasRM', 'character', format="x(60)", initial="", help="Tupas Return Message", max_width=400, label="TupasRM", column_label="TupasRM", position=32, order=300, description="Tupas Return Message")
