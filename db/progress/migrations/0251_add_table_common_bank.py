...
class AddTableBank(Migration):

    database = "common"

    def up(self):
        t = self.table('Bank', area="Sta_Data_2_256", label="xxBank", dump_name="xxBank-------1", desc="xxBank")
        ...
        t.index('BankId', [['Brand'], ['BankId'], ['BankOffice']], area="Sta_Index_3", primary=True)
