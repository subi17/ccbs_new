...
class AddTableCTServPac(Migration):
    ...
    def up(self):
        ...
        t.column('FromDate', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="From Date", column_label="From", position=5, order=40, help="Valid from date")
        t.column('ToDate', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="To Date", column_label="To", position=6, order=50, help="Valid to date")
