...
class AddTableStarSession(Migration):
    ...
    def up(self):
        ...
        t.column('LastDate', 'date', format="99.99.99", initial=self.unknown, max_width=4, label="LastDate", position=5, order=80, help="LastDate")
        ...
        t.column('CreateDate', 'date', format="99.99.99", initial=self.unknown, max_width=4, label="CreateDate", position=10, order=60)
