...
class AddTableMSOwner(Migration):
    ...
    def up(self):
        t = self.table('MSOwner', area="Sta_Data_64", multitenant="yes", label="Owner of a MSISDN Number", dump_name="msowner1", desc='''
...
''')
        ...
        t.column('Clitype', 'character', format="x(13)", initial="", max_width=16, label="MType", column_label="Mtype", position=17, order=160, help="Type Of Mobsub (connection type)")
