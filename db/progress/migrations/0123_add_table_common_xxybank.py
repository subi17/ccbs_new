...
class AddTablexxyBank(Migration):
    ...
    def up(self):
        ...
        t.column('FileDate', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="File Date", column_label="Date", position=11, order=1020, help="Date of the file from which data was read")
