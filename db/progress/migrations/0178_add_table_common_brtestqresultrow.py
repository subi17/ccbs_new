...
class AddTableBRTestQResultRow(Migration):
    ...
    def up(self):
        t = self.table('BRTestQResultRow', area="Sta_Data_2_256", multitenant="yes", label="BR Test Queue Result Row", dump_name="brtestqresultrow", desc="Billrun test queue result row")
