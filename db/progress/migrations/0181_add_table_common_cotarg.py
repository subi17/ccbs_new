...
class AddTableCoTarg(Migration):
    ...
    def up(self):
        t = self.table('CoTarg', area="Sta_Data_128", multitenant="yes", dump_name="cotarg")
        ...
        t.index('CoRuleID', [['Brand'], ['CoRuleID'], ['TargType'], ['CoTarg']], area="Sta_Index_3", primary=True)
        t.index('CommStatus', [['Brand'], ['CommStatus'], ['CoTarg']], area="Sta_Index_3")
        t.index('CoTargID', [['CoTargId']], area="Sta_Index_3", unique=True)
        t.index('OrderId', [['Brand'], ['OrderId']], area="Sta_Index_3")
        t.index('PromotedID', [['Brand'], ['PromotedID']], area="Sta_Index_3")
        t.index('TargType', [['Brand'], ['TargType'], ['CoTarg']], area="Sta_Index_3")
