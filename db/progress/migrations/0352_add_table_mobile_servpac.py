...
class AddTableServPac(Migration):
    ...
    def up(self):
        t = self.table('ServPac', area="Sta_Data_128_2", multitenant="yes", label="SerPac", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-servpac.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-servpac.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="servpac", desc='''
''')
