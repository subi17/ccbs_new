...
class AddTableTriggerEvent(Migration):
    ...
    def up(self):
        ...
        t.column('Activated', 'datetime', format="99-99-9999 HH:MM:SS.SSS", initial=self.unknown, max_width=8, label="Activated", column_label="Activated", position=7, order=60, help="Event activated Date and Time")
        t.column('Handled', 'datetime', format="99-99-9999 HH:MM:SS.SSS", initial=self.unknown, max_width=8, label="Handled", column_label="Handled", position=8, order=70, help="Event handled Date and Time")
        ...
        t.column('TableID', 'recid', format=">>>>>>>>>>>9", initial=self.unknown, max_width=8, label="TableID", column_label="TableID", position=12, order=110, help="RecordID")
