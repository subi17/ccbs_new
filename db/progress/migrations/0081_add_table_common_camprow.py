...
class AddTableCampRow(Migration):
    ...
    def up(self):
        t = self.table('CampRow', area="Sta_Data_128", multitenant="yes", label="CampRow", dump_name="camprow", desc='''Campaign rows
''')
        ...
        t.index('Campaign', [['Brand'], ['Campaign'], ['CRowType'], ['CRowItem']], area="Sta_Index_3", primary=True)
        t.index('BillCode', [['Brand'], ['BillCode']], area="Sta_Index_3")
        t.index('CLIType', [['Brand'], ['CLIType']], area="Sta_Index_3")
        t.index('CRowType', [['Brand'], ['CRowType'], ['CLIType']], area="Sta_Index_3")
