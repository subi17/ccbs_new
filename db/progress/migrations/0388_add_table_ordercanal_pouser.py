...
class AddTablePoUser(Migration):
    ...
    def up(self):
        ...
        t.column('SurName2', 'character', format="x(30)", initial="", max_width=60, label="Second Surname", column_label="2.Surname", position=9, order=80, help="Second surname")
        ...
        t.index('MsSeq', [['MsSeq'], ['LineType']], area="Sta_Index_1", primary=True, unique=True)
