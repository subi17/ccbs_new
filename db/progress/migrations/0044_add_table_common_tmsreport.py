...
class AddTableTMSReport(Migration):
    ...
    def up(self):
        ...
        t.column('UpdPerm', 'logical', format="Kyllõ/Ei", initial="yes", max_width=1, label="Ask", column_label="Ask", position=5, order=90, help="Ask printer's setup when starting to print (Y/N)")
