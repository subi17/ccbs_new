...
class AddTableMNPProcess(Migration):
    ...
    def up(self):
        t = self.table('MNPProcess', area="Sta_Data_64", multitenant="yes", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-mnpprocess.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-mnpprocess.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="mnpproce")
        ...
        t.index('FormRequest', [['FormRequest']], area="Sta_Index_4")
        t.index('MNPType', [['Brand'], ['MNPType'], ['StatusCode'], ['CreatedTS', 'DESC']], area="Sta_Index_4")
        t.index('OperCreated', [['Brand'], ['MNPType'], ['OperCode'], ['CreatedTS', 'DESC']], area="Sta_Index_4")
        t.index('OperPorting', [['Brand'], ['MNPType'], ['OperCode'], ['PortingTime', 'DESC']], area="Sta_Index_4")
        t.index('OperStatus', [['Brand'], ['MNPType'], ['OperCode'], ['StatusCode']], area="Sta_Index_4")
        t.index('OrderId', [['OrderId']], area="Sta_Index_4")
        t.index('PortingTime', [['Brand'], ['MNPType'], ['StatusCode'], ['PortingTime', 'DESC']], area="Sta_Index_4")
        t.index('PortRequest', [['PortRequest']], area="Sta_Index_4")
        t.index('StateFlag', [['Brand'], ['MNPType'], ['StateFlag'], ['StatusCode']], area="Sta_Index_4")
        t.index('StatusCode', [['StatusCode']], area="Sta_Index_4")
        t.index('UpdateTS', [['Brand'], ['MNPType'], ['UpdateTS', 'DESC']], area="Sta_Index_4")
