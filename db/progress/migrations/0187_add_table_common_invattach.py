...
class AddTableInvAttach(Migration):
    ...
    def up(self):
        t = self.table('InvAttach', area="Sta_Data_2_256", label="Invoice Attachments", dump_name="invattac", desc="Attachment definitions for EPL printing of invoices")
        ...
        t.index('CustNum', [['CustNum'], ['ToDate', 'DESC']], area="Sta_Index_4", primary=True, unique=True)
        t.index('PrintStamp', [['PrintStamp', 'DESC']], area="Sta_Index_2")
        t.index('ToDate', [['ToDate', 'DESC'], ['CustNum']], area="Sta_Index_4")
