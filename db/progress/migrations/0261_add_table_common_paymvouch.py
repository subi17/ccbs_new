...
class AddTablePaymVouch(Migration):
    ...
    def up(self):
        t = self.table('PaymVouch', area="Sta_Data_2_256", multitenant="yes", label="Payment Voucher", dump_name="paymvouc", desc="Number series for payment vouchers")
        ...
        t.index('Voucher', [['Brand'], ['VoucherType'], ['FromDate', 'DESC'], ['Voucher']], area="Sta_Index_3", primary=True)
