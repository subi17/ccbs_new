...
class AddTableTMCounter(Migration):
    ...
    def up(self):
        ...
        t.column('FromDate', 'date', format="99-99-99", max_width=4, label="From", position=3, order=50, help="Date when rule becomes effective")
...
''')
        t.column('ToDate', 'date', format="99-99-99", max_width=4, label="To", position=7, order=60, help="Date when rule expires")
