...
class AddTableTCC(Migration):
    ...
    def up(self):
        ...
        t.column('ValidFrom', 'date', format="99-99-99", max_width=4, label="Valid From", column_label="From", position=16, order=60, help="Effective from")
        t.column('ValidTo', 'date', format="99-99-99", max_width=4, label="Valid To", column_label="To", position=23, order=70, help="Effective until")
