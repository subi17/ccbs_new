...
class AddTableRegion(Migration):
    ...
    def up(self):
        t = self.table('Region', area="Sta_Data_128", multitenant="yes", label="Region", dump_name="region", desc="Customer region")
...
''')
        ...
        t.index('Region', [['Region']], area="Sta_Index_3", primary=True, unique=True)
        t.index('RgName', [['RgName']], area="Sta_Index_3")
