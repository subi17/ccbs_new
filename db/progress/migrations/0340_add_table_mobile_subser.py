...
class AddTableSubSer(Migration):
    ...
    def up(self):
        t = self.table('SubSer', area="SubSer_Data", multitenant="yes", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-subser.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-subser.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="subser-------1", desc="Services of mobile subscribers")
