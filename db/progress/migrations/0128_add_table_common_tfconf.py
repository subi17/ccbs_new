...
class AddTableTFConf(Migration):
    ...
    def up(self):
        t = self.table('TFConf', area="Sta_Data_128", multitenant="yes", label="TFConf", dump_name="tfconf", desc="Terminal financial configuration values")
        ...
        t.index('TFConfID', [['TFConfId']], area="Sta_Index_3", primary=True, unique=True)
        t.index('RVPercentage', [['RVPercentage'], ['ValidTo', 'DESC']], area="Sta_Index_3")
