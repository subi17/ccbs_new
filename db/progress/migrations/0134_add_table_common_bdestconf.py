...
class AddTableBDestConf(Migration):
    ...
    def up(self):
        ...
        t.column('ToDate', 'date', format="99-99-99", max_width=4, label="Valid To", column_label="To", position=12, order=120, help="Last effective day")
        t.column('FromDate', 'date', format="99-99-99", max_width=4, label="Valid From", column_label="From", position=13, order=110, help="Valid from")
