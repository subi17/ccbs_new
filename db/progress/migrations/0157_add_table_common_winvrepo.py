...
class AddTableWInvRepo(Migration):
    ...
    def up(self):
        ...
        t.column('FromDate', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="DateFrom", column_label="DateFrom", position=8, order=70, help="Report FROM this date")
        t.column('ToDate', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="DateTo", column_label="DateTo", position=9, order=80, help="Report TO this date")
