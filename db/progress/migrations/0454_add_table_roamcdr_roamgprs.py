...
class AddTableRoamGPRS(Migration):
    ...
    def up(self):
        ...
        t.column('DateStart', 'date', format="99-99-99", max_width=4, label="Date", column_label="Date", position=3, order=20)
        ...
        t.column('DateRead', 'date', format="99-99-99", max_width=4, label="DateRead", column_label="DateRead", position=10, order=90)
