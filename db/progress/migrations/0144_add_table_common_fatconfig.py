...
''')
        ...
        t.column('ValidFrom', 'date', format="99-99-99", max_width=4, label="Valid From", column_label="From", position=9, order=80, help="Valid from")
        t.column('ValidTo', 'date', format="99-99-99", max_width=4, label="Valid To", column_label="To", position=10, order=90, help="Valid to")
