...
''')
        t.column('Date', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="Date", position=2, order=10, help="Date when the run started")
        ...
        t.column('DateFrom', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="From", column_label="From", position=4, order=30, help="From which date erasing started")
        t.column('DateTo', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="To", column_label="To", position=5, order=40, help="To what date erasing was run")
