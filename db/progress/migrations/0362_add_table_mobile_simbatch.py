...
''')
        ...
        t.column('DelDate', 'date', format="99-99-99", max_width=4, label="Delivery Date", column_label="Delivery Date", position=6, order=50, help="Day of Delivery")
        ...
        t.column('FileName', 'character', format="X(20)", max_width=80, label="FileName", column_label="FileName", position=9, order=80, help="Name of the read sim file")
