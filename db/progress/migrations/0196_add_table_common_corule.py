...
class AddTableCoRule(Migration):
    ...
    def up(self):
        ...
        t.column('coFrom', 'date', format="99-99-9999", max_width=4, label="Commission From", column_label="From", position=5, order=40, help="Valid from")
        t.column('coTo', 'date', format="99-99-9999", max_width=4, label="Commission To", column_label="To", position=6, order=50, help="Valid to")
