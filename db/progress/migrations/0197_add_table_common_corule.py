...
class AddTableCoRule(Migration):
    ...
    def up(self):
        t = self.table('CoRule', area="Sta_Data_64", multitenant="yes", label="Commission Rule", dump_name="corule", desc="Defined rules for the commission to be paid to Salesman.")
        ...
        t.index('CoRuleID', [['Brand'], ['CoRuleID']], area="Sta_Index_3", primary=True, unique=True)
        t.index('CoFrom', [['Brand'], ['coFrom', 'DESC'], ['CustNum']], area="Sta_Index_3")
        t.index('CustNum', [['Brand'], ['CustNum'], ['RuleDesc']], area="Sta_Index_3")
        t.index('CustNum_s', [['CustNum'], ['RuleDesc']], area="Sta_Index_3")
        t.index('RuleDesc', [['Brand'], ['RuleDesc'], ['CustNum']], area="Sta_Index_3")
        t.index('RuleType', [['Brand'], ['RuleType'], ['coFrom', 'DESC'], ['CoRuleID']], area="Sta_Index_3")
