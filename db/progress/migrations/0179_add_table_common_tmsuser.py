...
class AddTableTMSUser(Migration):
    ...
    def up(self):
        ...
        t.column('UserNum', 'integer', mandatory=True, format="999", initial="0", help="User's internal consecutive number", max_width=4, label="UserNo", column_label="UserNo", position=5, order=40, description="Käyttäjätunn. liittyvä numeerinen yksilöintiavain")
        ...
        t.column('Active', 'logical', format="Kyllä/Ei", initial="yes", max_width=1, label="Activ", column_label="Activ", position=7, order=60, help="Active")
        ...
        t.column('WorkStation', 'logical', format="Mustavalko/Väri", initial="no", max_width=1, label="Workst.", column_label="Workst.", position=10, order=90, help="Is a workstation black&white or colour")
        ...
        t.column('FromDate', 'date', format="99-99-99", max_width=4, label="Date from", column_label="Date from", position=24, order=220, help="Activation date")
        t.column('ToDate', 'date', format="99-99-99", max_width=4, label="Date to", column_label="Date to", position=25, order=230, help="Expiring date")
