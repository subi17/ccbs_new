...
class AddTableProgLimit(Migration):
    ...
    def up(self):
        t = self.table('ProgLimit', area="Sta_Data_128", multitenant="yes", dump_name="proglimit")
        ...
        t.index('ValidTo', [['GroupCode'], ['SLSeq'], ['ValidTo', 'DESC'], ['LimitTo']], area="Sta_Index_3", primary=True)
        t.index('LimitTo', [['GroupCode'], ['SLSeq'], ['LimitTo'], ['ValidFrom']], area="Sta_Index_3")
