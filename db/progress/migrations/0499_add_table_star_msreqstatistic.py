...
class AddTableMsReqStatistic(Migration):

    database = "star"

    def up(self):
        t = self.table('MsReqStatistic', area="Dyn_Data_128", dump_name="MsReqStatistic")
        ...
        t.index('ReqType', [['Brand'], ['ReqType'], ['ReqStatus']], area="Dyn_Index_1", primary=True, unique=True)
