...
class AddTableJobQueue(Migration):
    ...
    def up(self):
        ...
        t.column('QueueDate', 'date', format="99.99.99", initial=self.unknown, max_width=4, label="Queued Date", position=3, order=60, help="Date when put to queue")
        ...
        t.column('RunDate', 'date', format="99.99.99", initial=self.unknown, max_width=4, label="Run Date", position=5, order=40, help="Date when launch")
...
9 = done''')
        ...
        t.column('CommitDate', 'date', format="99.99.99", initial=self.unknown, max_width=4, label="Commit Date", position=16, order=120, help="Date when job is commited")
