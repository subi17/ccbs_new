...
class AddTableSLGAnalyse(Migration):
    ...
    def up(self):
        t = self.table('SLGAnalyse', area="Sta_Data_64", multitenant="yes", dump_name="slganaly")
        ...
        t.column('ValidFrom', 'date', format="99-99-9999", initial=self.unknown, max_width=4, label="Valid From", column_label="Valid From", position=16, order=50, help="The date FROM which this SLG analyse will be used.")
        ...
        t.column('ValidTo', 'date', format="99-99-9999", initial=self.unknown, max_width=4, label="Valid To", column_label="Valid To", position=20, order=60, help="The date TO which this SLG analyse will be used.")
        ...
        t.index('BillCode', [['Brand'], ['BillCode'], ['Clitype'], ['ValidTo', 'DESC']], area="Sta_Index_3", primary=True)
        t.index('BelongTo', [['Brand'], ['BelongTo'], ['Clitype'], ['BillCode'], ['CCN'], ['BDest'], ['Prior'], ['ValidTo', 'DESC']], area="Sta_Index_3")
        t.index('CliType', [['Brand'], ['Clitype'], ['BillCode'], ['ValidTo', 'DESC']], area="Sta_Index_3")
        t.index('ServiceLimitGroup', [['Brand'], ['ServiceLimitGroup'], ['Clitype'], ['ValidTo', 'DESC']], area="Sta_Index_3")
