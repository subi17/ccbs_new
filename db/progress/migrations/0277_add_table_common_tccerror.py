...
class AddTableTCCError(Migration):
    ...
    def up(self):
        ...
        t.column('ValidFrom', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="Valid From", column_label="Valid From", position=16, order=60, help="The date from which this TCCError will be used.")
        t.column('ValidTo', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="Valid To", column_label="Valid To", position=23, order=70, help="The date to (until) which this TCCError will be used.")
