...
''')
        t.column('ValidFrom', 'date', mandatory=True, format="99-99-99", max_width=4, label="Valid", column_label="Valid", position=2, order=10, help="Date from which this interest is valid")
