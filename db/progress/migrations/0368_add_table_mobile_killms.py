...
class AddTableKillMs(Migration):
    ...
    def up(self):
        ...
        t.column('KillDate', 'date', format="99.99.99", initial=self.unknown, max_width=4, label="KillDate", column_label="KillDate", position=6, order=50, help="Date when subscription shall be killed")
