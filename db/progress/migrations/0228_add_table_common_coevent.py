...
class AddTableCoEvent(Migration):
    ...
    def up(self):
        ...
        t.column('CalcDate', 'date', format="99-99-99", max_width=4, label="Calc. Date", column_label="Date", position=5, order=40, help="Date when event was created")
        ...
        t.column('PaymDate', 'date', format="99-99-99", max_width=4, label="Payment Date", column_label="Paid", position=9, order=80, help="Date when commission has been paid out")
        ...
        t.column('CommFrom', 'date', format="99-99-99", max_width=4, label="From Date", column_label="From", position=12, order=110, help="Commission is based on events from this date onwards")
        t.column('CommTo', 'date', format="99-99-99", max_width=4, label="To Date", column_label="To", position=13, order=120, help="Commission is based on events till this date")
