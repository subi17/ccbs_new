...
class AddTableCustPP(Migration):
    ...
    def up(self):
        ...
        t.column('ValidFrom', 'date', mandatory=True, format="99-99-99", max_width=4, label="CDate", column_label="ContDate", position=5, order=40, help="Date from which the contract is valid")
        ...
        t.column('ValidTo', 'date', format="99-99-99", max_width=4, label="ExpDate", column_label="ExpDate", position=9, order=50, help="Date when contract was ended/expired")
