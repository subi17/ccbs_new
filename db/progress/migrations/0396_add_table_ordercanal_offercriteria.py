...
class AddTableOfferCriteria(Migration):
    ...
    def up(self):
        t = self.table('OfferCriteria', area="Sta_Data_128", multitenant="yes", label="Offer Criteria", dump_name="offercriteria", desc="Offer criteria")
        ...
        t.index('Criteria', [['Brand'], ['Offer'], ['OfferCriteriaID']], area="Sta_Index_3", primary=True)
        t.index('CriteriaType', [['Brand'], ['CriteriaType'], ['EndStamp', 'DESC']], area="Sta_Index_3")
        t.index('EndStamp', [['Brand'], ['EndStamp', 'DESC']], area="Sta_Index_3")
        t.index('Offer', [['Brand'], ['Offer'], ['EndStamp', 'DESC']], area="Sta_Index_3")
        t.index('OfferCriteriaID', [['OfferCriteriaID']], area="Sta_Index_3", unique=True)
        t.index('OfferCriteriaType', [['Brand'], ['Offer'], ['CriteriaType'], ['BeginStamp', 'DESC']], area="Sta_Index_3")
