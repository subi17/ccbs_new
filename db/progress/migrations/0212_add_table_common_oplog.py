...
class AddTableOPLog(Migration):
    ...
    def up(self):
        ...
        t.index('CustNum', [['CustNum'], ['CreStamp', 'DESC']], area="Sta_Index_3", primary=True)
        t.index('CLI', [['CLI']], area="Sta_Index_2")
        t.index('CustDate', [['CustNum'], ['EventDate', 'DESC'], ['Voucher']], area="Sta_Index_3")
        t.index('CustInv', [['CustNum'], ['InvNum'], ['EventDate', 'DESC']], area="Sta_Index_3")
        t.index('InvNum', [['InvNum'], ['SubInvNum'], ['EventDate', 'DESC']], area="Sta_Index_3")
