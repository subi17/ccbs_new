...
class AddTableCCN(Migration):
    ...
    def up(self):
        t = self.table('CCN', area="Sta_Data_128", multitenant="yes", label="CCN", dump_name="ccn", desc="CCN")
        ...
        t.index('CCN', [['Brand'], ['CCN']], area="Sta_Index_3", primary=True, unique=True)
        t.index('CCNName', [['Brand'], ['CCNName']], area="Sta_Index_3")
        t.index('RepCCN', [['Brand'], ['RepCCN'], ['CCN']], area="Sta_Index_3")
