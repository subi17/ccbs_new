...
class AddTableMServiceLPool(Migration):
    ...
    def up(self):
        t = self.table('MServiceLPool', area="Sta_Data_128", multitenant="yes", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-mservicelpool.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-mservicelpool.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="mservicelpool")
        ...
        t.index('CustNum', [['custnum'], ['SLSeq'], ['EndTS', 'DESC']], area="Sta_Index_4")
