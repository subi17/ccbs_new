...
class AddTableDiscPlan(Migration):
    ...
    def up(self):
        t = self.table('DiscPlan', area="Sta_Data_128", multitenant="yes", label="Discount Plan", dump_name="discplan")
        ...
        t.index('DiscPlan', [['Brand'], ['DiscPlan']], area="Sta_Index_3", primary=True, unique=True)
        t.index('DPName', [['Brand'], ['DPName'], ['DiscPlan']], area="Sta_Index_3")
