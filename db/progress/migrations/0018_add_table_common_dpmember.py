...
class AddTableDPMember(Migration):
    ...
    def up(self):
        t = self.table('DPMember', area="Sta_Data_2_256", multitenant="yes", label="Discount Plan Member", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-dpmember.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-dpmember.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="dpmember")
