...
class AddTableDPMember(Migration):
    ...
    def up(self):
        ...
        t.column('ValidFrom', 'date', format="99-99-9999", max_width=4, label="Valid From", column_label="From", position=6, order=50, help="Effective from date")
        t.column('ValidTo', 'date', format="99-99-9999", max_width=4, label="Valid To", column_label="To", position=7, order=60, help="Effective to date")
