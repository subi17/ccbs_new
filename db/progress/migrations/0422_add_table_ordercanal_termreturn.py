...
class AddTableTermReturn(Migration):
    ...
    def up(self):
        t = self.table('TermReturn', area="Sta_Data_32", multitenant="yes", label="Returned terminals", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-termreturn.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-termreturn.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="TermReturn")
