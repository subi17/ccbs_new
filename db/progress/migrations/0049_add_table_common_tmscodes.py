...
class AddTableTMSCodes(Migration):
    ...
    def up(self):
        t = self.table('TMSCodes', area="Sta_Data_64", multitenant="yes", label="Selection Lists", dump_name="tmscodes", desc="General selection list values in TMS application")
        ...
        t.index('TableName', [['TableName'], ['FieldName'], ['CodeValue']], area="Sta_Index_3", primary=True, unique=True)
        t.index('CodeGroup', [['CodeGroup'], ['FieldName']], area="Sta_Index_3")
