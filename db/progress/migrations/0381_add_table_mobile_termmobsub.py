...
class AddTableTermMobSub(Migration):
    ...
    def up(self):
        t = self.table('TermMobSub', area="Sta_Data_32", label="Mobile Subscriber", dump_name="Termms", desc="Mobile Subscription")
        ...
        t.column('CliType', 'character', format="x(8)", initial="", max_width=16, label="MType", column_label="Mtype", position=43, order=440, help="Type Of TermMobSub")
