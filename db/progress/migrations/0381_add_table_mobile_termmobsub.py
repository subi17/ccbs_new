...
class AddTableTermMobSub(Migration):
    ...
    def up(self):
        ...
        t.column('SegmentDate', 'date', format="99-99-99", max_width=4, label="Segmentation Date", column_label="SegmentDate", position=28, order=830, help="Date when segmentation code was changed")
        ...
        t.column('TariffActDate', 'date', format="99-99-99", max_width=4, label="Tariff Activation Date", column_label="TariffActDate", position=35, order=900)
