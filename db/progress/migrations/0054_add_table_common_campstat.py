...
''')
        ...
        t.column('CampDate', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="Campaign Date", column_label="Date", position=6, order=50, help="Date when campaign was used")
