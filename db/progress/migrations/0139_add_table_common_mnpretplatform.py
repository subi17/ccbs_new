...
class AddTableMNPRetPlatform(Migration):
    ...
    def up(self):
        ...
        t.column('FromDate', 'date', format="99-99-99", max_width=4, label="FromDate", position=6, order=50, help="Date when validity expires")
        t.column('ToDate', 'date', format="99-99-99", max_width=4, label="ToDate", position=7, order=60, help="Date when validity begins")
