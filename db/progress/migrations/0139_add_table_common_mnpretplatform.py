...
class AddTableMNPRetPlatform(Migration):
    ...
    def up(self):
        t = self.table('MNPRetPlatform', area="Sta_Data_128", multitenant="yes", label="MNPRetPlatform", dump_name="mnpretplatform", desc="MNP retention platform configuration")
        ...
        t.index('MNPRetPlatform', [['RetentionPlatform']], area="Sta_Index_3", primary=True, unique=True)
