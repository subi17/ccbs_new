...
class AddTableTriggerItem(Migration):
    ...
    def up(self):
        ...
        t.column('Handled', 'datetime', format="99-99-9999 HH:MM:SS.SSS", max_width=8, label="Handled", column_label="Handled", position=7, order=60, help="Date and Time when trigger item was handled")
        t.column('Activated', 'datetime', format="99-99-9999 HH:MM:SS.SSS", max_width=8, label="Activated", column_label="Activated", position=8, order=70, help="Date and time when trigger item was activated")
