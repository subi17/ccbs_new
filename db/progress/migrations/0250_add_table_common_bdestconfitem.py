...
class AddTableBDestConfItem(Migration):
    ...
    def up(self):
        t = self.table('BDestConfItem', area="Sta_Data_128", multitenant="yes", label="BDest Configuration Item", dump_name="bdestconfitem", desc="BDest configuration item")
        ...
        t.index('BDCGroup', [['Brand'], ['BDCGroup']], area="Sta_Index_3", primary=True)
        t.index('BDCItemID', [['BDCItemID']], area="Sta_Index_3", unique=True)
        t.index('BDest', [['Brand'], ['BDest'], ['ToDate', 'DESC']], area="Sta_Index_3")
