...
class AddTableCustTemp(Migration):
    ...
    def up(self):
        t = self.table('CustTemp', area="Sta_Data_128", multitenant="yes", label="Customer Templates", dump_name="custemp", desc='''Template definition for Customer creation
''')
        ...
        t.index('TemplNum', [['Brand'], ['TemplNum']], area="Sta_Index_3", primary=True, unique=True)
        t.index('TemplName', [['Brand'], ['TemplName'], ['TemplNum']], area="Sta_Index_3")
