...
class AddTableRoamTariff(Migration):
    ...
    def up(self):
        t = self.table('RoamTariff', area="Sta_Data_2_128", dump_name="roamtari")
        ...
        t.column('ValidFrom', 'date', format="99-99-9999", initial=self.unknown, max_width=4, label="Valid From", column_label="From", position=6, order=50, help="Valid from")
        t.column('ValidTo', 'date', format="99-99-9999", initial=self.unknown, max_width=4, label="Valid To", column_label="To", position=7, order=60, help="Valid to")
