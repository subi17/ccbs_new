...
class AddTableRequestActionRule(Migration):
    ...
    def up(self):
        t = self.table('RequestActionRule', area="Sta_Data_64", multitenant="yes", label="Request Action Rule", dump_name="requestactionrule", desc="Request action rule")
        ...
        t.index('ParamField', [['RequestActionID'], ['ParamField'], ['ToDate', 'DESC']], area="Sta_Index_3", primary=True)
