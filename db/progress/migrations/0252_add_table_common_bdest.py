...
class AddTableBDest(Migration):
    ...
    def up(self):
        ...
        t.column('ToDate', 'date', format="99-99-99", max_width=4, label="Valid To", column_label="To", position=20, order=200, help="Last effective day")
        t.column('FromDate', 'date', format="99-99-99", max_width=4, label="Valid From", column_label="From", position=21, order=210, help="First effective day")
