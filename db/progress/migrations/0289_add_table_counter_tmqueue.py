...
class AddTableTMQueue(Migration):
    ...
    def up(self):
        ...
        t.column('DateSt', 'date', format="99-99-99", max_width=4, label="Event Date", column_label="Date", position=5, order=40, help="Event date")
        ...
        t.column('PeriodFrom', 'date', format="99-99-99", max_width=4, label="FromDate", column_label="Period from", position=21, order=200, help="Billing period from")
        t.column('PeriodTo', 'date', format="99-99-99", max_width=4, label="ToDate", column_label="Period to", position=22, order=210, help="Billing period to")
