...
class AddTableDumpHPD(Migration):
    ...
    def up(self):
        ...
        t.column('MaxRecordsPerFile', 'integer', format=">>>>>>>9", initial="0", max_width=4, label="Max records per file", column_label="MaxRecords", position=9, order=80, help="Maximum amount of record per a file (0=unlimited)")
