...
class AddTableM2MTime(Migration):
    ...
    def up(self):
        t = self.table('M2MTime', area="Sta_Data_2_256", dump_name="m2mtime")
        t.column('Date', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="Date", column_label="Date", position=2, order=10, help="Date")
