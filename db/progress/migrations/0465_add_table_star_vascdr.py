...
class AddTableVASCDR(Migration):
    ...
    def up(self):
        ...
        t.column('RountingNumber', 'character', format="x(15)", max_width=30, label="RountingNumber", column_label="RountingNumber", position=146, order=1430, help="Routing Number")
