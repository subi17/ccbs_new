...
''')
        ...
        t.column('SSDate', 'date', format="99-99-99", max_width=4, label="Date", column_label="Date", position=7, order=60, help="Date When Activated")
        ...
        t.index('ServCom', [['MsSeq'], ['ServCom'], ['SSDate', 'DESC']], area="Sta_Index_2", primary=True, unique=True)
        t.index('ServPac', [['MsSeq'], ['ServPac'], ['ServCom'], ['SSDate', 'DESC']], area="Sta_Index_2")
