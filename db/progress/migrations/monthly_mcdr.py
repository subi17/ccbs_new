...
class AddMobCDR(Migration):

    dumped_on = 'propus'
    database = 'mcdr'

    def up(self):
        t = self.table('MobCDR', area='Dyn_Data_64',
                       label='Mobile Cdr',
                       dump_name='mcdr')
        ...
        t.column('SubsType', 'character', format='x(1)', initial='',
                 column_label='SubsType',
        ...
        t.column('DCEvent', 'character', format='x(12)', initial='',
                 ...
                 column_label='P.Contract',
                 help='Periodical contract')
        t.column('RerateID', 'integer', format='>>>>>>>>9', initial='0',
                 column_label='RerateID',
                 description='Rerating run ID')
        t.column('RerateTS', 'decimal', decimals=5, format='99999999.99999', initial='0',
                 column_label='RerateTS',
        ...
        t.index('gsmbnr', ['DateSt', 'GsmBnr'], area='Dyn_Index4')
        t.index('InvCust', ['InvCust', 'DateSt', 'TimeStart'], area='Dyn_Index5')
        t.index('invseq', ['InvCust', 'InvSeq'], area='Dyn_Index6')
        t.index('spocmt', ['SPOcmt'], area='Dyn_Index4')

    def down(self):
        self.drop_table('MobCDR')
