...
class AddTableIPRange(Migration):
    ...
    def up(self):
        t = self.table('IPRange', area="Sta_Data_128", multitenant="yes", dump_name="iprange")
        ...
        t.index('IPRange', [['NetworkAddress']], area="Sta_Index_3", primary=True, unique=True)
        t.index('FromDate', [['FirstIP'], ['LastIP']], area="Sta_Index_3")
