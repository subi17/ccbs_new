...
class AddFieldDeliveryType(Migration):
    ...
    def up(self):
        ...
        t.column('ParamKeys', 'character', format="x(60)", initial="", max_width=120, label="ParamKeys", column_label="ParamKeys", position=31, order=300, help="CHR(14) separated parameter key list. (if present)")
