...
class AddTableSubsTerminal(Migration):
    ...
    def up(self):
        t = self.table('SubsTerminal', area="Sta_Data_64", multitenant="yes", label="Subscription Terminal", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-substerminal.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-substerminal.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="substerminal", desc="Terminal of a subscription")
