...
class AddTablePrepRowCounter(Migration):
    ...
    def up(self):
        ...
        t.column('FromDate', 'date', format="99-99-99", max_width=4, label="Events From", column_label="From", position=6, order=50, help="Beginning of event period")
        t.column('ToDate', 'date', format="99-99-99", max_width=4, label="Events To", column_label="To", position=7, order=60, help="Events to date")
