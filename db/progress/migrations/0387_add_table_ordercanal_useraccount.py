...
class AddTableUserAccount(Migration):
    ...
    def up(self):
        t = self.table('UserAccount', area="Sta_Data_2_128", dump_name="useraccount", desc="Enduser accounts for logging-in on selfcare pages")
        ...
        t.index('login', [['login']], area="Sta_Index_3", primary=True, unique=True)
        t.index('CustNum', [['CustNum']], area="Sta_Index_3", unique=True)
