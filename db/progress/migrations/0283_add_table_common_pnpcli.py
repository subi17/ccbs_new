...
''')
        t.column('ValidFrom', 'date', format="99-99-99", help="Valid from", max_width=4, label="Begin Date", column_label="From", position=4, order=30, description='''


''')
        t.column('ValidTo', 'date', format="99-99-99", help="Valid to", max_width=4, label="End Date", column_label="To", position=5, order=40, description='''
''')
