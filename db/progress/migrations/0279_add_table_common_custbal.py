...
class AddTableCustBal(Migration):
    ...
    def up(self):
        t = self.table('CustBal', area="Sta_Data_128", multitenant="yes", label="Customer's balances", dump_name="custbal", desc='''Customer's balances
...
''')
        ...
        t.index('Custnum', [['CustNum'], ['CLI']], area="Sta_Index_3", primary=True, unique=True)
        t.index('MsSeq', [['CustNum'], ['MsSeq']], area="Sta_Index_3")
