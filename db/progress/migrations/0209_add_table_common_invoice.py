...
class AddTableInvoice(Migration):
    ...
    def up(self):
        ...
        t.column('InvDate', 'date', format="99-99-99", max_width=4, label="InvDate", column_label="InvDate", position=3, order=20, help="Invoice's date")
        ...
        t.column('DueDate', 'date', format="99-99-99", max_width=4, label="DueDate", column_label="DueDate", position=5, order=40, help="Invoice's dueday")
        ...
        t.column('FromDate', 'date', format="99-99-99", max_width=4, label="Calls from", column_label="Calls from", position=10, order=90, help="Date of Invoice's earliest call ")
        t.column('ToDate', 'date', format="99-99-99", max_width=4, label="LastCall", column_label="LastCall", position=11, order=100, help="Discount's previous call date")
        t.column('FirstCall', 'date', format="99-99-99", max_width=4, label="FirstCall", column_label="FirstCall", position=12, order=110, help="Invoice's first call date")
        ...
        t.column('PaymDate', 'date', format="99-99-99", max_width=4, label="PrevPayInDay", column_label="PrevPay", position=27, order=190, help="Invoice's previous payment day")
        t.column('ClaimDate', 'date', format="99-99-99", max_width=4, label="LastRem", column_label="LastRem", position=28, order=200, help="Date when latest reminder was sent to customer")
        t.column('EarliestRem', 'date', format="99-99-99", max_width=4, label="EarlRem", column_label="EarlRem", position=29, order=210, help="Date when first reminder could send ")
        t.column('CashDiscDate', 'date', format="99-99-99", max_width=4, label="CashDisc", column_label="CashDisc", position=31, order=230, help="Due day for payments with decrement of cash discount")
        ...
        t.column('ClaimStamp', 'decimal', format="99999999.99999", decimals=5, max_width=20, label="Claimed", column_label="Claimed", position=60, order=1050, help="Date and time when invoice is claimed")
        ...
        t.column('EPaymDate', 'date', format="99-99-99", max_width=4, label="EPayment Date", column_label="EPaymDate", position=71, order=1150, help="Date when ePayment was made")
