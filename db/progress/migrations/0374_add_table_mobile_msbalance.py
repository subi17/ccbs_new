...
class AddTableMSBalance(Migration):
    ...
    def up(self):
        t = self.table('MSBalance', area="Sta_Data_2_128", multitenant="yes", label="Mobsub Balance", dump_name="msbalance-------1", desc="Subscription balances")
        ...
        t.index('MsSeq', [['MSSeq'], ['CustNum'], ['BalType']], area="Sta_Index_3", primary=True, unique=True)
        t.index('CustNum', [['CustNum'], ['MSSeq'], ['BalType']], area="Sta_Index_3")
