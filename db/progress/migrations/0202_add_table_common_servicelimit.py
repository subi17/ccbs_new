...
class AddTableServiceLimit(Migration):
    ...
    def up(self):
        ...
        t.column('ValidFrom', 'date', format="99-99-99", help="Valid from this date on", max_width=4, label="Valid From", position=18, order=160, description='''

''')
        t.column('ValidTo', 'date', format="99-99-99", help="Valid until this date", max_width=4, label="Valid To", position=19, order=170, description='''
''')
