...
class AddTableMServiceLimit(Migration):
    ...
    def up(self):
        t = self.table('MServiceLimit', area="Sta_Data_128", multitenant="yes", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-mservicelimit.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-mservicelimit.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="mservice")
        ...
        t.index('msseq', [['MsSeq'], ['DialType'], ['SLSeq'], ['EndTS', 'DESC']], area="Sta_Index_5", primary=True, unique=True)
        t.index('Active', [['MsSeq'], ['DialType'], ['FromTS'], ['EndTS']], area="Sta_Index_4")
        t.index('CustNum', [['custnum'], ['DialType'], ['SLSeq'], ['EndTS', 'DESC']], area="Sta_Index_4")
        t.index('slseq', [['SLSeq'], ['DialType'], ['EndTS', 'DESC']], area="Sta_Index_4")
