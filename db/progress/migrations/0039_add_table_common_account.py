...
class AddTableAccount(Migration):
    ...
    def up(self):
        t = self.table('Account', area="Sta_Data_128", multitenant="yes", label="Accounts", dump_name="account", desc="Accounts")
        ...
        t.index('AccNum', [['Brand'], ['AccNum']], area="Sta_Index_3", primary=True, unique=True)
        t.index('AccName', [['Brand'], ['AccName']], area="Sta_Index_3")
