...
class AddTableUpdateQueue(Migration):
    ...
    def up(self):
        t = self.table('UpdateQueue', area="Sta_Data_2_64", dump_name="updatequeue")
        ...
        t.index('Seq1', [['Seq1'], ['State']], area="Sta_Index_3", primary=True)
        t.index('State', [['State']], area="Sta_Index_3")
