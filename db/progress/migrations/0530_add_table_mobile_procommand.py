...
class AddTableProCommand(Migration):
    ...
    def up(self):
        ...
        t.column('ActivationTS', 'datetime-tz', format="99/99/9999 HH:MM:SS.SSS+HH:MM", initial=self.unknown, max_width=12, label="Activation", position=4, order=30, help="Date and time when procommand acknowledged from BUS/BPM")
        ...
        t.column('ProCommandStatus', 'integer', format=">>9", initial="0", max_width=4, label="Status", position=9, order=80, help="Status: 0 - New, 1 - Ongoing, 2 - Done, 3 - Error")
