...
class AddTableVAService(Migration):
    ...
    def up(self):
        ...
        t.column('FromDate', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="From Date", column_label="From", position=9, order=70, help="First effective date")
        t.column('ToDate', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="To Date", column_label="To", position=10, order=80, help="Last effective date")
