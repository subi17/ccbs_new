...
6= price per minute or second''')
        ...
        t.column('ValidFrom', 'date', format="99-99-99", max_width=4, label="Valid From", column_label="Valid From", position=16, order=130, help="The date FROM which this price will be used.")
        ...
        t.column('ValidTo', 'date', format="99-99-99", max_width=4, label="Valid To", column_label="Valid To", position=23, order=180, help="The date TO (until) which this price will be used.")
