...
class AddTableDCServiceComponent(Migration):
    ...
    def up(self):
        t = self.table('DCServiceComponent', area="Sta_Data_2_128", multitenant="yes", label="DC Service Component", dump_name="dcservicecomponent", desc="Service component settings for packages related to periodical contract")
