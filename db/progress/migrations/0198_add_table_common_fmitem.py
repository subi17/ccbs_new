...
class AddTableFMItem(Migration):
    ...
    def up(self):
        ...
        t.column('Amount', 'decimal', format="->,>>9.999", decimals=3, initial="0", max_width=17, label="Price", column_label="Price", position=7, order=60, help="Billable price of an item")
        ...
        t.column('InclAmt', 'decimal', format="->,>>9.999", decimals=3, initial="0", max_width=17, label="Included Amount", column_label="Incl.Amt", position=12, order=110, help="Amount of billable material that is included in this fee")
        ...
        t.index('FeeModel', [['Brand'], ['FeeModel'], ['PriceList'], ['BillCode'], ['FromDate', 'DESC']], area="Sta_Index_3", primary=True, unique=True)
        t.index('BillCode', [['Brand'], ['FeeModel'], ['BillCode'], ['PriceList'], ['FromDate', 'DESC']], area="Sta_Index_3")
