...
class AddTableProgLimit(Migration):
    ...
    def up(self):
        ...
        t.column('ValidFrom', 'date', format="99-99-99", max_width=4, label="Valid From", position=18, order=60, help="Valid from this date on")
        t.column('ValidTo', 'date', format="99-99-99", max_width=4, label="Valid To", position=19, order=70, help="Valid until this date")
