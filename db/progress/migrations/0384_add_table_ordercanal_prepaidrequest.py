...
class AddTablePrePaidRequest(Migration):
    ...
    def up(self):
        t = self.table('PrePaidRequest', area="Sta_Data_32", multitenant="yes", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-prepaidrequest.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-prepaidrequest.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="prepaidr")
