...
class AddTableClaimHist(Migration):
    ...
    def up(self):
        t = self.table('ClaimHist', area="Sta_Data_128", multitenant="yes", label="Claiming history", dump_name="claimhis", desc="Claiming history of invoice")
        ...
        t.index('InvNum_s', [['InvNum'], ['Claim']], area="Sta_Index_3", primary=True, unique=True)
        t.index('ClaimDate', [['Brand'], ['ClaimDate', 'DESC'], ['InvNum']], area="Sta_Index_3")
        t.index('CustNum', [['Brand'], ['CustNum'], ['ClaimDate', 'DESC']], area="Sta_Index_3")
        t.index('InvNum', [['Brand'], ['InvNum'], ['Claim']], area="Sta_Index_3")
