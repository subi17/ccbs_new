...
class AddTableDMS(Migration):
    ...
    def up(self):
        t = self.table('DMS', area="Sta_Data_128", multitenant="yes", label="Document mgmt case", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-dms.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-dms.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="dms", desc="Document management case")
