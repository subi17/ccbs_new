...
class AddTableprogjob(Migration):
    ...
    def up(self):
        ...
        t.column('startdate', 'date', format="99.99.99", initial=self.unknown, max_width=4, label="Start", position=7, order=80, help="Start date")
        t.column('enddate', 'date', format="99.99.99", initial=self.unknown, max_width=4, label="End", position=8, order=90, help="End date")
        ...
        t.column('lastchanged', 'date', format="99.99.99", initial=self.unknown, max_width=4, label="Last changed", position=10, order=100)
