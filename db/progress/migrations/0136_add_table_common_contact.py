...
''')
        ...
        t.column('ConDate', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="Contact Date", column_label="Date", position=4, order=30, help="Date when contact was taken")
        ...
        t.column('PlanDate', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="Contact Planned", column_label="Planned", position=9, order=80, help="Date when contact was planned to be taken")
