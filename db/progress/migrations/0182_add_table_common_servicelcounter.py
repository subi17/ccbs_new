...
class AddTableServiceLCounter(Migration):
    ...
    def up(self):
        t = self.table('ServiceLCounter', area="Sta_Data_128", multitenant="yes", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-servicelcounter.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-servicelcounter.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="servcou1")
        ...
        t.index('CustNum', [['CustNum'], ['Period', 'DESC'], ['SLSeq']], area="Sta_Index_4")
