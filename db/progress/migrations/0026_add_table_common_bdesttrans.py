...
class AddTableBDestTrans(Migration):
    ...
    def up(self):
        ...
        t.column('ToDate', 'date', format="99-99-9999", max_width=4, label="Valid To", column_label="ToDate", position=6, order=60, help="Last effective day")
        t.column('FromDate', 'date', format="99-99-9999", max_width=4, label="Valid From", column_label="FromDate", position=7, order=70, help="First effective day")
