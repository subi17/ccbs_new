...
class AddTableSLCounterItem(Migration):
    ...
    def up(self):
        t = self.table('SLCounterItem', area="Sta_Data_2_128", multitenant="yes", dump_name="slcounteritem-------1", desc="Keep a count of items for ServiceLCounter")
        ...
        t.index('msseq', [['MsSeq'], ['Period', 'DESC'], ['SLSeq'], ['SLCItem']], area="Sta_Index_5", primary=True)
