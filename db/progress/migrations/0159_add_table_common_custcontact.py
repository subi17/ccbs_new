...
class AddTableCustContact(Migration):
    ...
    def up(self):
        t = self.table('CustContact', area="Sta_Data_32", multitenant="yes", label="CustContact", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-custcontact.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-custcontact.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="custcontact", desc="CustContact")
