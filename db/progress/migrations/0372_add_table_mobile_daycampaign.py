...
class AddTableDayCampaign(Migration):
    ...
    def up(self):
        t = self.table('DayCampaign', area="Sta_Data_2_128", multitenant="yes", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-daycampaign.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-daycampaign.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="daycampa")
