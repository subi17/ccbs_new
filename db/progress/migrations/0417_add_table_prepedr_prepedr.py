...
class AddTablePrepEDR(Migration):
    ...
    def up(self):
        ...
        t.column('DateSt', 'date', format="99.99.99", max_width=4, label="CallDate", column_label="CallDate", position=4, order=30, help="Date when the data record was generated")
        ...
        t.column('ReadDate', 'date', format="99-99-99", max_width=4, label="Read In Date", column_label="ReadDate", position=9, order=80, help="Read in date")
