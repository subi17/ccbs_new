...
class AddTableMthCall(Migration):
    ...
    def up(self):
        ...
        t.column('CloseDate', 'date', format="99-99-99", initial=self.unknown, help="Closing date", max_width=4, label="Closing Date", column_label="Cl.date", position=6, order=150, description="Closing date")
