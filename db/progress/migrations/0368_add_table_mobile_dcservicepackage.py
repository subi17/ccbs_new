...
class AddTableDCServicePackage(Migration):
    ...
    def up(self):
        t = self.table('DCServicePackage', area="Sta_Data_2_128", multitenant="yes", label="DC Service Package", dump_name="dcservicepackage", desc="Service packages related to periodical contract")
