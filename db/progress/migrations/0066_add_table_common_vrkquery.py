...
class AddTableVRKQuery(Migration):
    ...
    def up(self):
        ...
        t.column('MovingDate', 'date', format="99/99/99", max_width=4, label="MovingDate", column_label="MovingDate", position=10, order=100)
        ...
        t.column('TempFrom', 'date', format="99/99/99", max_width=4, label="TempFrom", column_label="TempFrom", position=14, order=140, description="Temporary address valid from")
        t.column('TempTo', 'date', format="99/99/99", max_width=4, label="TempTo", column_label="TempTo", position=15, order=150, description="Temporary address valid to")
        ...
        t.column('DeathDay', 'date', format="99/99/99", max_width=4, label="DeathDay", column_label="DeathDay", position=18, order=180, description="Date of death")
