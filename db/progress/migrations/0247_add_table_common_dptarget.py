...
class AddTableDPTarget(Migration):
    ...
    def up(self):
        t = self.table('DPTarget', area="Sta_Data_128", multitenant="yes", label="Discount Plan Target", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-dptarget.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-dptarget.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="dptarget")
