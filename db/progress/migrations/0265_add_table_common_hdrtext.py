...
class AddTableHdrText(Migration):
    ...
    def up(self):
        t = self.table('HdrText', area="Sta_Data_128", multitenant="yes", label="HdrText", dump_name="hdrtext", desc="Header texts for reports")
        ...
        t.index('te-nro', [['Brand'], ['te-nro'], ['te-kie']], area="Sta_Index_3", primary=True, unique=True)
        t.index('te-kie', [['Brand'], ['te-kie'], ['te-nro']], area="Sta_Index_3", unique=True)
        t.index('te-text', [['Brand'], ['te-text']], area="Sta_Index_3")
