...
class AddTableFixedFeeTF(Migration):
    ...
    def up(self):
        t = self.table('FixedFeeTF', area="Sta_Data_128", multitenant="yes", label="Financed Contract Fees", dump_name="fixedfeetf", desc="Extension of FixedFee table. Contains financing info")
        ...
        t.column('BankDate', 'date', format="99-99-9999", initial=self.unknown, max_width=4, label="Bank Date", column_label="BankDate", position=4, order=30, help="Date of Contract")
        t.column('BankRespDate', 'date', format="99-99-9999", initial=self.unknown, max_width=4, label="Bank Resp. Date", column_label="BankRespDate", position=5, order=40, help="Date of Contract")
        t.column('CancelDate', 'date', format="99-99-9999", initial=self.unknown, max_width=4, label="Cancel Date", column_label="Cancel Date", position=6, order=50, help="Date of Contract")
