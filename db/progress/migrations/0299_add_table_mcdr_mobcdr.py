...
class AddTableMobCDR(Migration):

    database = "mcdr"

    def up(self):
        t = self.table('MobCDR', area="Dyn_Data_64", multitenant="yes", label="Mobile Cdr", dump_name="mcdr---1")
...
''')
        ...
        t.column('ReadTime', 'integer', format="zzzzz9", initial="0", max_width=4, label="ReadTime", column_label="ReadTime", position=205, order=2540, description="Time while collecting CDR's")
        t.column('Accumulator', 'integer', format=">>>>>>>>>9", initial="0", max_width=4, label="Accumulator", column_label="Accumulator", position=206, order=2550, help="Accumulator value")
