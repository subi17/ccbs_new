...
class AddTableMNPRetentionRule(Migration):
    ...
    def up(self):
        t = self.table('MNPRetentionRule', area="Sta_Data_128", multitenant="yes", label="MNPRetentionRule", dump_name="mnpretentionrule", desc="MNP retention rules")
        ...
        t.index('RetentionRuleID', [['RetentionRuleID']], area="Sta_Index_3", primary=True, unique=True)
