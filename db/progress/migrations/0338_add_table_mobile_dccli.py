...
class AddTableDCCLi(Migration):
    ...
    def up(self):
        t = self.table('DCCLi', area="Sta_Data_128_2", multitenant="yes", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-dccli.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-dccli.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="dccli-------1")
