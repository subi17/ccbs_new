...
class AddTableCGMember(Migration):
    ...
    def up(self):
        t = self.table('CGMember', area="Sta_Data_2_256", multitenant="yes", label="Customer Group Members", dump_name="cgmember", desc="Customer Group Member records;  join customers&cust.groups")
        ...
        t.index('CustGroup', [['Brand'], ['CustGroup'], ['CustNum']], area="Sta_Index_3", primary=True, unique=True)
        t.index('CustName', [['Brand'], ['CustGroup'], ['CustName'], ['CustNum']], area="Sta_Index_3", unique=True)
        t.index('CustNum', [['Brand'], ['CustNum'], ['CustGroup']], area="Sta_Index_3", unique=True)
        t.index('CustNum_s', [['CustNum'], ['CustGroup']], area="Sta_Index_3", unique=True)
