...
class AddTableOffer(Migration):
    ...
    def up(self):
        t = self.table('Offer', area="Sta_Data_64", multitenant="yes", label="Offer", dump_name="offer", desc="Offer header")
        ...
        t.index('Offer', [['Brand'], ['Offer']], area="Sta_Index_3", primary=True, unique=True)
        t.index('Active', [['Brand'], ['Active'], ['ToDate', 'DESC']], area="Sta_Index_3")
