...
class AddTableDPBasis(Migration):
    ...
    def up(self):
        t = self.table('DPBasis', area="Sta_Data_2_256", multitenant="yes", label="Volume Discount Basis", dump_name="dpbasis", desc='''Basis of volume discount (DpConf).
''')
        ...
        t.index('DpConfNum', [['DPConfNum'], ['BasisType', 'DESC']], area="Sta_Index_3", primary=True)
        t.index('KeyField', [['DPConfNum'], ['KeyField']], area="Sta_Index_3")
