...
class AddTableFeeModel(Migration):
    ...
    def up(self):
        t = self.table('FeeModel', area="Sta_Data_64", multitenant="yes", label="Billing Event", dump_name="bevent", desc="A group of single and/or periodical fees")
        ...
        t.index('FeeModel', [['Brand'], ['FeeModel']], area="Sta_Index_3", primary=True, unique=True)
        t.index('FeeGroup', [['Brand'], ['FMGroup']], area="Sta_Index_3")
        t.index('FeeName', [['Brand'], ['FeeName'], ['FeeModel']], area="Sta_Index_3", unique=True)
