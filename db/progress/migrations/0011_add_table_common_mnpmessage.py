...
class AddTableMNPMessage(Migration):
    ...
    def up(self):
        t = self.table('MNPMessage', area="Sta_Data_64", multitenant="yes", dump_name="mnpmessa")
        ...
        t.index('MNPSeq', [['MNPSeq']], area="Sta_Index_4", primary=True)
        t.index('Sender', [['Sender'], ['StatusCode']], area="Sta_Index_4")
