...
class AddTableCustGroup(Migration):
    ...
    def up(self):
        ...
        t.column('ChgDate', 'date', format="99-99-99", max_width=4, label="Changed", column_label="Changed", position=5, order=40, help="Date when Group and/or its members were changed")
