...
class AddTableCustGroup(Migration):
    ...
    def up(self):
        t = self.table('CustGroup', area="Sta_Data_2_256", multitenant="yes", label="Customer Groups", dump_name="custgrou", desc="Customer Groups")
        ...
        t.index('CustGroup', [['Brand'], ['CustGroup']], area="Sta_Index_3", primary=True, unique=True)
        t.index('CGName', [['Brand'], ['CGName']], area="Sta_Index_3")
