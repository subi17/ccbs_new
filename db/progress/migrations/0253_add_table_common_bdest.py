...
class AddTableBDest(Migration):
    ...
    def up(self):
        t = self.table('BDest', area="Sta_Data_128", multitenant="yes", label="B-Destinations", dump_name="bdest", desc="B-Destinations")
        ...
        t.index('BDest', [['Brand'], ['BDest'], ['DestType'], ['ToDate', 'DESC']], area="Sta_Index_3", primary=True, unique=True)
        t.index('BDestID', [['BdestID']], area="Sta_Index_3", unique=True)
        t.index('BDName', [['Brand'], ['BDName'], ['BDest']], area="Sta_Index_3")
        t.index('CCN', [['Brand'], ['CCN'], ['BDName'], ['BDest']], area="Sta_Index_3")
