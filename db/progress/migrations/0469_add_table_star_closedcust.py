...
class AddTableClosedCust(Migration):
    ...
    def up(self):
        ...
        t.column('Date', 'date', format="99-99-99", initial=self.unknown, help="Closing date", max_width=4, label="ClDate", column_label="ClDate", position=3, order=20, description="Closing date")
        t.column('DateOpen', 'date', format="99-99-99", initial=self.unknown, help="Opening date", max_width=4, label="OpDate", column_label="OpDate", position=4, order=150, description="Opening date")
