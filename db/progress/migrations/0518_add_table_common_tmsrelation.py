...
class AddTableTMSRelation(Migration):
    ...
    def up(self):
        ...
        t.column('ParentValue', 'character', format="x(30)", initial="", max_width=60, label="Parent value", column_label="ParentValue", position=4, order=30)
        t.column('ChildValue', 'character', format="x(30)", initial="", max_width=60, label="Child value", column_label="ChildValue", position=5, order=40)
