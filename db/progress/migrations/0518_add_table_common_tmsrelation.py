...
class AddTableTMSRelation(Migration):
    ...
    def up(self):
        ...
        t.index('KeyValue1', [['TableName'], ['KeyType'], ['KeyValue1'], ['ToTime', 'DESC']], area="Sta_Index_3", primary=True)
        t.index('KeyValue2', [['TableName'], ['KeyType'], ['KeyValue2'], ['KeyValue1'], ['ToTime', 'DESC']], area="Sta_Index_3", unique=True)
