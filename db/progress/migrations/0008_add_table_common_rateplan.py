...
class AddTableRatePlan(Migration):
    ...
    def up(self):
        t = self.table('RatePlan', area="Sta_Data_128", multitenant="yes", label="Rating Plan", dump_name="rateplan", desc="Rating plan for invoice target")
        ...
        t.index('RatePlan', [['Brand'], ['RatePlan']], area="Sta_Index_3", primary=True, unique=True)
        t.index('RPName', [['Brand'], ['RPName']], area="Sta_Index_3")
