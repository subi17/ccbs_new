...
class AddTableTopupScheme(Migration):
    ...
    def up(self):
        t = self.table('TopupScheme', area="Sta_Data_64", multitenant="yes", label="Topup Scheme", dump_name="topupscheme", desc="Topup scheme")
        ...
        t.index('ToupScheme', [['Brand'], ['TopupScheme']], area="Sta_Index_3", primary=True, unique=True)
        t.index('Source', [['Brand'], ['TopupSource'], ['ToDate', 'DESC']], area="Sta_Index_3")
