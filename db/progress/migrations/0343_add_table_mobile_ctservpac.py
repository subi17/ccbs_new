...
class AddTableCTServPac(Migration):
    ...
    def up(self):
        t = self.table('CTServPac', area="Sta_Data_128_2", multitenant="yes", label="CLIType Service Packages", dump_name="ctservpa", desc="Service Packages of a CLI type")
        ...
        t.column('CLIType', 'character', format="x(13)", initial="", max_width=16, label="CLI Type", column_label="CLIType", position=3, order=20, help="CLI type")
