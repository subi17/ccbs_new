...
class AddTablecfoSer(Migration):
    ...
    def up(self):
        ...
        t.column('ValidFrom', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="Valid From", column_label="Valid From", position=7, order=60, help="The date FROM which this CFO series will be used.")
        t.column('ValidTo', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="Valid To", column_label="Valid To", position=8, order=70, help="The date TO (until) which this CFO Series will be used.")
