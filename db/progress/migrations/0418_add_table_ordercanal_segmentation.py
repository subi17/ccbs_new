...
class AddTableSegmentation(Migration):
    ...
    def up(self):
        t = self.table('Segmentation', area="Sta_Data_128", multitenant="yes", dump_name="segmentation", desc="Collect segmentation information")
        ...
        t.column('SegmentDate', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="Segmentation Date", column_label="SegmentDate", position=5, order=40, help="Date when segmentation code was changed")
