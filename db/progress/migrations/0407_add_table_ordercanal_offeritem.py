...
class AddTableOfferItem(Migration):
    ...
    def up(self):
        t = self.table('OfferItem', area="Sta_Data_128", multitenant="yes", label="Offer Item", dump_name="offeritem", desc="Offer item")
        ...
        t.index('Item', [['Brand'], ['Offer'], ['OfferItemID']], area="Sta_Index_3", primary=True)
        t.index('EndStamp', [['Brand'], ['Offer'], ['EndStamp', 'DESC']], area="Sta_Index_3")
        t.index('ItemKey', [['Brand'], ['ItemType'], ['ItemKey']], area="Sta_Index_3")
        t.index('ItemType', [['Brand'], ['Offer'], ['ItemType'], ['ItemKey'], ['EndStamp', 'DESC']], area="Sta_Index_3")
        t.index('OfferItemID', [['OfferItemID']], area="Sta_Index_3", unique=True)
