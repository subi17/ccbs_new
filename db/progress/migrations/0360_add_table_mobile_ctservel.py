...
class AddTableCTServEl(Migration):
    ...
    def up(self):
        t = self.table('CTServEl', area="Sta_Data_128_2", multitenant="yes", label="CLIType Service Elements", dump_name="ctservel", desc="Service elements of a CLI type")
        t.column('CLIType', 'character', format="x(13)", initial="", max_width=16, label="CLI Type", column_label="CLIType", position=2, order=20, help="CLI type")
