...
class AddTableeventlog(Migration):
    ...
    def up(self):
        ...
        t.column('eventdate', 'date', format="99.99.99", max_width=4, label="Date", position=2, order=10, help="Event date")
        ...
        t.column('TimingDate', 'date', format="99-99-99", max_width=4, label="TimingDate", column_label="TimingDate", position=13, order=120, help="Timing Date (schedule date)")
