...
class AddTableDCCli(Migration):
    ...
    def up(self):
        ...
        t.column('ValidTo', 'date', format="99-99-9999", max_width=4, label="Valid To", column_label="To", position=5, order=40, help="Valid to")
        ...
        t.column('ContractDate', 'date', format="99-99-99", max_width=4, label="Contract Date", column_label="Contract", position=8, order=70, help="Date when contract was originally signed")
        t.column('TermDate', 'date', format="99-99-99", max_width=4, label="Termination Date", column_label="Terminate", position=9, order=80, help="Date when contract when will be terminated")
        ...
        t.column('RenewalDate', 'date', format="99-99-99", max_width=4, label="Renewal Date", column_label="Renewal", position=12, order=110, help="Date when contract was renewed")
        t.column('ValidToOrig', 'date', format="99-99-9999", max_width=4, label="Valid To Original", column_label="ValidToOrig", position=13, order=120, help="Original Valid To")
        ...
        t.column('Amount', 'decimal', format="->>>>>>9.99999", decimals=5, max_width=20, label="Amount", column_label="Amount", position=15, order=140, help="Penalty amount")
