...
class AddTableOffer(Migration):
    ...
    def up(self):
        ...
        t.column('FromDate', 'date', format="99-99-99", max_width=4, label="Valid From", column_label="From", position=6, order=50, help="Date when offer becomes effective")
        t.column('ToDate', 'date', format="99-99-99", max_width=4, label="Valid To", column_label="To", position=7, order=60, help="Date when offer expires")
