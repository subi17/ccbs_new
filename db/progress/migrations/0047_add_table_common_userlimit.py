...
class AddTableUserLimit(Migration):
    ...
    def up(self):
        t = self.table('UserLimit', area="Sta_Data_64", multitenant="yes", label="UserLimit", dump_name="userlimit", desc="User or usergroup limits")
        ...
        t.index('Limit', [['Brand'], ['LimitType'], ['LimitTarget'], ['LimitTargetID']], area="Sta_Index_3", primary=True, unique=True)
