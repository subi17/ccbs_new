...
class AddTablePresel(Migration):
    ...
    def up(self):
        ...
        t.column('AuthDate', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="AuthDate", column_label="AuthDate", position=10, order=100, help="Date of Authorisation")
        ...
        t.column('ConfDate', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="Date of confirm", column_label="ConfDate", position=13, order=130, help="Date of confirmation")
        ...
        t.column('SentDate', 'date', format="99-99-99", initial=self.unknown, max_width=4, label="SentDate", column_label="SentDate", position=15, order=150, help="Date when preselection has been sent")
