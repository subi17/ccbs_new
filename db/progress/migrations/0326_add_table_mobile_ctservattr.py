...
class AddTableCTServAttr(Migration):
    ...
    def up(self):
        t = self.table('CTServAttr', area="Sta_Data_128_2", multitenant="yes", label="CLIType Service Attributes", dump_name="ctservat", desc='''Attributes of CLI type's service components
