...
class AddTableTMSParam(Migration):
    ...
    def up(self):
        t = self.table('TMSParam', area="Sta_Data_128", multitenant="yes", label="Configuration Parameters", dump_name="tmsparam", desc="Company parameters")
        ...
        t.index('ParamGroup', [['Brand'], ['ParamGroup'], ['ParamCode']], area="Sta_Index_3", primary=True, unique=True)
        t.index('ParamCode', [['Brand'], ['ParamCode'], ['ParamGroup']], area="Sta_Index_3", unique=True)
        t.index('ParamName', [['Brand'], ['ParamName']], area="Sta_Index_3")
