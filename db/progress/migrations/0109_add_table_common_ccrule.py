...
''')
        ...
        t.column('ValidFrom', 'date', format="99-99-99", max_width=4, label="Effective date", column_label="Eff.date", position=4, order=30, help="Date when rule becomes effective")
