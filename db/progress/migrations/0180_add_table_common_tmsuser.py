...
class AddTableTMSUser(Migration):
    ...
    def up(self):
        t = self.table('TMSUser', area="Sta_Data_32", multitenant="yes", label="Users", dump_name="tmsuser", desc="Users")
        ...
        t.index('UserCode', [['UserCode', 'ABBREVIATED']], area="Sta_Index_3", primary=True, unique=True)
        t.index('ForeignId', [['ForeignId'], ['UserCode'], ['UserName']], area="Sta_Index_3")
        t.index('UserGroup', [['UserGroup']], area="Sta_Index_3")
        t.index('UserName', [['UserName'], ['UserCode']], area="Sta_Index_3", unique=True)
        t.index('UserNum', [['UserNum']], area="Sta_Index_3", unique=True)
