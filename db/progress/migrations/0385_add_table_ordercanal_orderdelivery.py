...
class AddTableOrderDelivery(Migration):
    ...
    def up(self):
        t = self.table('OrderDelivery', area="Sta_Data_32", multitenant="yes", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-orderdelivery.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-orderdelivery.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="orderdelivery")
