...
class AddTableBarring(Migration):
    ...
    def up(self):
        t = self.table('Barring', area="Sta_Data_128", multitenant="yes", label="Barring", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-barring.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-barring.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="barring", desc="Barring information")
