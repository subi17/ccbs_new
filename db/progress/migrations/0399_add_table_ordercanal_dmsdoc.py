...
class AddTableDMSDOC(Migration):
    ...
    def up(self):
        t = self.table('DMSDOC', area="Sta_Data_128", multitenant="yes", label="Document", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-dmsdoc.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-dmsdoc.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="dmsdoc", desc="DMS Document")
