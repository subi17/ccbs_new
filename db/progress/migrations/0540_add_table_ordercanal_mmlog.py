...
class AddTableMMLog(Migration):
    ...
    def up(self):
        ...
        t.column('SchedulingPolicy', 'character', format="x(30)", initial="", max_width=60, label="SchedulingPolicy", column_label="SPolicy", position=12, order=110, help="From template. Name of scheduling policy. (optional)")
        t.column('SchedulingPriority', 'integer', format=">>>9", initial="", max_width=4, label="SchedulingPriority", column_label="SPriority", position=13, order=120, help="From template. Priority of message for scheduling in RabbitMQ. (optional)")
