...
class AddTableMCDRDtl(Migration):
    ...
    def up(self):
        ...
        t.column('Complete', 'integer', format="9", initial=self.unknown, max_width=4, label="Complete", column_label="Complete", position=106, order=2050, help="0 = Connection still active 1= Connection ready")
        ...
        t.column('mstype', 'character', format="x(8)", initial=self.unknown, max_width=16, label="MType", column_label="Mtype", position=175, order=940, help="Type Of Mobsub (connection type)")
        t.column('DataVol', 'integer', format=">>>>>>9", initial=self.unknown, max_width=4, label="Data Vol", column_label="Data Vol", position=176, order=2020, help="Data Volume")
        t.column('DataRef', 'integer', format=">>>>>9", initial=self.unknown, max_width=4, position=177, order=2030, help="Data Volume ref")
        t.column('UserMsisdn', 'character', format="x(24)", initial=self.unknown, max_width=60, label="UserMsisdn", column_label="UserMsisdn", position=178, order=2150, help="Target MSISDN")
        t.column('ReadInTS', 'decimal', format="99999999.99999", decimals=5, initial=self.unknown, max_width=17, label="TimeStamp", column_label="TimeStamp", position=179, order=2210, help="Read In Timestamp")
        t.column('MMSServiceName', 'character', format="x(20)", initial=self.unknown, max_width=40, label="MMSServiceName", column_label="MMSServiceName", position=181, order=2240, help="MMS Service Name")
        t.column('MMSServiceTarget', 'character', format="x(41)", initial=self.unknown, max_width=82, label="MMS Service Target", column_label="MMS Service Target", position=182, order=2250, help="MMS Service Target")
        t.column('MMSPlatformStatus', 'character', format="x(4)", initial=self.unknown, max_width=8, label="Platform", column_label="Platform", position=183, order=2260, help="MMS Platform Status")
        t.column('RateCategory', 'character', format="x(4)", initial=self.unknown, max_width=8, label="Rate Category", column_label="Rate Category", position=184, order=2270, help="Rate Category")
        ...
        t.column('DateSt', 'date', format="99.99.99", initial=self.unknown, max_width=4, label="CallDate", column_label="CallDate", position=188, order=470, help="Date When call started")
