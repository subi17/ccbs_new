...
class AddTableFATGMember(Migration):
    ...
    def up(self):
        t = self.table('FATGMember', area="Sta_Data_128", multitenant="yes", label="FAT Group Members", dump_name="fatgmemb", desc="Members for the FAT Group (FtGrp)")
        ...
        t.index('FtGrp', [['Brand'], ['FtGrp'], ['MemberType'], ['FtgMember']], area="Sta_Index_3", primary=True, unique=True)
