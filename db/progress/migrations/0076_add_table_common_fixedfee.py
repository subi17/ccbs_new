...
class AddTableFixedFee(Migration):
    ...
    def up(self):
        ...
        t.column('BegDate', 'date', format="99-99-9999", max_width=4, label="ContDate", column_label="ContDate", position=17, order=161, help="Date of Contract")
        ...
        t.column('CalcAmt', 'decimal', format="->>>,>>9.99", decimals=2, max_width=17, label="Calculated Amount", column_label="CalcAmt", position=33, order=290)
