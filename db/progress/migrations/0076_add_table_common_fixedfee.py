...
class AddTableFixedFee(Migration):
    ...
    def up(self):
        t = self.table('FixedFee', area="Sta_Data_32", multitenant="yes", label="Constant / Contract Fees", table_trigger=[{'crc': '?', 'procedure': 'triggers/rd-fixedfee.p', 'override_proc': True, 'event': 'REPLICATION-DELETE'}, {'crc': '?', 'procedure': 'triggers/rw-fixedfee.p', 'override_proc': True, 'event': 'REPLICATION-WRITE'}], dump_name="fixedfee", desc="Constant / contract fees")
        ...
        t.column('Amt', 'decimal', format="->>>,>>9.999", decimals=3, initial="0", max_width=17, label="To Pay", column_label="To Pay", position=5, order=50, help="Contract payment per bill")
        ...
        t.column('OwnCost', 'decimal', format="->>>,>>9.999", decimals=3, initial="0", help="Our own costs per bill", max_width=17, label="Our costs", column_label="Our costs", position=7, order=70, description="Our own costs per bill")
        ...
        t.column('InclAmt', 'decimal', format="->>>,>>9.999", decimals=3, initial="0", max_width=17, label="Included Amount", column_label="Incl.Amt", position=22, order=190, help="Amount of billable material that is included in this fee")
        ...
        t.column('CalcAmt', 'decimal', format="->>>,>>9.999", decimals=3, initial=self.unknown, max_width=17, label="Calculated Amount", column_label="CalcAmt", position=33, order=290)
