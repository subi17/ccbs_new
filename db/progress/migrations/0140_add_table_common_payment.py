...
class AddTablePayment(Migration):
    ...
    def up(self):
        ...
        t.column('InvDate', 'date', format="99-99-99", max_width=4, label="Invoice date", column_label="Invoice date", position=8, order=80, help="Invoice date")
        t.column('DueDate', 'date', format="99-99-99", max_width=4, label="DueDay", column_label="DueDay", position=9, order=90, help="Invoice's due day")
        t.column('PaymDate', 'date', format="99-99-99", max_width=4, label="Payment Date", column_label="Payment Date", position=10, order=100, help="Date of Invoice Payment")
        ...
        t.column('AccDate', 'date', format="99-99-99", max_width=4, label="BookDate", column_label="BookDate", position=14, order=140, help="Date, when payment has been registered in bank")
