...
class AddTableFusionMessage(Migration):
    ...
    def up(self):
        t = self.table('FusionMessage', area="Sta_Data_64", multitenant="yes", label="Fusion Message", dump_name="fusionmessage", desc="Contains messages between TMS and MasMovil")
