...
db_locations = {
    ...
    'barbatus': {'common': '/db1/common/common',
              'ordercanal': '/db1/ordercanal/ordercanal',
              'mobile': '/db1/mobile/mobile',
              'counter': '/db1/counter/counter',
              'star': '/db1/star/star',
              ...
              'fraudcdr': '/db1/fraudcdr/fraudcdr',
              'reratelog': '/db1/reratelog/reratelog'},
    'bartok': {'common': 'barbatus.int.asp.qvantel.net:common',
               'ordercanal': 'barbatus.int.asp.qvantel.net:ordercanal',
               'mobile': 'barbatus.int.asp.qvantel.net:mobile',
               'counter': 'barbatus.int.asp.qvantel.net:counter',
               'star': 'barbatus.int.asp.qvantel.net:star',
               'prepedr': 'barbatus.int.asp.qvantel.net:prepedr',
               'fraudcdr': 'barbatus.int.asp.qvantel.net:fraudcdr',
               'reratelog': 'barbatus.int.asp.qvantel.net:reratelog'},
