...
ELSE DO:
    ...
    liMultiSIMType = (IF MobSub.MultiSIMType EQ 0 THEN {&MULTISIMTYPE_SECONDARY} ELSE 0).
    ...
    IF AVAIL lbMobSub  
    THEN ASSIGN 
         liMultiSimTypeValue = (IF MobSub.MultiSimType = 0 THEN {&MULTISIMTYPE_PRIMARY} ELSE MobSub.MultiSimType)
