...
DO WHILE TRUE ON ENDKEY UNDO:
   ...
   IF FRAME-INDEX EQ 1 THEN DO:
      ...
      RUN Inv/chk_customer_bankacc(lcOutFile).
      RUN Inv/chk_customer_deltype(lcOutFile).
      RUN Inv/chk_invseq_msseq0(lcOutFile).
      RUN Inv/cust_address_missing(lcOutFile).
   ...
   ELSE IF FRAME-INDEX  = 2 THEN DO:
      ...
      RUN Inv/chk_inv_cdr(lcOutFile,ldtinv).
      RUN Inv/chk_inv_acc(lcOutFile,ldtInv).
      RUN Inv/chk_subs_invoice(lcOutFile,ldtInv,ldtFrom,ldtTo).
   ...
   ELSE IF FRAME-INDEX  = 3 THEN DO:
      ...
      RUN Inv/yoigo_printrep(lcOutFile,ldtinv,lldisp).
      RUN Inv/yoigo_0count(lcOutFile,ldtinv).
      RUN Inv/yoigo_invrep(lcOutFile,ldtinv).
