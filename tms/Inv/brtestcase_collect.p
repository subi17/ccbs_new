...
PROCEDURE pCollect:
   ...
   BREAK BY MsOwner.InvCust
      ...
      IF ilgMergeAnalysis THEN DO:
          ...
          RUN pAnalyseMergeAnalysis.
          
          RUN pSaveResultsMergeAnalysis.
      END.
   ...
   IF ilgMergeAnalysis THEN DO:
      FIND ttNoEntriesResult NO-LOCK NO-ERROR.
          
      IF AVAILABLE ttNoEntriesResult THEN DO:
          
         /* IF no entires cases were found then create the 
            results */ 
         RUN pResultNoEntries.
          
         FIND ttResult NO-LOCK NO-ERROR.
        
         IF AVAILABLE ttResult THEN DO:
            RUN pInitializeMergeAnalysis.
...
PROCEDURE pAnalyseMergeAnalysis:
...
PROCEDURE pSaveResultsMergeAnalysis:
