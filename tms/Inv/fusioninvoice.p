...
WITH  OVERLAY ROW 8 centered
    COLOR VALUE(Syst.Var:cfc)
    TITLE COLOR VALUE(Syst.Var:ctc) "MOBILE INVOICE"
    SIDE-LABELS 
    2 columns
    FRAME lis2.
...
form /* seek FusionInvoice  BY  FusionInvoice */
    ...
    WITH row 4 col 2 TITLE COLOR VALUE(Syst.Var:ctc) " FIND FuInvNo "
    COLOR VALUE(Syst.Var:cfc) NO-LABELS OVERLAY FRAME f1.

form /* seek FusionInvoice  BY CoName */
    liCustnum
    HELP "Enter InvDate"
    WITH row 4 col 2 TITLE COLOR VALUE(Syst.Var:ctc) " FIND InvDate "
    COLOR VALUE(Syst.Var:cfc) NO-LABELS OVERLAY FRAME f2.

form /* seek FusionInvoice  BY CoName */
    liCustnum
    HELP "Enter CustomerId"
    WITH row 4 col 2 TITLE COLOR VALUE(Syst.Var:ctc) " FIND CustomerID "
...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 92  Syst.Var:ufk[2]= 28 Syst.Var:ufk[3]= 812 Syst.Var:ufk[4]= 707
        Syst.Var:ufk[5]= 0 /* (IF lcRight = "RW" THEN 5 ELSE 0) */
        Syst.Var:ufk[6]= 0 /* (IF lcRight = "RW" THEN 4 ELSE 0) */
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) FusionInvoice.FuInvNum WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW FusionInvoice.Invdate {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) FusionInvoice.Invdate WITH FRAME sel.
      END.
      ELSE IF order = 3 THEN DO:
        CHOOSE ROW FusionInvoice.CustomerID {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) FusionInvoice.CustomerID WITH FRAME sel.
      END.
      ELSE IF order = 4 THEN DO:
        CHOOSE ROW FusionInvoice.Custnum {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) FusionInvoice.Custnum WITH FRAME sel.
      END.
...
PROCEDURE local-UPDATE-record:
   ...
   IF ufkey THEN DO:
     ASSIGN
     Syst.Var:ufk = 0
     Syst.Var:ufk[1]= 216 WHEN fusioninvoice.MsSeq > 0 
