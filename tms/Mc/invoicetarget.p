...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ...
        Syst.CUICommon:ufk[5]= (IF lcRight = "RW" AND iiITGroupID > 0 THEN 5 ELSE 0)  
/*        Syst.CUICommon:ufk[6]= (IF lcRight = "RW" THEN 4 ELSE 0) */
      ...
      IF order = 1 THEN DO:
        CHOOSE ROW InvoiceTarget.InvoiceTargetID {Syst/uchoose.i} NO-ERROR 
           WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.CUICommon:ccc) InvoiceTarget.InvoiceTargetID WITH FRAME sel.
      END.
...
PROCEDURE local-VIEW-record:
   ...
   REPEAT ON ENDKEY UNDO, LEAVE:
      ...
      ASSIGN 
         ...
         Syst.CUICommon:ufk[7] = 1522 WHEN lcRight EQ "RW" 
         Syst.CUICommon:ufk[8] = 8
