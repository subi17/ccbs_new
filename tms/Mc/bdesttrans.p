...
ADD-ROW:
      REPEAT WITH FRAME lis ON ENDKEY UNDO ADD-ROW, LEAVE ADD-ROW.
        ...
        ASSIGN
            Syst.Var:ufk    = 0
            Syst.Var:ufk[1] = 1052    WHEN lcRight = "RW"
            Syst.Var:ufk[2] = 0
            Syst.Var:ufk[3] = 0
            Syst.Var:ufk[4] = 0
            Syst.Var:ufk[6] = 0
...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) bdesttrans.translatenumber WITH FRAME sel.
      END.
      /*
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW bdesttrans.CoName {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) bdesttrans.CoName WITH FRAME sel.
      END.*/
...
PROCEDURE local-UPDATE-record:
   ...
   IF NEW bDestTrans THEN Syst.Var:toimi = -1.
