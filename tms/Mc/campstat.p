...
IF llDoEvent THEN DO:
   ...
   ON F12 ANYWHERE DO:
      RUN Mc/eventview2.p(lhCampStat).
   END.
...
form /* seek  CampStat */
    ...
    WITH row 4 col 2 TITLE COLOR VALUE(Syst.Var:ctc) " FIND Campaign "
...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 1729  Syst.Var:ufk[2]= 714 Syst.Var:ufk[3]= 653  Syst.Var:ufk[4]= 28
        Syst.Var:ufk[5]= 0 
        Syst.Var:ufk[6]= 0 
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) CampStat.Campaign WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW CampStat.CustNum {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) CampStat.CustNum WITH FRAME sel.
      END.
      ELSE IF order = 3 THEN DO:
        CHOOSE ROW CampStat.CLI {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) CampStat.CLI WITH FRAME sel.
      END.
      ELSE IF order = 4 THEN DO:
        CHOOSE ROW CampStat.CampDate {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) CampStat.CampDate WITH FRAME sel.
      END.
