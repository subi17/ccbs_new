...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ...
        Syst.Var:ufk[7]= (IF lcRight = "RW" THEN 1851 ELSE 0)
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) CustClass.CustClass WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW CustClass.CCName {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) CustClass.CCName WITH FRAME sel.
      END.
