...
WITH ROW FrmRow width 80 OVERLAY FrmDown  DOWN
    ...
    TITLE COLOR VALUE(Syst.Var:ctc) " " + Syst.Var:ynimi +
       " CAMPAIGNS "  + string(TODAY,"99-99-99") + " "
    FRAME sel.
...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 35  Syst.Var:ufk[2]= 30 Syst.Var:ufk[3]= 28  Syst.Var:ufk[4]= 1728
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) Campaign.Campaign WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW Campaign.CaName {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) Campaign.CaName WITH FRAME sel.
      END.
      ELSE IF order = 3 THEN DO:
        CHOOSE ROW Campaign.ToDate {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) Campaign.ToDate WITH FRAME sel.
      END.
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"4,f4") > 0 THEN DO:  /* rows */
       {Syst/uright2.i}
       RUN local-find-this (FALSE).
