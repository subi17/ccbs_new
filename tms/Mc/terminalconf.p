...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) TerminalConf.TerminalCode WITH FRAME sel.
      END.
      /*
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW TerminalConf.CoName {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) TerminalConf.CoName WITH FRAME sel.
      END.
      */
     ...
     /* Search BY column 1 */
     /*ELSE IF LOOKUP(Syst.Var:nap,"1,/1") > 0 THEN DO ON ENDKEY UNDO, NEXT LOOP:*/
     ...
     ON ENDKEY UNDO, LEAVE:
       ...
       ASSIGN ac-hdr = " DETAILS " ufkey = TRUE Syst.Var:ehto = 9. RUN Syst/ufkey.p.
