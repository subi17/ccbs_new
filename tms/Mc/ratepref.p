...
WITH ROW FrmRow width 80 OVERLAY FrmDown  DOWN
    ...
    TITLE COLOR VALUE(Syst.Var:ctc) " " + Syst.Var:ynimi +
       " Rating Prefixes "  + string(TODAY,"99-99-99") + " "
    FRAME sel.
...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) RatePref.Prefix WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW RatePref.DialType {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) RatePref.DialType WITH FRAME sel.
      END.
