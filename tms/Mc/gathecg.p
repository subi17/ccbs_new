...
FIND FIRST CustGroup
   USE-INDEX CustGroup  WHERE CustGroup.Brand = Syst.Var:gcBrand NO-LOCK no-error.
   ...
   DO :
    ...
    repeat WITH FRAME sel:
       IF AVAILABLE CustGroup  THEN DO:
          ...
          USE-INDEX CGName WHERE CustGroup.Brand = Syst.Var:gcBrand NO-LOCK no-error.
...
BROWSE:
   repeat WITH FRAME sel ON ENDKEY UNDO, RETURN:
      IF ufkey THEN DO:
    ASSIGN
    Syst.Var:ufk[1]= 1709 Syst.Var:ufk[2]= 717 Syst.Var:ufk[3]= 0 Syst.Var:ufk[4]= 0
   ...
   CustGroup = "". Syst.Var:ehto = 9. RUN Syst/ufkey.p. ufkey = TRUE.
