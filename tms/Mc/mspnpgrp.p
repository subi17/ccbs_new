      ...
      repeat WITH FRAME lis ON ENDKEY UNDO add-new, LEAVE add-new.
        ...
        DO TRANSACTION:
           ...
           FIND FIRST xxPnpgroup WHERE
                      xxPnpgroup.Brand    = Syst.Var:gcBrand AND 
...
BROWSE:
   repeat WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 0  Syst.Var:ufk[2]= 0 Syst.Var:ufk[3]= 0 Syst.Var:ufk[4]= 1764
     ...
     END.
       ...
       IF ok THEN DO:
           ...
           IF NOT can-find(FIRST PNPGroup
              WHERE PNPGroup.Brand = Syst.Var:gcBrand ) THEN DO:
