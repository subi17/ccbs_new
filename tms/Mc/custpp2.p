...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.CUICommon:ufk[1]= 35 Syst.CUICommon:ufk[2]= 1759 Syst.CUICommon:ufk[3]= 250 Syst.CUICommon:ufk[4]= 927
      ...
      IF order = 1 THEN DO:
        CHOOSE ROW CustPP.ProdPack {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.CUICommon:ccc) CustPP.ProdPack WITH FRAME sel.
      END.
     ...
     ELSE IF LOOKUP(Syst.CUICommon:nap,"2,f2") > 0 THEN DO TRANS:  /* other customers  */
       RUN local-find-this(FALSE).                                        
