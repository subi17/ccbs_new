...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 35 Syst.Var:ufk[2]= 1759 Syst.Var:ufk[3]= 250 Syst.Var:ufk[4]= 927
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) CustPP.ProdPack WITH FRAME sel.
      END.
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"2,f2") > 0 THEN DO TRANS:  /* other customers  */
       RUN local-find-this(FALSE).                                        
