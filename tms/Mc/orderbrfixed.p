...
DEFINE TEMP-TABLE ttOrder NO-UNDO
 ...
 FIELD Fixednumber  AS CHARACTER
...
DEF INPUT PARAMETER icFixedNumber AS CHAR NO-UNDO.
...
form
    ...
    ttOrder.FixedNumber        LABEL "Fixed Num" FORMAT "x(9)"
    ttOrder.Contract    
...
FOR EACH OrderFusion NO-LOCK WHERE
   ...
   FIND FIRST Order WHERE
              ...
              Order.OrderId = OrderFusion.OrderId
   NO-LOCK NO-ERROR.
   ...
   IF AVAILABLE Order THEN DO:
      ...
      ASSIGN ttOrder.TimeStamp   = Order.CrStamp
             ...
             ttOrder.FixedNumber = OrderFusion.Fixednumber
