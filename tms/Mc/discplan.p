...
BROWSE:
   REPEAT WITH FRAME sel on ENDkey undo, return:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.CUICommon:ufk[1]= 35  Syst.CUICommon:ufk[2]= 30 Syst.CUICommon:ufk[3]= 235 Syst.CUICommon:ufk[4]= 927
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.CUICommon:ccc) discplan.DiscPlan WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        choose row discplan.DPName {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.CUICommon:ccc) discplan.DPName WITH FRAME sel.
      END.
