...
BROWSE:
   REPEAT WITH FRAME sel on ENDkey undo, return:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 35  Syst.Var:ufk[2]= 30 Syst.Var:ufk[3]= 235 Syst.Var:ufk[4]= 927
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) discplan.DiscPlan WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        choose row discplan.DPName {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) discplan.DPName WITH FRAME sel.
      END.
