/* ----------------------------------------------------------------------
  MODULE .......: ordserv
  TASK .........: UPDATEs table OrderService
  APPLICATION ..: TMS
  AUTHOR .......: aam
  CREATED ......: 24.11.06
  CHANGED ......: 
...
DEF VAR lcSCName   AS CHAR                   NO-UNDO.

DEF BUFFER bOrderService FOR OrderService.
...
WITH ROW FrmRow CENTERED OVERLAY FrmDown  DOWN
    ...
    TITLE COLOR VALUE(Syst.CUICommon:ctc) " SERVICES OF ORDER " + STRING(iiOrderID) + " "
    FRAME sel.
...
IF AVAILABLE OrderService THEN ASSIGN
   Memory       = recid(OrderService)
   must-print   = TRUE
   must-add     = FALSE.
ELSE ASSIGN
   Memory       = ?
...
REPEAT WITH FRAME sel:
   ...
   IF must-add THEN DO:  /* Add a OrderService  */
      ...
      REPEAT WITH FRAME lis ON ENDKEY UNDO ADD-ROW, LEAVE ADD-ROW.
        ...
        REPEAT TRANSACTION WITH FRAME lis ON ENDKEY UNDO, LEAVE:
           ...
           IF INPUT FRAME lis OrderService.Service = ""
           THEN LEAVE add-row.
           ...
           IF CAN-FIND(OrderService WHERE
              ...
              MESSAGE "OrderService already exists with code"     
                      INPUT FRAME lis OrderService.Service
           ...
           IF llDoEvent THEN RUN StarEventMakeCreateEvent(lhOrderService).
      ...
      /* is there ANY record ? */
      RUN local-find-first.
      IF NOT AVAILABLE OrderService THEN LEAVE LOOP.
      NEXT LOOP.
   END.
   ...
   DO :
      IF must-print THEN DO:
        ...
        REPEAT WITH FRAME sel:
           IF AVAILABLE OrderService THEN DO:
              RUN local-disp-row.
              rtab[FRAME-LINE] = recid(OrderService).
              RUN local-find-NEXT.
           END.
           ELSE DO:
              CLEAR NO-PAUSE.
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.CUICommon:ccc) OrderService.Service WITH FRAME sel.
      END.
      ...
      IF order <> pr-order AND MaxOrder > 1 THEN DO:
        ...
        FIND OrderService WHERE recid(OrderService) = Memory NO-LOCK.
        DO i = 1 TO FRAME-LINE - 1:
           RUN local-find-PREV.
           IF AVAILABLE OrderService THEN
              ASSIGN FIRSTrow = i Memory = recid(OrderService).
           ELSE LEAVE.
        END.
        must-print = TRUE.
        NEXT LOOP.
        ...
        IF FRAME-LINE = FRAME-DOWN THEN DO:
           ...
           ELSE DO:
              ...
              DO i = 1 TO FRAME-DOWN - 1:
                 rtab[i] = rtab[i + 1].
              END.
              rtab[FRAME-DOWN] = recid(OrderService).
      ...
      ELSE IF LOOKUP(nap,"PREV-page,page-up,-") > 0 THEN DO:
        ...
        IF AVAILABLE OrderService THEN DO:
           ...
           DO RowNo = 1 TO (FRAME-DOWN - 1):
              RUN local-find-PREV.
              IF AVAILABLE OrderService THEN Memory = recid(OrderService).
     ...
     THEN DO ON ENDKEY UNDO, NEXT LOOP:
       ...
       IF lcServCom > "" THEN DO:
          ...
          ASSIGN Memory     = RECID(OrderService) 
                 must-print = TRUE
                 order      = 1.
          NEXT LOOP.
     ...
     THEN DO TRANSACTION:  /* DELETE */
       ...
       IF ok THEN DO:
           ...
           IF llDoEvent THEN RUN StarEventMakeDeleteEvent(lhOrderService).
     ...
     ON ENDKEY UNDO, LEAVE:
       ...
       IF llDoEvent THEN RUN StarEventMakeModifyEvent(lhOrderService).

       RUN local-disp-row.
       xrecid = recid(OrderService).
       LEAVE.
     END.
...
PROCEDURE local-find-this:
    ...
    IF exlock THEN
      FIND OrderService WHERE recid(OrderService) = rtab[frame-line(sel)] 
      EXCLUSIVE-LOCK.
    ELSE
       FIND OrderService WHERE recid(OrderService) = rtab[frame-line(sel)] 
       NO-LOCK.
