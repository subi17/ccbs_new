...
DEF VAR haku3       LIKE CCN.RepCCN FORMAT ">>>9" NO-UNDO.
...
form
    ...
    title color value(Syst.Var:ctc) " " + Syst.Var:ynimi + " CALL CASE NUMBERS (CCN) "
...
form /* nnmaan nimi :n tunnuksella hakua varten */
    ...
    "CCN .:" haku
    help "Give CCN"
    with row 4 col 2 title color value(Syst.Var:ctc) " FIND CCN"
...
form /* report ccn  */
    ...
    with row 4 col 2 title color value(Syst.Var:ctc) " FIND REPORT CCN "
...
BROWSE:
   repeat WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
         ...
         COLOR DISPLAY value(Syst.Var:ccc) CCN.CCN WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
         CHOOSE ROW CCN.CCNName {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
         COLOR DISPLAY value(Syst.Var:ccc) CCN.CCNName WITH FRAME sel.
      END.
     ...
     /* Haku sarakk. 2 */
     else if lookup(Syst.Var:nap,"2,f2") > 0 THEN DO:  /* haku sar. 2 */
        Syst.Var:cfc = "puyr". RUN Syst/ufcolor.p.
        haku2 = "".
        Syst.Var:ehto = 9. RUN Syst/ufkey.p. ufkey = TRUE.
     ...
     THEN DO TRANSAction:  /* removal */
        ...
        COLOR DISPLAY value(Syst.Var:ctc) CCN.CCN CCN.CCNName.
        ...
        FOR FIRST BDest NO-LOCK WHERE 
           ...
           VIEW-AS ALERT-BOX.
           COLOR DISPLAY value(Syst.Var:ccc) CCN.CCN CCN.CCNName.
           NEXT.
        END.
