...
WITH ROW FrmRow width 80 OVERLAY FrmDown  DOWN
    ...
    TITLE COLOR VALUE(Syst.Var:ctc) " " + Syst.Var:ynimi +
       " TEXT SEND LOG "  + string(TODAY,"99-99-99") + " "
    FRAME sel.
...
form /* seek  ITSendLog */
    ...
    WITH row 4 col 2 TITLE COLOR VALUE(Syst.Var:ctc) " FIND Report Type "
...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 702  Syst.Var:ufk[2]= 92 Syst.Var:ufk[3]= 1739 Syst.Var:ufk[4]= 0
        Syst.Var:ufk[5]= 0
        Syst.Var:ufk[6]= 0 
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) ITSendLog.CustNum WITH FRAME sel.
      END.

      ELSE IF order = 2 THEN DO:
        CHOOSE ROW ITSendLog.InvNum {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) ITSendLog.InvNum WITH FRAME sel.
      END.

      ELSE IF order = 3 THEN DO:
        CHOOSE ROW ITSendLog.RepType {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) ITSendLog.RepType WITH FRAME sel.
      END.
