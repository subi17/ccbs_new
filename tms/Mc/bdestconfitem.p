...
IF llDoEvent THEN DO:
   ...
   ON F12 ANYWHERE DO:
      RUN Mc/eventview2.p(lhBDestConfItem).
   END.
   ...
   IF must-add THEN DO:  /* Add a BDestConfItem  */
      ...
      REPEAT WITH FRAME lis ON ENDKEY UNDO ADD-ROW, LEAVE ADD-ROW.
        ...
        REPEAT TRANS WITH FRAME lis:
           ...
           DISPLAY Syst.Var:gcBrand @ BDestConfItem.Brand
           ...
           ASSIGN 
              BDestConfItem.Brand     = Syst.Var:gcBrand 
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        CHOOSE ROW BDestConfItem.RateCCN {Syst/uchoose.i} NO-ERROR 
           WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) BDestConfItem.RateCCN WITH FRAME sel.
      END.
