...
WITH ROW 1 CENTERED OVERLAY 15  DOWN
    COLOR VALUE(Syst.Var:cfc) TITLE COLOR VALUE(Syst.Var:ctc) "  DOCUMENTS  "  FRAME sel.
...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) ttDocs.DocTypeID WITH FRAME sel.
      END.
 ...
 */
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"enter,return,4,f4") > 0 AND Syst.Var:ufk[4] > 0 THEN DO:
       RUN local-find-this(FALSE).        
