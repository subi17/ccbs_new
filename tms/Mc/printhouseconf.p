...
WITH ROW FrmRow width 80 OVERLAY FrmDown  DOWN
    ...
    TITLE COLOR VALUE(Syst.Var:ctc) " " + Syst.Var:ynimi +
       " PRINTHOUSE CONFIGURATION "  + string(TODAY,"99-99-99") + " "
    FRAME sel.
...
FORM 
    ...
    WITH row 4 col 2 TITLE COLOR VALUE(Syst.Var:ctc) " FIND PrintHouse"
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        CHOOSE ROW PrintHouseConf.PrintHouse {Syst/uchoose.i} NO-ERROR 
           WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) PrintHouseConf.PrintHouse WITH FRAME sel.
      END.
...
PROCEDURE local-UPDATE-record:
   ...
   REPEAT ON ENDKEY UNDO, LEAVE:
      ...
      IF CAN-FIND(FIRST bConf WHERE 
                        bConf.Brand      = Syst.Var:gcBrand                   AND
