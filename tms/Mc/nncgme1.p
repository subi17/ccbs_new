...
WITH centered OVERLAY scroll 1 13 DOWN ROW 2
    ...
    " Members in a c-group " + icCustGroup + " (" + Syst.Var:gcBrand + ") "
   FRAME sel.
...
form /* member :n haku kentällä CustName */
    ...
    with row 4 col 2 title color value(Syst.Var:ctc) " FIND CUST. Name "
...
ADD-CUST:
       repeat TRANS ON ENDKEY UNDO ADD-CUST, LEAVE ADD-CUST.
          ...
          Syst.Var:ufk[1] = 511 Syst.Var:ufk[2] = 513 Syst.Var:ufk[3] = 516 Syst.Var:ufk[4] = 529 Syst.Var:ufk[8] = 8.
          RUN Syst/ufkey.p.

          IF Syst.Var:toimi = 8 THEN LEAVE ADD-CUST.
             ...
             repeat WITH FRAME copy ON ENDKEY UNDO ADD-CUST: 
                ...
                validate(INPUT xcg-code  = "" OR 
                         can-find(xCustGroup where
                                  xCustGroup.Brand     = Syst.Var:gcBrand AND
...
SELAUS:
   repeat WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 702  Syst.Var:ufk[2]= 30 Syst.Var:ufk[3]= 530 Syst.Var:ufk[4]= 518
        Syst.Var:ufk[5]= (IF lcRight = "RW" THEN 1499 ELSE 0)
        Syst.Var:ufk[6]= (IF lcRight = "RW" THEN 4    ELSE 0)
        Syst.Var:ufk[7]= 185 Syst.Var:ufk[8]=   8 Syst.Var:ufk[9]= 1
      ...
      IF jarj = 1 THEN DO:
        ...
        COLOR DISPLAY value(Syst.Var:ccc) CGMember.CustNum WITH FRAME sel.
      END.
      ELSE IF jarj = 2 THEN DO:
        CHOOSE ROW CGMember.CustName {Syst/uchoose.i} no-error WITH FRAME sel.
        COLOR DISPLAY value(Syst.Var:ccc) CGMember.CustName WITH FRAME sel.
      END.
     ...
     END.
        ...
        ASSIGN Qty = 0 Syst.Var:ehto = 3 ufkey = TRUE Syst.Var:ufk = 0. RUN Syst/ufkey.p.
        ...
        NEXT LOOP.
     END.
     else if lookup(Syst.Var:nap,"f7,7") > 0 THEN REPEAT WITH FRAME SEL:
        ...
        ASSIGN
           ...
           Syst.Var:ufk   = 0
           Syst.Var:ehto  = 1
           Syst.Var:ufk[1] = 1883 Syst.Var:ufk[2] = 1888 
           Syst.Var:ufk[4] = 0 Syst.Var:ufk[5]= 0 Syst.Var:ufk[6]= 0 Syst.Var:ufk[7]= 0 Syst.Var:ufk[8]= 8.
        RUN Syst/ufkey.p.   

        IF Syst.Var:toimi = 8 THEN NEXT SELAUS.

        IF Syst.Var:toimi = 1 THEN RUN Mc/commontt.p(CGMember.CustNum).

        IF Syst.Var:toimi = 2 THEN RUN Mc/mobilett.p(CGMember.CustNum).
