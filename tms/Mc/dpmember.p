...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ...
        Syst.CUICommon:ufk[1]= 1852 WHEN iiDPId > 0
        Syst.CUICommon:ufk[5]= (IF lcRight = "RW" AND iiDPId = 0 THEN 5 ELSE 0)  
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.CUICommon:ccc) DPMember.KeyValue WITH FRAME sel.
      END.
