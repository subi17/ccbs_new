...
form
    ...
    FixedFee.ServiceLimitGroup NO-LABEL 
        AT 56 FORMAT "X(20)"
WITH OVERLAY ROW 3 centered COLOR value(Syst.Var:cfc) TITLE COLOR value(Syst.Var:ctc)
...
repeat WITH FRAME sel:
   ...
   repeat WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 183 Syst.Var:ufk[2]= 927  Syst.Var:ufk[3]= 2150 Syst.Var:ufk[4]= 609
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY value(Syst.Var:ccc) FixedFee.KeyValue WITH FRAME sel.
      END.
     ...
     ELSE if lookup(Syst.Var:nap,"3,f3") > 0 THEN 
     ...
     DO WITH FRAME lis TRANSACTION ON ENDKEY UNDO, NEXT LOOP:
       ...
       assign fr-header = " FIXED FEE DATA " Syst.Var:cfc = "lis".  RUN Syst/ufcolor.p.
       ...
       IF lcRight = "RW" THEN DO:         
          ...
          ASSIGN 
             Syst.Var:ufk = 0 
             Syst.Var:ufk[1] = 7 
             Syst.Var:ufk[2] = 9845 when CAN-FIND(first fixedfeetf of fixedfee)
             Syst.Var:ufk[8] = 8 
             Syst.Var:ehto = 0 
             ufkey = true.
          RUN Syst/ufkey.p.
