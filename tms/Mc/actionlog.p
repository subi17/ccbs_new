...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) ActionLog.ActionID WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW ActionLog.TableName {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) ActionLog.TableName WITH FRAME sel.
      END.
...
PROCEDURE local-find-FIRST:
   ...
   IF order = 1 THEN DO:
      ...
      ELSE FIND FIRST ActionLog USE-INDEX ActionID WHERE
                      ActionLog.Brand = Syst.Var:gcBrand NO-LOCK NO-ERROR.
   END.      
   ...
   REPEAT ON ENDKEY UNDO, LEAVE:
      ...
      REPEAT WITH FRAME lis ON ENDKEY UNDO, LEAVE:
         ...
         UPDATE ActionLog.ActionStatus WITH FRAME lis EDITING:
            ...
            IF Syst.Var:nap = "F9" AND FRAME-FIELD = "ActionStatus" THEN DO:
      ...
      ELSE IF Syst.Var:toimi = 4 THEN DO:
         ...
         REPEAT WITH FRAME fInfo:
            ...
            THEN Syst.Var:ufk[4] = 20.
 
            RUN Syst/ufkey.p.
        
            IF Syst.Var:toimi = 4 THEN NEXT. 
