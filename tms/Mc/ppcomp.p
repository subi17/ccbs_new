...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.CUICommon:ufk[1]= 35  Syst.CUICommon:ufk[2]= 0 Syst.CUICommon:ufk[3]= 251 Syst.CUICommon:ufk[4]= 0
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.CUICommon:ccc) PPItem.Product WITH FRAME sel.
      END.
     ...
     ELSE IF LOOKUP(Syst.CUICommon:nap,"3,f3") > 0 THEN DO TRANS:  /* Within ProdPack */
       ...
       RUN Mc/ppcomp2.p(PPItem.Product).
       ufkey = TRUE.
       NEXT LOOP.
     END.
