/* ----------------------------------------------------------------------
  MODULE .......: dms_create_file_start2.p
  TASK .........: Create DMS file with long time period.
                  Module reads events from previous exec time time to
...
ASSIGN
       ...
       lcLogFile    = lcLogDir + "tms_to_dms_2_" +
...
ldCollPeriodEndTS = fSecOffSet(ldCurrentTimeTS, -60). /*60 seconds buffer */

/*make actual file creation operations*/
/*DMS_CASE_TYPE_ID_ORDER_ACT "1"
  DMS_CASE_TYPE_ID_ORDER_VFR "4"
  DMS_CASE_TYPE_ID_DIRECT_CH "5"
  DMS_CASE_TYPE_ID_CANCEL "6"*/


RUN dms_create_docfile.p(SUBST("&1,&2,&3,&4",
