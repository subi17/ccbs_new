...
form /* seek  BY  name */
    ...
    WITH row 4 col 2 TITLE COLOR VALUE(Syst.Var:ctc) " FIND FILE "
...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ...
        Syst.Var:ufk[5]= 11 /* 5 */     Syst.Var:ufk[6]= 0 /* 4 */ 
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) ttFile.FName WITH FRAME sel.
      END.
