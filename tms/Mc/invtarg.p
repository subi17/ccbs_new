...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.CUICommon:ufk[1]= 35  Syst.CUICommon:ufk[2]= 30 Syst.CUICommon:ufk[3]= 235 Syst.CUICommon:ufk[4]= 876
     ...
     ELSE IF lookup(Syst.CUICommon:nap,"3,f3") > 0 THEN DO: /* discounts */
        {Syst/uright2.i}
