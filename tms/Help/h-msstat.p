...
form
    ...
    title color value(Syst.Var:ctc) " MSISDN Status codes " overlay frame sel.
...
BROWSE:
      repeat with frame sel on endkey undo, retuRN:
         ...
         color display value(Syst.Var:ccc) MSStat.StatusCode with frame sel.
        ...
        /* Seek */
        if lookup(Syst.Var:nap,"1,f1") > 0 then do:  /* StatusCode */
