...
form
    ...
    title color value(Syst.CUICommon:ctc) " Tokens " overlay frame sel.
...
BROWSE:
      repeat with frame sel on endkey undo, return:
         ...
         color display value(Syst.CUICommon:ccc) token.tokencode with frame sel.
        ...
        /* Seek */
        if lookup(Syst.CUICommon:nap,"1,f1") > 0 then do:  /* token */
