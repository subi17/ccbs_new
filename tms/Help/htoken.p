...
form
    ...
    title color value(Syst.Var:ctc) " Tokens " overlay frame sel.
...
BROWSE:
      repeat with frame sel on endkey undo, return:
         ...
         color display value(Syst.Var:ccc) token.tokencode with frame sel.
        ...
        /* Seek */
        if lookup(Syst.Var:nap,"1,f1") > 0 then do:  /* token */
