/*------------------------------------------------------
  Module .......: H-BEACAP.P
  Parent .......: APPLHELP.P
  FUNCTION .....: Help browser of Bearer capability
  APPLICATION ..: NN
  AUTHOR .......: JP
  CREATED ......: 10-06-99
                  15.09.03 jp Brand 
...
def var bc_name        like BeaCap.BeaCap   no-undo.
...
form
    ...
    title color value(Syst.CUICommon:ctc) " Bearer capabilities " overlay frame sel.
...
print-line:
   do :
      if must-print then do:
         ...
         /* Print to screen */
         rtab = ?.
         do while frame-line<= frame-down and available BeaCap:
            display
            BeaCap.BeaCap
            BeaCap.BCName
            with frame sel.
...
BROWSE:
      repeat with frame sel on endkey undo, retuRN:
         ...
         with frame sel:
            if frame-line = 1 then do:
               ...
               if not available BeaCap then do:
                  ...
                  display BeaCap.BeaCap BeaCap.BCName.
                  rtab[frame-line] = recid(BeaCap).
                  memory = recid(BeaCap).
               end.
            end.
        ...
        /* Seek */
        if lookup(Syst.CUICommon:nap,"1,f1") > 0 then do:  /* bc_name */
