...
form
    ...
    title color value(Syst.Var:ctc) " Manufacturers " overlay frame sel.
...
repeat:
   ...
   find first SimMan WHERE simman.Brand = Syst.Var:gcBrand no-lock no-error.
   ...
   do :
      if must-print then do:
         ...
         do while frame-line<= frame-down and available SimMan:
            ...
            down with frame sel.
            find next SimMan WHERE simman.Brand = Syst.Var:gcBrand no-lock no-error.
         end.
         must-print = false.
      ...
      repeat with frame sel on endkey undo, retuRN:
         ...
         with frame sel:
            if frame-line = 1 then do:
               ...
               find prev SimMan WHERE simman.Brand = Syst.Var:gcBrand no-lock no-error.
               if not available SimMan then do:
                  bell.
         ...
         /* previous page */
            ...
            if available SimMan then do:
               ...
               do i = 1 to (frame-down - 1):
                  find prev SimMan WHERE simman.Brand = Syst.Var:gcBrand 
                  no-lock no-error.
        ...
        /* Seek */
        if lookup(Syst.Var:nap,"1,f1") > 0 then do:  /* Mancode */
        ...
        /* First record */
           ...
           find first SimMan no-lock WHERE simman.Brand = Syst.Var:gcBrand.
           memory = recid(SimMan).
           must-print = true.
           next LOOP.
        end. /* First record */
        ...
        /* last record */
           ...
           find last SimMan no-lock WHERE simman.Brand = Syst.Var:gcBrand.
           memory = recid(SimMan).
           must-print = true.
           next LOOP.
        end. /* last record */
