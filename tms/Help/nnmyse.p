...
WITH centered OVERLAY scroll 1 10 DOWN ROW 6
    ...
    " Salesman BROWSER: FROM (" + Syst.Var:gcBrand + ") '"  + Salesman + "' " 
    FRAME sel.
...
Syst.Var:cfc = "sel". RUN Syst/ufcolor.p. ASSIGN Syst.Var:ccc = Syst.Var:cfc.
   FIND FIRST Salesman USE-INDEX Salesman WHERE 
      Salesman.Brand = Syst.Var:gcBrand NO-LOCK no-error.
   ...
   repeat WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order <> ex-order THEN DO:
         ...
         DO i = 1 TO FRAME-LINE - 1:
            ...
            USE-INDEX Salesman WHERE Salesman.Brand = Syst.Var:gcBrand NO-LOCK no-error.
            ELSE IF order = 1 THEN FIND prev Salesman
            USE-INDEX SmName WHERE Salesman.Brand = Syst.Var:gcBrand NO-LOCK no-error.
