...
WITH ROW FrmRow CENTERED OVERLAY FrmDown DOWN
    ...
    TITLE COLOR VALUE(Syst.Var:ctc) "  PostCodes  " 
    FRAME sel.

form /* seek  PostCode */
    "Zip Code:" lcZipCode
    HELP "Enter zip code"
    WITH row 4 col 2 TITLE COLOR VALUE(Syst.Var:ctc) " FIND Zip Code "
...
form /* seek  */
    ...
    WITH row 4 col 2 TITLE COLOR VALUE(Syst.Var:ctc) " FIND Post Office "
...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
         ...
         COLOR DISPLAY VALUE(Syst.Var:ccc) PostCode.ZipCode WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
         CHOOSE ROW PostCode.PostOffice {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
         COLOR DISPLAY VALUE(Syst.Var:ccc) PostCode.PostOffice WITH FRAME sel.
      END.
      ELSE IF order = 3 THEN DO:
         CHOOSE ROW PostCode.Region {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
         COLOR DISPLAY VALUE(Syst.Var:ccc) PostCode.Region WITH FRAME sel.
      END.
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"5,f5,enter,return") > 0 THEN DO: 
        ...
        IF AVAILABLE PostCode THEN DO:
           ASSIGN siirto   = PostCode.ZipCode
                  Syst.Var:si-recid = RECID(PostCode).
           LEAVE LOOP.
        END.
     END.
