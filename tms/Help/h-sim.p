...
form
    ...
    title color value(Syst.Var:ctc) " SIM CARDS BY ICC ID " overlay frame sel.
...
repeat:
   ...
   find first SIM  use-index SimSer WHERE 
              sim.Brand = Syst.Var:gcBrand no-lock no-error.
      ...
      if must-print then do:
         ...
         do while frame-line<= frame-down and available SIM:
            ...
            find next SIM no-lock use-index SimSer WHERE 
                      sim.Brand = Syst.Var:gcBrand no-error.
         end.
         must-print = false.
...
~                  rtab[frame-line] = recid(SIM).
         ...
         /* previous page */
            ...
            if available SIM then do:
               ...
               do i = 1 to (frame-down - 1):
                  ...
                  WHERE sim.Brand = Syst.Var:gcBrand no-error. 
        ...
        /* Seek */
        if lookup(Syst.Var:nap,"1,f1") > 0 then do:  /* ICC */
