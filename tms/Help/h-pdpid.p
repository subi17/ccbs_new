...
form
    ...
    title color value(Syst.CUICommon:ctc) " PDP " overlay frame sel.
...
repeat:
   ...
   find first servattr WHERE servattr.servcom = servcom no-lock no-error.
   ...
   do :
      if must-print then do:
         ...
         do while frame-line<= frame-down and available servattr:
            ...
            down with frame sel.
            find next servattr  WHERE servattr.servcom = servcom 
            no-lock no-error.
         end.
         must-print = false.
      ...
      repeat with frame sel on endkey undo, retuRN:
         ...
         with frame sel:
            if frame-line = 1 then do:
               ...
               find prev servattr WHERE servattr.servcom = servcom
                no-lock no-error.
               if not available servattr then do:
                  bell.
        ...
        /* First record */
           ...
           find first servattr  WHERE servattr.servcom = servcom no-lock.
           memory = recid(servattr).
           must-print = true.
           next LOOP.
        end. /* First record */
        ...
        /* last record */
           ...
           find last servattr  WHERE servattr.servcom = servcom no-lock.
           memory = recid(servattr).
           must-print = true.
           next LOOP.
        end. /* last record */
