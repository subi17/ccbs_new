/*------------------------------------------------------
  MODULE .......: H-LANGUAGE.P
  PARENT .......: APPLHELP.P
  FUNCTION .....: Help browser of languages
  APPLICATION ..: TMS
  AUTHOR .......: aam
  CREATED ......: 25.07.02
  MODIFIED .....: 
...
form
      Language.Language
      Language.LangName  format "x(20)"
    with scroll 1 11 down  row 4 centered color value(Syst.CUICommon:cfc)
    title color value(Syst.CUICommon:ctc) " Languages " overlay frame sel.

form /* SEEK code */
    Language
    help "Enter Code of a Language"
...
repeat:
   ...
   find first Language no-lock no-error.
...
print-line:
   do :
      if must-print then do:
         ...
         /* Print to screen */
         rtab = ?.
         do while frame-line<= frame-down and available Language:
            display
            Language.Language
            Language.LangName
            with frame sel.
            ...
            down with frame sel.
            find next Language no-lock no-error.
         end.
         must-print = false.
      ...
      repeat with frame sel on endkey undo, return:
         ...
         with frame sel:
            if frame-line = 1 then do:
               find Language where recid(Language) = rtab[frame-line] no-lock.
               find prev Language no-lock no-error.
               if not available Language then do:
                  bell.
                  ...
                  display Language.Language Language.LangName.
                  rtab[frame-line] = recid(Language).
                  memory = recid(Language).
               end.
            end.
        ...
        /* Seek */
        if lookup(Syst.CUICommon:nap,"1,f1") > 0 then do:  /* Language */
           Syst.CUICommon:cfc = "puyr". RUN Syst/ufcolor.p.
           Syst.CUICommon:ehto = 9. RUN Syst/ufkey.p. ufkey = true.
           set Language with frame hayr.
        ...
        /* Choose */
           ...
           find Language where recid(Language) = rtab[frame-line] no-lock.
           siirto = string(Language.Language).
           leave MAIN.
        end. /* Choose */
        /* First record */
        else if lookup(Syst.CUICommon:nap,"home,h") > 0 then do:
           find first Language no-lock.
           memory = recid(Language).
           must-print = true.
           next LOOP.
        end. /* First record */
