/* ----------------------------------------------------------------------
  MODULE .......: userkeys.p
  TASK .........: update table userkeys
  APPLICATION ..: TMS
  AUTHOR .......: TK
  CREATED ......: 03.04.03
  CHANGED ......: 02.03.04 jp finalizing
                  09.04.06 tk longer format for usercode
  Version ......: 
  ---------------------------------------------------------------------- */
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
     ...
     ELSE IF LOOKUP(nap,"2,f2") > 0 THEN DO ON ENDKEY UNDO, NEXT LOOP:
       ...
       IF keytype ENTERED THEN DO:
          ...
          USE-INDEX keytype /* srule */ NO-LOCK NO-ERROR.
          IF NOT AVAILABLE userkeys THEN DO:
