...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.CUICommon:ccc) FuncRunExec.FRExecID WITH FRAME sel.
      END.
...
PROCEDURE local-UPDATE-record:
   ...
   REPEAT ON ENDKEY UNDO, LEAVE:
      ...
      IF NOT NEW FuncRunExec THEN DO:
         ASSIGN 
            Syst.CUICommon:ufk    = 0
            Syst.CUICommon:ufk[1] = 7 WHEN FuncRunExec.RunState = "Initialized"
            Syst.CUICommon:ufk[2] = 1125
            Syst.CUICommon:ufk[3] = 1182
            Syst.CUICommon:ufk[4] = 1183
            Syst.CUICommon:ufk[8] = 8
