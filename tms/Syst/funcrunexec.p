...
WITH ROW FrmRow CENTERED OVERLAY FrmDown  DOWN
    ...
    TITLE COLOR VALUE(Syst.Var:ctc) lcTitle
    FRAME sel.
...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) FuncRunExec.FRExecID WITH FRAME sel.
      END.
...
PROCEDURE local-UPDATE-record:
   ...
   REPEAT ON ENDKEY UNDO, LEAVE:
      ...
      IF NOT NEW FuncRunExec THEN DO:
         ASSIGN 
            Syst.Var:ufk    = 0
            Syst.Var:ufk[1] = 7 WHEN FuncRunExec.RunState = "Initialized"
            Syst.Var:ufk[2] = 1125
            Syst.Var:ufk[3] = 1182
            Syst.Var:ufk[4] = 1183
            Syst.Var:ufk[8] = 8
      ...
      ELSE IF Syst.Var:toimi = 3 THEN RUN Syst/funcrunexeclog.p(FuncRunExec.FRExecID).
      
      ELSE IF Syst.Var:toimi = 4 THEN RUN Syst/funcrunprocess.p(FuncRunExec.FRConfigID,
                                                  FuncRunExec.FRExecID).
