...
IF llDoEvent THEN DO:
   ...
   ON F12 ANYWHERE DO:
      RUN Mc/eventview2.p(lhFuncRunConfig).
   END.
...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.CUICommon:ccc) FuncRunConfig.ConfName WITH FRAME sel.
      END.
   ...
   REPEAT ON ENDKEY UNDO, LEAVE:
      ...
      ELSE DO:
         ASSIGN 
            ...
            Syst.CUICommon:ufk[2] = 1180 
            Syst.CUICommon:ufk[4] = 1181
            Syst.CUICommon:ufk[8] = 8
