...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 973 Syst.Var:ufk[2]= 35 Syst.Var:ufk[3]= 30 Syst.Var:ufk[4]= 927
      ...
      IF order = 2 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) TMSParam.ParamCode WITH FRAME sel.
      END.
      ELSE IF order = 1 THEN DO:
        CHOOSE ROW TMSParam.ParamGroup {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) TMSParam.ParamGroup WITH FRAME sel.
      END.
    IF order = 3 THEN DO:
        CHOOSE ROW TMSParam.ParamName {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) TMSParam.ParamName WITH FRAME sel.
      END.
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"CTRL-P") > 0 THEN DO:
        FIND FIRST TMSParam where
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"7,f7") > 0 THEN DO:
        RUN local-find-this(FALSE).
        RUN Mc/eventsel.p("TMSParam", Syst.Var:gcBrand + chr(255) + TMSParam.ParamGroup +
