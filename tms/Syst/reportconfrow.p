   ...
   IF must-add THEN DO:  /* Add a ReportConfRow  */
      ...
      REPEAT WITH FRAME lis ON ENDKEY UNDO ADD-ROW, LEAVE ADD-ROW.
        ...
        REPEAT TRANS WITH FRAME lis:
           ...
           DISPLAY Syst.Var:gcBrand @ ReportConfRow.Brand
           ...
           ASSIGN 
              ReportConfRow.Brand     = Syst.Var:gcBrand 
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        CHOOSE ROW ReportConfRow.RowType {Syst/uchoose.i} NO-ERROR 
           WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) ReportConfRow.RowType WITH FRAME sel.
      END.
...
PROCEDURE local-find-FIRST:
   ...
   IF order = 1 THEN FIND FIRST ReportConfRow WHERE 
      ReportConfRow.Brand = Syst.Var:gcBrand AND
