...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 30 Syst.Var:ufk[2]= 0 Syst.Var:ufk[3]= 0 Syst.Var:ufk[4]= 0
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) tabletoken.tablename WITH FRAME sel.
      END.
...
PROCEDURE local-update-record:
   ...
   IF fIsAdminToken(TableToken.TokenCode) THEN DO:
      IF NOT fIsAdminUser(Syst.Var:katun) THEN DO:
   ...
   RUN Syst/tokench.p(INPUT-OUTPUT lTokens).
