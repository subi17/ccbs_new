...
IF llDoEvent THEN DO:
   ...
   ON F12 ANYWHERE DO:
      RUN Mc/eventview2.p(lhRequestQueue).
   END.
...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.CUICommon:ufk[1]= 36 Syst.CUICommon:ufk[2]= 0  Syst.CUICommon:ufk[3]= 0  
        Syst.CUICommon:ufk[4]= 6910
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.CUICommon:ccc) RequestQueue.Queue WITH FRAME sel.
      END.
     ...
     ELSE IF LOOKUP(Syst.CUICommon:nap,"4,f4") > 0 THEN DO:
       ...
       IF AVAILABLE RequestQueue THEN 
          RUN Syst/requesttype.p(RequestQueue.Queue).
