...
IF llDoEvent THEN DO:
   ...
   ON F12 ANYWHERE DO:
      RUN Mc/eventview2.p(lhRequestActionRule).
   END.
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        CHOOSE ROW RequestActionRule.ParamField {Syst/uchoose.i} NO-ERROR 
          WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) RequestActionRule.ParamField WITH FRAME sel.
      END.
   ...
   REPEAT ON ENDKEY UNDO, LEAVE:
      ...
      WITH FRAME lis EDITING:
         ...
         IF KEYLABEL(LASTKEY) = "F9" AND FRAME-FIELD = "ParamField" THEN DO:
            ...
            ASSIGN
               Syst.Var:gcHelpParam = "RequestActionRule"
               Syst.Var:si-recid    = ?.
            ...
            IF Syst.Var:si-recid NE ? THEN DO:
               ...
               FIND RequestParam WHERE RECID(RequestParam) = Syst.Var:si-recid
                  NO-LOCK NO-ERROR.
         ...
         ELSE IF LOOKUP(KEYLABEL(LASTKEY),Syst.Var:poisnap) > 0 THEN DO WITH FRAME lis:
