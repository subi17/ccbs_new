...
&scop object-name       starfop_hard.p
...
------------------------------------------------------------------------------*/
    ...
    lcc = "-H localhost -S 4260".
    IF lcc = '' OR lcc = ? 
    THEN RETURN 'ERROR Fpod parameter FOPD-CONNECT missing'.
    ...
    lcc = "w00t".
    IF lcc = '' OR lcc = ? 
    THEN RETURN 'ERROR Fopd parameter FOPD-PASSWORD missing'.
