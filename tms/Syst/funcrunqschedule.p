...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ...
        Syst.CUICommon:ufk[5] = (IF lcRight = "RW" AND FuncRunQueue.Active THEN 5 ELSE 0)  
        Syst.CUICommon:ufk[6] = (IF lcRight = "RW" AND FuncRunQueue.Active THEN 4 ELSE 0)  
...
PROCEDURE local-UPDATE-record:
   ...
   REPEAT ON ENDKEY UNDO, LEAVE:
      ...
      IF NOT NEW FuncRunQSchedule THEN DO:
         ASSIGN 
            Syst.CUICommon:ufk    = 0
            Syst.CUICommon:ufk[1] = 7    WHEN FuncRunQSchedule.RunState = "Scheduled"
            Syst.CUICommon:ufk[2] = 1125
            Syst.CUICommon:ufk[3] = 1181
            Syst.CUICommon:ufk[4] = 1180
            /*
            Syst.CUICommon:ufk[5] = 1189 WHEN FuncRunQSchedule.RunState = "Running"
            Syst.CUICommon:ufk[5] = 1190 WHEN FuncRunQSchedule.RunState = "Paused"
            */
            Syst.CUICommon:ufk[6] = 1188 WHEN LOOKUP(FuncRunQSchedule.RunState, 
                                      "Running,Paused") > 0
            Syst.CUICommon:ufk[8] = 8
