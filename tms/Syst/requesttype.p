...
IF iiQueue > 0 OR Syst.Var:gcHelpParam > "" THEN ASSIGN
   FrmRow  = 2
   FrmDown = 14.
...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ...
        Syst.Var:ufk[3]= 1643  
        Syst.Var:ufk[4]= 6911
        Syst.Var:ufk[5]= (IF lcRight = "RW" AND iiQueue = 0 THEN 5 ELSE 0)  
        Syst.Var:ufk[6]= (IF lcRight = "RW" AND iiQueue = 0 THEN 4 ELSE 0)  
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) RequestType.ReqType WITH FRAME sel.
      END.
