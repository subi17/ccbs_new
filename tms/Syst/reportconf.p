...
FORM 
    ...
    WITH row 4 col 2 TITLE COLOR VALUE(Syst.Var:ctc) " FIND Report"
      ...
      REPEAT WITH FRAME lis ON ENDKEY UNDO ADD-ROW, LEAVE ADD-ROW.
        ...
        REPEAT TRANSACTION WITH FRAME lis:
           ...
           IF CAN-FIND(FIRST ReportConf WHERE 
                             ReportConf.Brand = Syst.Var:gcBrand
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        CHOOSE ROW ReportConf.ReportID {Syst/uchoose.i} NO-ERROR 
           WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) ReportConf.ReportID WITH FRAME sel.
      END.
