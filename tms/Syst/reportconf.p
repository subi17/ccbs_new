...
WITH ROW FrmRow width 80 OVERLAY FrmDown  DOWN
    ...
    TITLE COLOR VALUE(Syst.CUICommon:ctc) " " + Syst.CUICommon:ynimi +
       " REPORT CONFIGURATION "  + string(TODAY,"99-99-99") + " "
    FRAME sel.
...
FORM 
    ...
    WITH row 4 col 2 TITLE COLOR VALUE(Syst.CUICommon:ctc) " FIND Report"
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        CHOOSE ROW ReportConf.ReportID {Syst/uchoose.i} NO-ERROR 
           WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.CUICommon:ccc) ReportConf.ReportID WITH FRAME sel.
      END.
