/* ----------------------------------------------------------------------
  ...
  AUTHOR .......: tk
  CREATED ......: 07.04.03
  CHANGED ......: 03.09.07/aam ConfigValue
  Version ......: M15
  ---------------------------------------------------------------------- */
...
DEF VAR llUsed       AS LOG                    NO-UNDO.

form
    TMSCodes.Tablename    
    TMSCodes.FieldName FORMAT "X(18)" 
    TMSCodes.CodeGroup
    TMSCodes.CodeValue
    TMSCodes.CodeName  FORMAT "x(18)"
    llUsed             FORMAT "Yes/No" COLUMN-LABEL "Used"
...
form
    TMSCodes.Tablename     /* LABEL FORMAT */
    TMSCodes.FieldName    /* LABEL FORMAT */ FORMAT "X(40)"
...
form
    ...
    " Memo: " + TMSCodes.FieldName + " " WITH NO-LABELS 1 columns
    FRAME f4.
...
ADD-ROW:
      REPEAT WITH FRAME lis ON ENDKEY UNDO ADD-ROW, LEAVE ADD-ROW.
        ...
        REPEAT TRANSACTION WITH FRAME lis:
           ...
           IF INPUT FRAME lis TMSCodes.Tablename = "" THEN 
           LEAVE add-row.
           CREATE TMSCodes.
           ASSIGN
           TMSCodes.Tablename = INPUT FRAME lis TMSCodes.Tablename.
           ...
           IF llDoEvent THEN RUN StarEventMakeCreateEvent(lhTMSCodes).
...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) TMSCodes.Tablename WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW TMSCodes.CodeGroup {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) TMSCodes.CodeGroup WITH FRAME sel.
      END.
      ...
      IF order <> pr-order AND MaxOrder > 1 THEN DO:
        ...
        FIND TMSCodes WHERE recid(TMSCodes) = Memory NO-LOCK.
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"1,f1") > 0 THEN DO ON ENDKEY UNDO, NEXT LOOP:
       ...
       IF TMSCodes ENTERED THEN DO:
          FIND FIRST TMSCodes WHERE TMSCodes.Tablename >= TMSCodes
          /* srule */ NO-LOCK NO-ERROR.
          IF NOT AVAILABLE TMSCodes THEN DO:
             BELL.
             MESSAGE "NOT FOUND !".
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"2,f2") > 0 THEN DO ON ENDKEY UNDO, NEXT LOOP:
       ...
       IF CodeGroup ENTERED THEN DO:
          FIND FIRST TMSCodes WHERE TMSCodes.CodeGroup >= CodeGroup
          USE-INDEX CodeGroup /* srule */ NO-LOCK NO-ERROR.
          IF NOT AVAILABLE TMSCodes THEN DO:
             BELL. MESSAGE "NOT FOUND !".
             PAUSE 1 NO-MESSAGE.
             NEXT BROWSE.
          END.
          /* some TMSCodes/FieldName was found */
     ...
     /* UPDATE memo */
     ELSE IF LOOKUP(Syst.Var:nap,"3,f3") > 0 THEN DO TRANS ON ENDKEY UNDO, NEXT LOOP:
        Syst.Var:cfc = "puyr". RUN Syst/ufcolor.p.
        Syst.Var:ehto = 9. 
        ...
        IF llDoEvent THEN RUN StarEventMakeModifyEvent(lhTMSCodes).
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"6,f6") > 0 THEN DO TRANSACTION:  /* DELETE */
       ...
       IF ok THEN DO:
           ...
           IF llDoEvent THEN RUN StarEventMakeDeleteEvent(lhTMSCodes).

           DELETE TMSCodes.

           /* was LAST record DELETEd ? */
           IF NOT CAN-FIND(FIRST TMSCodes
           /* srule */) THEN DO:
