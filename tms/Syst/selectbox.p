...
WITH ROW FrmRow CENTER OVERLAY WIDTH 50 FrmDown DOWN SCROLL 1
    COLOR VALUE(Syst.Var:cfc) TITLE " "  + pcHeader + " "
    FRAME sel.
...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) ttOptions.Name WITH FRAME sel.
      END.
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"enter,return,f5") > 0 THEN DO:
