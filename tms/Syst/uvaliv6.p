...
form
    ...
    with color value(Syst.Var:cfc) title color value(Syst.Var:ctc) " MOVE SUBMENU "
...
form
    ...
    TITLE COLOR value(Syst.Var:ctc) fr-header COLOR value(Syst.Var:cfc)
    FRAME lis.
...
form
 ...
 WITH width 80 OVERLAY scroll 1 15 DOWN
    ...
    title color value(Syst.Var:ctc) " " + Syst.Var:ynimi + " MenuText TREE "
...
repeat WITH FRAME sel:
   ...
   IF must-add THEN DO:  /* valikon lisays  */
      assign Syst.Var:cfc = "lis" ufkey = true fr-header = " LISAYS " must-add = FALSE.
      RUN Syst/ufcolor.p.
      ...
      repeat WITH FRAME lis ON ENDKEY UNDO add-new, LEAVE add-new.
         ...
         repeat TRANSACTION WITH FRAME lis ON ENDKEY UNDO, LEAVE add-new:
            ...
            WITH FRAME lis  EDITING:
               ...
               pois = lookup(Syst.Var:nap,Syst.Var:poisnap) > 0.
...
BROWSE:
   repeat WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
         ASSIGN
         Syst.Var:ufk[1]= 22  Syst.Var:ufk[2]= 1150 Syst.Var:ufk[3]= 35 Syst.Var:ufk[4]= 301
         Syst.Var:ufk[5]= (IF lcRight = "RW" THEN 5   ELSE 0) 
         Syst.Var:ufk[6]= (IF lcRight = "RW" THEN 4   ELSE 0)
         Syst.Var:ufk[7]= (IF lcRight = "RW" THEN 140 ELSE 0)
      ...
      IF order = 1 THEN DO:
         ...
         COLOR DISPLAY value(Syst.Var:ccc) MenuTree.Level WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
         CHOOSE ROW MenuTree.Module {Syst/uchoose.i} no-error WITH FRAME sel.
         COLOR DISPLAY value(Syst.Var:ccc) MenuTree.Module WITH FRAME sel.
      END.
     ...
     if lookup(Syst.Var:nap,"1,f1") > 0 THEN DO:  /* haku sarakk. 1 */
        Syst.Var:cfc = "puyr". RUN Syst/ufcolor.p. haku = "". Syst.Var:ehto = 9. RUN Syst/ufkey.p. ufkey = TRUE.
     ...
     /* Haku sarakk. 3 */
     if lookup(Syst.Var:nap,"3,f3") > 0 THEN DO:  /* haku sar. 2 */
     ...
     /* Search by module */
     if lookup(Syst.Var:nap,"2,f2") > 0 THEN DO: 
        Syst.Var:cfc = "puyr". RUN Syst/ufcolor.p.
        haku3 = "".
        Syst.Var:ehto = 9. RUN Syst/ufkey.p. ufkey = TRUE.
     ...
     else if Syst.Var:nap = "7" or Syst.Var:nap = "f7" AND lcRight = "RW" THEN DO: /* siirto */
        assign ufkey = true Syst.Var:ehto = 9. Syst.Var:cfc = "kline". RUN Syst/ufcolor.p. RUN Syst/ufkey.p.
        DO TRANSACTION ON ENDKEY UNDO, NEXT LOOP:
           assign mista = "" minne = "".
           UPDATE mista minne WITH FRAME siirto EDITING:
              READKEY.
              ASSIGN Syst.Var:nap = keylabel(LASTKEY) pois = lookup(Syst.Var:nap,Syst.Var:poisnap) > 0.
              IF pois THEN DO:
                 HIDE MESSAGE.
...
siirto:             repeat:
     ...
     THEN DO TRANSAction:  /* removal */
        ...
        COLOR DISPLAY value(Syst.Var:ctc) MenuTree.Level MenuTree.MenuId
        ...
        COLOR DISPLAY value(Syst.Var:ccc) MenuTree.Level MenuTree.MenuId
        MenuTree.Position MenuTree.MenuNum tx1 tx2
        MenuTree.MenuType MenuTree.Module MenuTree.MenuTitle MenuTree.State[1]
        MenuTree.MenuClass.
        IF ok THEN DO:
     ...
     else  if lookup(Syst.Var:nap,"return,enter") > 0  THEN DO TRANSACTION
     WITH FRAME lis ON ENDKEY UNDO, NEXT LOOP: /* change */
        ...
        assign ufkey = true Syst.Var:ehto = 9 fr-header = " CHANGE MenuText "
     ...
     if lookup(Syst.Var:nap,"CTRL-P") > 0 THEN DO:
