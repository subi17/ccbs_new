...
WITH ROW 1 width 80 OVERLAY scroll 1 15 DOWN
    ...
    title color value(Syst.Var:ctc) " MENU - TEXTER " FRAME sel.
...
form /* menunron hakua varten */
    ...
    color value(Syst.Var:ctc) " SEEK TEXTNO "
...
form /* menunimen hakua varten */
    ...
    help "Give a text"
    WITH ROW 4 col 2 TITLE
    color value(Syst.Var:ctc) " SEEK TEXT "
...
add-new:
       ...
       IF ufkey THEN DO:
          ASSIGN
          Syst.Var:ufk[1] = 133  Syst.Var:ufk[2] = 134  Syst.Var:ufk[3] = 0    Syst.Var:ufk[4] = 0
          Syst.Var:ufk[5] = 5    Syst.Var:ufk[6] = 4    Syst.Var:ufk[7] = 0    Syst.Var:ufk[8] = 3
       ...
       /* haku */
       if Syst.Var:nap = "f1"  or Syst.Var:nap = "1" THEN DO:  /* fixmenunron haku */
          PAUSE 0 no-message.
       ...
       else if Syst.Var:nap = "f2" or Syst.Var:nap = "2" THEN DO: /* fixmenutekstin haku */
          PAUSE 0 no-message.
     ...
     END. /* removal */
       ...
       else  if Syst.Var:nap = "return" or Syst.Var:nap = "enter" THEN DO:  /* change */
          FIND MenuText where recid(MenuText) = rtab[FRAME-LINE] exclusive-lock.
       ...
       else if Syst.Var:nap = "8" or Syst.Var:nap = "f8" THEN LEAVE BROWSE.
