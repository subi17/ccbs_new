...
IF NOT AVAIL TMSUSER THEN DO:
   MESSAGE 
   "Unknown UserCode " Syst.Var:katun SKIP
   VIEW-AS ALERT-BOX.
   NEXT.
END.
...
BROWSE:
   REPEAT WITH FRAME sel on ENDkey undo, return:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 35  Syst.Var:ufk[2]= 0 /* 30 */ Syst.Var:ufk[3]= 0 Syst.Var:ufk[4]= 0
        Syst.Var:ufk[5]= 11  Syst.Var:ufk[6]= 0 /* 4  */ Syst.Var:ufk[7]= 0 Syst.Var:ufk[8]= 8 Syst.Var:ufk[9]= 1
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) Brand.Brand WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        choose row Brand.BRName {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) Brand.BRName WITH FRAME sel.
      END.
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"5,f5,enter,return") > 0 THEN DO:  /* choose */
