...
IF llDoEvent THEN DO:
   ...
   ON F12 ANYWHERE DO:
      RUN Mc/eventview2.p(lhFuncRunQRow).
   END.
...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        CHOOSE ROW FuncRunQRow.FRQRowSeq {Syst/uchoose.i} NO-ERROR 
           WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) FuncRunQRow.FRQRowSeq WITH FRAME sel.
      END.
         ...
         REPEAT TRANS WITH FRAME lis ON ENDKEY UNDO, LEAVE:
            ...
            WITH FRAME lis EDITING:
               ...
               THEN DO:
                  ...
                  ASSIGN 
                     Syst.Var:gcHelpParam  = "FuncRunQRow"
                     siirto = ?.
