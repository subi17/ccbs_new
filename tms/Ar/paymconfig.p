...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.CUICommon:ufk[1]= 759 Syst.CUICommon:ufk[2]= 1018 Syst.CUICommon:ufk[3]= 0  Syst.CUICommon:ufk[4]= 0
   ...
   REPEAT ON ENDKEY UNDO, LEAVE:
      ...
      IF NOT llNew THEN DO:
         ASSIGN 
            ...
            Syst.CUICommon:ufk[2] = 1644 WHEN PaymConfig.TaxRules
            Syst.CUICommon:ufk[3] = 1698 WHEN lcRight = "RW"
            Syst.CUICommon:ufk[8] = 8
