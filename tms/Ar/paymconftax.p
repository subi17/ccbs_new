...
IF llDoEvent THEN DO:
   ...
   ON F12 ANYWHERE DO:
      RUN Mc/eventview2.p(lhPaymConfTax).
   END.
...
WITH ROW FrmRow CENTERED OVERLAY FrmDown  DOWN
    ...
    TITLE COLOR VALUE(Syst.Var:ctc) " TAX POSTING RULES " 
    FRAME sel.
...
WITH  OVERLAY ROW 12 centered
    COLOR VALUE(Syst.Var:cfc)
    TITLE COLOR VALUE(Syst.Var:ctc) " TAX RULE "
    SIDE-LABELS 
    FRAME lis.
...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) PaymConfTax.TaxZone WITH FRAME sel.
      END.
