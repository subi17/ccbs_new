...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
         ASSIGN
         Syst.CUICommon:ufk[1]= 829
         Syst.CUICommon:ufk[2]= IF PaymPlan.PPStatus < 3 OR PaymPlan.PPStatus = 7
                 THEN 1781 ELSE 0
         ...
         IF ilAutoMode THEN ASSIGN Syst.CUICommon:ufk[5] = 0               
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.CUICommon:ccc) PPInv.InvNum WITH FRAME sel.
      END.
     ...
     ELSE IF LOOKUP(Syst.CUICommon:nap,"8,f8,4,F4") > 0 THEN DO:
        /* move directly to batches */    
        IF LOOKUP(Syst.CUICommon:nap,"4,F4") > 0 THEN ol2Batch = TRUE.
