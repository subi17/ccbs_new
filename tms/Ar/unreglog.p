...
form /* seek  BY  AccDate */
    AccDate
    help "Enter Date"
    WITH row 4 col 2 title COLOR VALUE(Syst.Var:ctc) " FIND BOOKING Date "
...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 28 Syst.Var:ufk[2]= 0 /* 702 */   Syst.Var:ufk[3]= 0 Syst.Var:ufk[4]= 0
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) UnregLog.AccDate WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW UnregLog.CustNum {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) UnregLog.CustNum WITH FRAME sel.
      END.
