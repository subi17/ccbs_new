...
DO:
   ...
   ON F12 ANYWHERE 
   DO:
      RUN Mc/eventview2.p(lhInterest).
   END.
END.
...
form /* seek Interest record  BY IntPerc */
    ...
    "Perc.:" IntPerc
    HELP "Enter Percent"
    WITH row 4 col 2 TITLE COLOR VALUE(Syst.Var:ctc) " FIND PERCENT "
...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 28  Syst.Var:ufk[2]= 789 Syst.Var:ufk[3]= 0 Syst.Var:ufk[4]= 0
      ...
      IF order = 1 THEN DO:
        CHOOSE ROW Interest.ValidFrom {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) Interest.ValidFrom WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW Interest.IntPerc {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) Interest.IntPerc WITH FRAME sel.
      END.
