/* ----------------------------------------------------------------------
  MODULE .......: ifs_collection_action_ui.p
  TASK .........: Read ifs collection actions from files (ui)
  APPLICATION ..: tms
  AUTHOR .......: aam
  CREATED ......: 24.06.09
  Version ......: yoigo
...
FORM 
   SKIP(2)
   "Read IFS collection actions from a file." AT 5 
   SKIP(3)
...
REPEAT WITH FRAME fCrit ON ENDKEY UNDO CritLoop, NEXT CritLoop:
   ...
   ELSE IF toimi = 5 THEN DO:
      ...
      RUN Ar/ifs_collection_action (lcFile,
                                 OUTPUT liRead,
                                 OUTPUT liErrors).
      
      MESSAGE liRead "rows were read." SKIP
              liRead - liErrors
                 "subscriptions were handled succesfully," SKIP
