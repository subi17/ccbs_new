...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ...
        ASSIGN
        Syst.CUICommon:ufk[2]= 0  Syst.CUICommon:ufk[3]= 0  
     ...
     ELSE IF LOOKUP(Syst.CUICommon:nap,"4,f4") > 0 AND Syst.CUICommon:ufk[4] > 0 THEN DO:  /* SHARING */
       {Syst/uright2.i}
       RUN local-find-this (FALSE).
       IF AVAILABLE CoTarg 
     ...
     ELSE IF LOOKUP(Syst.CUICommon:nap,"5,f5") > 0 AND Syst.CUICommon:ufk[5] > 0 AND lcRight = "RW"
     THEN DO:  /* add */
        {Syst/uright2.i}
        must-add = TRUE.
        NEXT LOOP.
