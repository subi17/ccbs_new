...
WITH ROW FrmRow width 80 OVERLAY FrmDown  DOWN
    ...
    TITLE COLOR VALUE(Syst.Var:ctc) " " + Syst.Var:ynimi +
       "  TAXZONES  "  + string(TODAY,"99-99-99") + " "
    FRAME sel.
...
form /* seek  TaxZone */
    ...
    HELP "Enter TaxZone"
    WITH row 4 col 2 TITLE COLOR VALUE(Syst.Var:ctc) " FIND TaxZone "
...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) TaxZone.TaxZone WITH FRAME sel.
      END.
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"4,f4") > 0 AND Syst.Var:ufk[4] > 0 THEN DO:  
        ...
        RUN Mc/invlang.p(7,TaxZone.TaxZone).
