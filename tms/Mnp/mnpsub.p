...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
     ...
     /*   Syst.Var:ufk[5]= 5  WHEN lcRight = "RW" */
        Syst.Var:ufk[6]= 0  /* WHEN lcRight = "RW" */
...
/*        COLOR DISPLAY VALUE(Syst.Var:ccc) mnpsub.cli WITH FRAME sel.*/
      END.
/*      IF order = 2 THEN DO:
        CHOOSE ROW mnpsub.Ratezone {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) mnpsub.Ratezone WITH FRAME sel.
      END. */
