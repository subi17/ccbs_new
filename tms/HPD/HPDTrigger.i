&IF "{&HPDTrigger}" NE "YES"
&THEN

&GLOBAL-DEFINE HPDTrigger YES

/* DSS,DSS_UPSELL,DSS_UPSELL_UPGRADE,DSS2,DSS2_UPSELL,DSS200_UPSELL */
&GLOBAL-DEFINE DSS_SLSEQS 28,29,48,73,74,111
