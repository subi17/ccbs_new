...
ASSIGN 
   ...
   lcActionId      = "UpsellFor1G"                    /* For execution lock   */
   lcTableName     = "YCO-1-Promo-1Gb"                /* For execution lock   */
   ldCurrentTimeTS = Func.Common:mMakeTS()
   lcUpsell        = "DATA1G_UPSELL"                  /* Upsells that will be aded in the promo */
...
ASSIGN 
   lcLogFile    = lcLogDir + "YCO-1_upsell_1Gb_update_" +
...
PUT STREAM sLogFile UNFORMATTED "YCO-1 1Gb Activation starts " +
...
PUT STREAM sLogFile UNFORMATTED "YCO-1 1Gb Activation done " +
