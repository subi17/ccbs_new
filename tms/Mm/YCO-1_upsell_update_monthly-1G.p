/*--------------------------------------------------------------------
  ...
  TASK .........: Activating 1gb upsell for 12 months
  APPLICATION ..: TMS
...
DEF VAR cValidList          AS CHAR NO-UNDO INITIAL
...
ASSIGN 
   ...
   lcActionId      = "SAN1GB_001"                     /* For execution lock   */
   lcTableName     = "SAN1GB_001-Promo-1Gb"           /* For execution lock   */
   ldCurrentTimeTS = Func.Common:mMakeTS()
   lcUpsell        = "SAN1GB_001"                     /* Upsells that will be aded in the promo */
   ldCampaignStart = fCParamDe("YCO-1-1G-FromDate")   /* Promotion start date */
   ldCampaignEnd   = fCParamDe("YCO-1-1G-ToDate").    /* Promotion start date */
...
ASSIGN 
   lcLogFile    = lcLogDir + "SAN1GB_001_upsell_1Gb_update_" +
...
PUT STREAM sLogFile UNFORMATTED "SAN1GB_001 1Gb Activation starts " +
...
PUT STREAM sLogFile UNFORMATTED "SAN1GB_001 1Gb Activation done " +
