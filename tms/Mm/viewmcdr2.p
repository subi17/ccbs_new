...
form /* seek  ttValue */
    lcttValue
    HELP "Enter Value "
    WITH row 4 col 2 TITLE COLOR VALUE(Syst.Var:ctc) " FIND VALUE "
...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 30  Syst.Var:ufk[2]= 9064 Syst.Var:ufk[3]= 0  Syst.Var:ufk[4]= 0
        Syst.Var:ufk[5]= 0
        Syst.Var:ufk[6]= 0
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) ttName WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW ttCallDetail.ttValue {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) ttCallDetail.ttValue WITH FRAME sel.
      END.
