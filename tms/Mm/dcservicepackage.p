...
FORM 
    ...
    WITH row 4 col 2 TITLE COLOR VALUE(Syst.Var:ctc) " FIND Service Pacage "
   ...
   IF must-add THEN DO:  /* Add a DCServicePackage  */
      ...
      REPEAT WITH FRAME lis ON ENDKEY UNDO ADD-ROW, LEAVE ADD-ROW.
        ...
        REPEAT TRANSACTION WITH FRAME lis:
           ...
           DISPLAY Syst.Var:gcBrand @ DCServicePackage.Brand
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        CHOOSE ROW DCServicePackage.ServPac {Syst/uchoose.i} NO-ERROR 
           WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) DCServicePackage.ServPac WITH FRAME sel.
      END.
