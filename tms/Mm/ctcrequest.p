...
FIND FIRST OldCliType WHERE 
           OldCliType.Brand   = Syst.CUICommon:gcBrand AND 
...
IF lcBankNumber ne "" AND
   ...
   NOT CAN-FIND(FIRST bMobSubCust WHERE
                      bMobSubCust.Brand     = Syst.CUICommon:gcBrand AND
...
FIND MsRequest WHERE
     ...
     MsRequest.Brand     = Syst.CUICommon:gcBrand NO-LOCK NO-ERROR.
...
FIND MsRequest WHERE
     MsRequest.MsRequest = iiReqId  AND
     MsRequest.Brand     = Syst.CUICommon:gcBrand EXCLUSIVE-LOCK NO-ERROR.
