...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.CUICommon:ufk[1]= 973 Syst.CUICommon:ufk[2]= 30 Syst.CUICommon:ufk[3]= 1452 Syst.CUICommon:ufk[4]= 1453
        Syst.CUICommon:ufk[5]= (IF lcRight = "RW" THEN 5 ELSE 0)
        Syst.CUICommon:ufk[6]= (IF lcRight = "RW" THEN 4 ELSE 0)
        Syst.CUICommon:ufk[7]= 1069 
     ...
     ELSE IF LOOKUP(Syst.CUICommon:nap,"6,f6") > 0 AND Syst.CUICommon:ufk[6] > 0  THEN DO TRANSACTION:
       /* DELETE */
       {Syst/uright2.i}.
       delrow = FRAME-LINE.
       RUN local-find-this (FALSE).
