/* ----------------------------------------------------------------------
MODULE .......: prepcdr_errordump.p 
TASK .........: Create a dump file for prepaid error cdrs. YOT-1074
APPLICATION ..: TMS
AUTHOR .......: anttis 
CREATED ......: 15.12.10
Version ......: Yoigo
...
FOR EACH PrepCDR NO-LOCK USE-INDEX ReadDate WHERE
   ...
   PUT STREAM sFile UNFORMATTED
      ...
      TRIM(STRING(PrepCDR.Charge,"->>>>>>>>>>>9.9<<<<<")) lcDelimiter
      PrepCDR.ErrorCode                    lcDelimiter
      PrepCDR.EventType                    SKIP.
