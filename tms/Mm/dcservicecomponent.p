        ...
        REPEAT TRANSACTION WITH FRAME lis:
           ...
           EDITING:
              ...
              IF KEYLABEL(LASTKEY) = "F9" THEN DO:
                 ...
                 Syst.Var:gcHelpParam = DCServicePackage.ServPac.
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        CHOOSE ROW DCServiceComponent.ServCom {Syst/uchoose.i} NO-ERROR 
           WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) DCServiceComponent.ServCom WITH FRAME sel.
      END.
   ...
   REPEAT ON ENDKEY UNDO, LEAVE:
      ...
      IF NOT NEW DCServiceComponent THEN REPEAT:
         ASSIGN 
            ...
            Syst.Var:ufk[4] = 2350 WHEN llAttributes
            Syst.Var:ufk[8] = 8
            Syst.Var:ehto   = 0.
