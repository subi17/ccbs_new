...
/* Parameters */
DEF VAR lcProcessMode AS CHAR NO-UNDO. /* ["OTA_OK"|"OTA_KO"] */
...
PUT STREAM sMandaLog UNFORMATTED STRING(TIME,"hh:mm:ss") + ";mandarina_OTA_bob_starts (" + lcProcessMode + ")" SKIP.

/* Verify input parameter */
IF lcProcessMode <> "OTA_OK" AND lcProcessMode <> "OTA_KO" THEN DO:
...
REPEAT:
   ...
   IF NOT (lcFileName BEGINS lcProcessMode) THEN
     NEXT.
