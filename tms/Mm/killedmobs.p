...
BROWSE:
   REPEAT WITH FRAME sel on ENDkey undo, return:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 707  Syst.Var:ufk[2]= 209 Syst.Var:ufk[3]= 211  Syst.Var:ufk[4]= 0
        Syst.Var:ufk[5]= 716  
        Syst.Var:ufk[6]= 1342 
        Syst.Var:ufk[7]= 2354 
        Syst.Var:ufk[8]= 8 
      ...
      ELSE IF order = 2 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) msowner.CLI WITH FRAME sel.
      END.

      IF order = 3 THEN DO:
        choose row msowner.Imsi {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) msowner.Imsi WITH FRAME sel.
      END.
    ...
    /* Search by col 3 */
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"5,f5") > 0 THEN DO:  /* call value / detail */
       RUN local-find-this(false).
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"6,f6") > 0 THEN DO:  /* call value / detail */
       RUN local-find-this(false).
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"7,f7") > 0 THEN DO:  /* revive Mobsub */ 
       RUN local-find-this(false).
...
PROCEDURE local-find-FIRST:
      ...
      AND msowner.Brand = Syst.Var:gcBrand NO-LOCK NO-ERROR.
