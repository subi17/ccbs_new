/*--------------------------------------------------------------------
  MODULE .......: YCO-275_upsell_update_monthly_5gb_3m_with_penalty.p
  TASK .........: Activating 5gb upsell for 3 months - RET5GB_3mP_R_UPSELL
  APPLICATION ..: TMS
...
ASSIGN 
   ...
   lcActionId      = "RET5GB_3mP_R_UPSELL"                      /* For execution lock                                   */
   lcTableName     = "RET5GB_3m-with-penalty-Promo"              /* For execution lock                                   */
   ldCurrentTimeTS = Func.Common:mMakeTS()
   lcUpsell        = "RET5GB_3mP_R_UPSELL"                      /* Upsells that will be added in the promo              */
...
ASSIGN 
   lcLogFile    = lcLogDir + "RET5GB_3mP_upsell_5Gb_update_" +
...
PUT STREAM sLogFile UNFORMATTED "RET5GB_3m with penalty 5Gb Activation starts " +
...
PUT STREAM sLogFile UNFORMATTED "RET5GB_3m with penalty 5Gb Activation done " +
