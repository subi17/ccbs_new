...
WITH  overlay row 4 centered
    COLOR VALUE(Syst.Var:cfc)
    TITLE COLOR VALUE(Syst.Var:ctc) ac-hdr  NO-LABELS 
    FRAME lis.
...
BROWSE:
   REPEAT WITH FRAME sel on ENDkey undo, return:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 35  Syst.Var:ufk[2]= 30 Syst.Var:ufk[3]= 0  Syst.Var:ufk[4]= 585
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) VASOper.OperID WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        choose row VASOper.VOName {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) VASOper.VOName WITH FRAME sel.
      END.
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"4,f4") > 0 THEN DO:  /* add */
        RUN local-find-this (false).
