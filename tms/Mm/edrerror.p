...
BROWSE:
   REPEAT WITH FRAME sel on ENDkey undo, return:
      ...
      IF ufkey THEN DO:
        ...
        Syst.CUICommon:ufk[5]= 1961 Syst.CUICommon:ufk[6]= 0 Syst.CUICommon:ufk[7]= 0 Syst.CUICommon:ufk[8]= 8 Syst.CUICommon:ufk[9]= 1
     ...
     IF LOOKUP(Syst.CUICommon:nap,"home,H") > 0 THEN DO:
