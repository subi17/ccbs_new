...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 36  Syst.Var:ufk[2]= 0 Syst.Var:ufk[3]= 2140  Syst.Var:ufk[4]= 0
        Syst.Var:ufk[5]= 0
        Syst.Var:ufk[6]= 0
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) MSISDNNumber.CLI WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW MSISDNNumber.MSISDNType {Syst/uchoose.i} 
        NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) MSISDNNumber.MSISDNType WITH FRAME sel.
      END.
