        ...
        REPEAT TRANSACTION WITH FRAME lis:
           ...
           VALIDATE
              ...
              NOT CAN-FIND(Service using  Service.Service WHERE
                           Service.Brand = Syst.Var:gcBrand ),
...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 35  Syst.Var:ufk[2]= 30 Syst.Var:ufk[3]= 252 Syst.Var:ufk[4]= 927
      ...
      ELSE IF order = 2 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) Service.SEName WITH FRAME sel.
      END.
    ...
    /* UPDATE memo */
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"3,f3") > 0 THEN DO TRANS:  /* ServComponents */
       RUN local-find-this(FALSE).                                        
       RUN Mm/servcom.p(Service.Service).
       ufkey = TRUE.
       NEXT LOOP.
     END.
