/*--------------------------------------------------------------------
  MODULE .......: YCO-275_upsell_update_monthly_5gb_6m_with_penalty.p
  TASK .........: Activating 5gb upsell for 6 months - RET5GB_6mP_R_UPSELL
  APPLICATION ..: TMS
...
ASSIGN 
   ...
   lcActionId      = "RET5GB_6mP_R_UPSELL"                      /* For execution lock                                   */
   lcTableName     = "RET5GB_6m-with-penalty-Promo"              /* For execution lock                                   */
   ldCurrentTimeTS = Func.Common:mMakeTS()
   lcUpsell        = "RET5GB_6mP_R_UPSELL"                      /* Upsells that will be added in the promo              */
   ldCampaignStart = fCParamDe("YCO-275-RET5GB_6m-FromDate")   /* Promotion start date                                 */
   ldCampaignEnd   = fCParamDe("YCO-275-RET5GB_6m-ToDate").    /* Promotion end date                                   */
...
ASSIGN 
   lcLogFile    = lcLogDir + "RET5GB_6mP_upsell_5Gb_update_" +
...
PUT STREAM sLogFile UNFORMATTED "RET5GB_6m with penalty 5Gb Activation starts " +
...
PUT STREAM sLogFile UNFORMATTED "RET5GB_6m with penalty 5Gb Activation done " +
