/* ----------------------------------------------------------------------
  MODULE .......: TermMobSubfind.p
  TASK .........: find TermMobSub with customer 
  APPLICATION ..: nn
  AUTHOR .......: 
  CREATED ......: 
  CHANGED ......: 10.10.2007 termmobsub in lowercase
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
     ...
     ELSE IF LOOKUP(nap,"2,f2") > 0 AND lcRight = "RW" THEN DO:  
        ...
        IF icCriteria      = "ID" OR 
           ...
           RUN Mm/termmobsub(Customer.CustNum, "AGREEMENT").
        ELSE IF icCriteria = "UserName" THEN
           RUN Mm/termmobsub(Customer.CustNum, "USER").
