...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) prepcdr.DateSt WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW prepcdr.BillCode {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) prepcdr.BillCode WITH FRAME sel.
      END.
      ...
      ELSE IF order = 5 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) prepcdr.GsmBnr WITH FRAME sel.
      END.
