...
FIND FIRST company where company.Brand = Syst.Var:gcBrand no-lock.
...
WITH centered OVERLAY scroll 1 13 DOWN ROW 2
    color value(Syst.Var:cfc) title color value(Syst.Var:ctc) " CHOOSE MEMBERS INTO GROUP " FRAME sel.
