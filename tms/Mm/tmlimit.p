...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF rtab[FRAME-LINE] = ? THEN DO:
        ...
        IF LOOKUP(Syst.CUICommon:nap,"8,f8") > 0 THEN LEAVE LOOP.
     ...
     END.   
      ...
      ELSE IF LOOKUP(Syst.CUICommon:nap,"f4") > 0 AND Syst.CUICommon:ufk[4] > 0 THEN DO:
