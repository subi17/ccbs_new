...
form /* seek  RoamZone */
    RoamZone
    HELP "Enter RoamZone  "
    WITH row 4 col 2 TITLE COLOR VALUE(Syst.Var:ctc) " FIND ROAMZONE "
...
BROWSE:
   REPEAT WITH FRAME sel on ENDkey undo, return:
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) RoamZone.RoamZone WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        choose row RoamZone.RZName {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) RoamZone.RZName WITH FRAME sel.
      END.
