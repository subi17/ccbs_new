...
FORM
   ...
   ttDocs.Source        FORMAT "X(30)"  COLUMN-LABEL "Source"
...
PROCEDURE local-find-this:
    ...
    IF exlock THEN
      FIND ttDocs WHERE recid(ttDocs) = rtab[frame-line(sel)] EXCLUSIVE-LOCK.
    ELSE
       FIND ttDocs WHERE recid(ttDocs) = rtab[frame-line(sel)] NO-LOCK.
