...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.CUICommon:ufk[1]= 973  Syst.CUICommon:ufk[2]= 0 Syst.CUICommon:ufk[3]= 1131 Syst.CUICommon:ufk[4]= 0
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.CUICommon:ccc) EPMember.EpGroup WITH FRAME sel.
      END.
