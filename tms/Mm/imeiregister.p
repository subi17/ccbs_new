...
FORM 
    ...
    HELP "Enter IMEI"
    WITH row 4 col 2 TITLE COLOR VALUE(Syst.Var:ctc) " FIND IMEI "
...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) IMEIRegister.IMEI WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW IMEIRegister.BillCode {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) IMEIRegister.BillCode WITH FRAME sel.
      END.
