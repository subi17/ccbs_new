...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
     ...
     ELSE IF (LOOKUP(Syst.CUICommon:nap,"2,f2") > 0 OR LOOKUP(Syst.CUICommon:nap, "enter,return") > 0)
     ...
     ELSE IF LOOKUP(Syst.CUICommon:nap,"5,f5") > 0 AND Syst.CUICommon:ufk[5] > 0 AND lcRight = "RW" THEN DO:
     /* add */
        must-add= TRUE.
        NEXT LOOP.
     END.
