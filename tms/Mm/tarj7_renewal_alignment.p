...
DEF VAR liCurrentServiceClass AS INTEGER NO-UNDO.
...
FOR FIRST ServiceLimit NO-LOCK WHERE
   ...
   IF liCurrentServiceClass EQ 303 THEN DO:
      PUT STREAM sout UNFORMATTED
         MobSub.custnum ";"
         MobSub.MsSeq ";"
         Mobsub.cli ";"
         ...
         ldaExpDate ";"
         liCurrentServiceClass ";"
         "SKIPPED:Current SC in AIR is already 303" skip.
      NEXT.
   END.

   IF liCurrentServiceClass NE 3 THEN DO:
      PUT STREAM sout UNFORMATTED
         MobSub.custnum ";"
         MobSub.MsSeq ";"
         Mobsub.cli ";"
         ...
         ldaExpDate ";"
         liCurrentServiceClass ";"
         "ERROR:Current SC in AIR is not 3" skip.
      liErrors = liErrors + 1.
      NEXT.
   END.
