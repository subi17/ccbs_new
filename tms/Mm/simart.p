...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.CUICommon:ufk[1]= 35  Syst.CUICommon:ufk[2]= 30 Syst.CUICommon:ufk[3]= 208 Syst.CUICommon:ufk[4]= 202
      ...
      ELSE IF order = 2 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.CUICommon:ccc) SimArt.SAName WITH FRAME sel.
      END.
     ...
     ELSE IF LOOKUP(Syst.CUICommon:nap,"3,f3") > 0 THEN DO TRANSACTION:  /* DET. BAL */
       ufkey = TRUE. 
     ...
     ELSE IF LOOKUP(Syst.CUICommon:nap,"4,f4") > 0 THEN DO TRANSACTION:  /* DET. BAL */
       ufkey = TRUE. Syst.CUICommon:ufk = 0. Syst.CUICommon:ehto = 3. RUN Syst/ufkey.p.
       FIND SimArt WHERE recid(SimArt) = rtab[FRAME-LINE] NO-LOCK. 
       PAUSE 0.
