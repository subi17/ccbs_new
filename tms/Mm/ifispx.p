...
form /* seek Spex  BY  Mancode */
    ...
    WITH row 4 col 2 title COLOR VALUE(Syst.Var:ctc) " FIND MANUFACTURER "
         ...
         EDITING:
            ...
            DO WITH FRAME lis:
               ...
               DO:
                  ...
                  DO:
                     FIND IFiSpx where 
                        ifispx.Brand   = Syst.Var:gcBrand AND 
            ...
            END.      
            CREATE IFiSpx.
            ASSIGN IFIspx.Brand   = Syst.Var:gcBrand 
...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      DO:
         ASSIGN
            Syst.Var:ufk[1]= 215  Syst.Var:ufk[2]= 0 Syst.Var:ufk[3]= 0   Syst.Var:ufk[4] = 0
            Syst.Var:ufk[5]= 5    Syst.Var:ufk[6]= 4 Syst.Var:ufk[7]= 0   Syst.Var:ufk[8]= 8 Syst.Var:ufk[9]= 1
            Syst.Var:ehto = 3 ufkey = FALSE.
            {Syst/uright1.i '"5,6"'}  
         IF NOT llIsAdmin THEN ASSIGN  Syst.Var:ufk[5]= 0    Syst.Var:ufk[6]= 0. 
         RUN Syst/ufkey.p.
      END.
      ...
      DO:
         ...
         COLOR DISPLAY VALUE(Syst.Var:ccc) IFiSpx.ManCode WITH FRAME sel.
      END.
      ...
      /* Search BY column 1 */
      ELSE IF LOOKUP(Syst.Var:nap,"1,f1") > 0 THEN 
      ...
      ELSE IF LOOKUP(Syst.Var:nap,"5,f5") > 0 AND llIsAdmin THEN 
      DO:  /* add */
         {Syst/uright2.i}
         must-add = TRUE.
         NEXT LOOP.
      ...
      ELSE IF LOOKUP(Syst.Var:nap,"6,f6") > 0 AND llIsAdmin THEN 
      ...
      ELSE IF LOOKUP(Syst.Var:nap,"enter,return") > 0  AND llIsAdmin THEN
