...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.CUICommon:ufk[1]= 35  Syst.CUICommon:ufk[2]= 30 Syst.CUICommon:ufk[3]= 0 Syst.CUICommon:ufk[4]= 207
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.CUICommon:ccc) Stock.Stock WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW Stock.StoName {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.CUICommon:ccc) Stock.StoName WITH FRAME sel.
      END.
     ...
     ELSE IF LOOKUP(Syst.CUICommon:nap,"4,f4") > 0 THEN DO:  /* CONTAINS ... */
       ufkey = TRUE.              
       RUN local-find-this (FALSE).
