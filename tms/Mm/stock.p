...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 35  Syst.Var:ufk[2]= 30 Syst.Var:ufk[3]= 0 Syst.Var:ufk[4]= 207
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) Stock.Stock WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW Stock.StoName {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) Stock.StoName WITH FRAME sel.
      END.
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"1,f1") > 0 THEN DO ON ENDKEY UNDO, NEXT LOOP:
       ...
       UPDATE lcBrand WHEN Syst.Var:gcAllBrand = TRUE Stock WITH FRAME f1.
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"4,f4") > 0 THEN DO:  /* CONTAINS ... */
       ufkey = TRUE.              
       RUN local-find-this (FALSE).
