...
REPEAT WITH FRAME sel:
   ...
   IF must-add THEN DO:  /* Add a CTServEl  */
      ...
      REPEAT WITH FRAME lis ON ENDKEY UNDO ADD-ROW, LEAVE ADD-ROW.
        ...
        REPEAT TRANSACTION WITH FRAME lis:
           ...
           CREATE CTServEl.
           ASSIGN
           CTServEl.Brand    = Syst.Var:gcBrand
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 0  Syst.Var:ufk[2]= 0 Syst.Var:ufk[3]= 0 Syst.Var:ufk[4]= 2350.
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) CTServEl.ServCom WITH FRAME sel.
      END.
     ...
     THEN DO TRANSACTION:  /* DELETE */
       ...
       IF ok THEN DO:
           ...
           WHERE CTServEl.ServPac = ServPac AND CTServEl.Brand = Syst.Var:gcBrand) 
           THEN DO:
