/* ----------------------------------------------------------------------
  MODULE .......: StoBal2.p
  TASK .........: UPDATE /Browse Stock Balances (one Stock / many articls)
  APPLICATION ..: nn
  AUTHOR .......: pt
  CREATED ......: 01-06-99
...
/*   IF lcRight NE "RW" THEN DO: */
      MESSAGE "No stock articles available !" VIEW-AS ALERT-BOX.
      RETURN.
/*   END.
   ASSIGN
      Memory       = ?
        ...
        DO TRANSACTION:
           ...
           IF CAN-FIND(FIRST StoBal WHERE
              ...
              MESSAGE "Balance Record " + p-Stock + " already exists for Sim Article " +
                      STRING(StoBal.SimArt) + " !".
              LEAVE ADD-ROW.
           END. /* IF CAN-FIND(FIRST StoBal WHERE */
...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.CUICommon:ufk[1]= 204  Syst.CUICommon:ufk[2]= 0   Syst.CUICommon:ufk[3]= 0 Syst.CUICommon:ufk[4]= 202
...
PROCEDURE local-find-others.
   FIND SimArt WHERE SimArt.SimArt = StoBal.SimArt no-lock no-error.
END PROCEDURE.
...
PROCEDURE local-UPDATE-record:
   ...
   FIND CURRENT StoBal EXCLUSIVE-LOCK.

   IF CURRENT-CHANGED StoBal THEN DO:
      FIND CURRENT StoBal NO-LOCK.
