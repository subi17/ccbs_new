...
WITH ROW FrmRow width 80 OVERLAY FrmDown  DOWN
    ...
    TITLE COLOR VALUE(Syst.Var:ctc) " " + Syst.Var:ynimi +
       " Service Update Rules "  + string(TODAY,"99-99-99") + " "
    FRAME sel.
...
form /* seek  ScUpdRule */
    ...
    WITH row 4 col 2 TITLE COLOR VALUE(Syst.Var:ctc) " FIND Updated Service "
...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 70  Syst.Var:ufk[2]= 71 Syst.Var:ufk[3]= 0  Syst.Var:ufk[4]= 0
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) ScUpdRule.ServCom WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW ScUpdRule.UpdServCom {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) ScUpdRule.UpdServCom WITH FRAME sel.
      END.
            ...
            THEN DO WITH FRAME lis:
               ...
               IF FRAME-FIELD = "UpdServCom" THEN DO:
                  ...
                  IF CAN-FIND(FIRST bScUpdRule WHERE
                     bScUpdRule.Brand      = Syst.Var:gcBrand                    AND 
