...
form /* seek Billable item  BY  CLI */
    CLI
    HELP "Enter CLI No."
    WITH row 4 col 2 TITLE COLOR VALUE(Syst.Var:ctc) " FIND CLI. NO "
...
WHERE FATime.Brand = Syst.Var:gcBrand NO-LOCK NO-ERROR.
...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 714 Syst.Var:ufk[2]= 209 Syst.Var:ufk[3]= 2150 Syst.Var:ufk[4]= 927
        Syst.Var:ufk[5]= (IF lcRight = "RW" THEN 5 ELSE 0)
        Syst.Var:ufk[6]= (IF lcRight = "RW" THEN 4 ELSE 0)
        Syst.Var:ufk[7] = 1752 Syst.Var:ufk[8]= 8 Syst.Var:ufk[9]= 1
        Syst.Var:ehto = 3 ufkey = FALSE.

        IF iiCustNum > 0  THEN ASSIGN Syst.Var:ufk[1] = 0
                                      Syst.Var:ufk[5] = 0.
        IF icCLI     > "" THEN ASSIGN Syst.Var:ufk[1] = 0
                                      Syst.Var:ufk[2] = 0.
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) FATime.custnum WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW FATime.cli {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) FATime.cli WITH FRAME sel.
      END.
      IF order = 3 THEN DO:
        CHOOSE ROW liTransPeriod {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) liTransPeriod WITH FRAME sel.
      END.
...
PROCEDURE local-find-FIRST:
   ...
   ELSE DO:
       ...
       FIND FIRST FATime USE-INDEX InvNum WHERE 
                  FATime.Brand = Syst.Var:gcBrand NO-LOCK NO-ERROR.
...
PROCEDURE local-UPDATE-record:
   ...
   REPEAT ON ENDKEY UNDO, LEAVE:
      ...
      IF NEW Fatime THEN Syst.Var:toimi = 1.
      ELSE DO: 
         ASSIGN 
            Syst.Var:ehto   = 0
            Syst.Var:ufk    = 0
