...
WITH ROW FrmRow centered OVERLAY FrmDown  DOWN
    ...
    TITLE COLOR VALUE(Syst.Var:ctc)  " Services of MobSub " + MobSub.CLI + " "
    FRAME sel.
...
WITH  OVERLAY ROW 6 centered
    COLOR VALUE(Syst.Var:cfc)
    TITLE COLOR VALUE(Syst.Var:ctc) "UPDATE TO HLR" 
    SIDE-LABELS 
...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.Var:ufk[1]= 245  Syst.Var:ufk[2]= 246 Syst.Var:ufk[3]= 2350 
        Syst.Var:ufk[4]= (IF lcRight = "RW" THEN 248 ELSE 0)
        Syst.Var:ufk[5]= (IF lcRight = "RW" THEN 60 ELSE 0) 
        Syst.Var:ufk[6]= 66
        Syst.Var:ufk[7]= 781  
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"3,f3") > 0 AND Syst.Var:ufk[3] > 0 THEN DO:  
        ...
        IF AVAILABLE ttSubSer THEN DO:
           ...
           ELSE DO:
               ...
               IF NOT llStop THEN 
                   RUN Mm/subserpara.p (INPUT-OUTPUT TABLE ttSubserPara,
                                                      ttSubSer.MsSeq,
                                                      ttSubSer.ServCom).
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"4,f4") > 0 AND Syst.Var:ufk[4] > 0 THEN DO:  /* COPY */
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"6,f6") > 0 AND Syst.Var:ufk[6] > 0 THEN DO:  /* history */
        ...
        NEXT LOOP.
     END.
     ELSE IF LOOKUP(Syst.Var:nap,"7,f7") > 0 AND Syst.Var:ufk[7] > 0 THEN DO:  /* history */
        RUN local-find-this(FALSE).
   ...
   */ 
   ...
   IF CAN-FIND(FIRST ttRequest) THEN DO:
      ...
      FOR EACH ttRequest:
         ...
         RUN Mm/runreqim.p(ttRequest.ReqID).
