...
BROWSE:
   REPEAT WITH FRAME sel on ENDkey undo, return:
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) bnet.BnetCode WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        choose row bnet.BnetName {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) bnet.BnetName WITH FRAME sel.
      END.
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"1,f1") > 0 THEN DO on ENDkey undo, NEXT LOOP:
       ...
       SET   lcBrand WHEN Syst.Var:gcAllBrand = TRUE  BnetCode WITH FRAME f1.
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"2,f2") > 0 THEN DO on ENDkey undo, NEXT LOOP:
       ...
       SET  lcBrand WHEN Syst.Var:gcAllBrand = TRUE BnetName WITH FRAME f2.
