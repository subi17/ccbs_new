...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ASSIGN
        Syst.CUICommon:ufk[1]= 28   Syst.CUICommon:ufk[2]= 209 Syst.CUICommon:ufk[3]= 559 Syst.CUICommon:ufk[4]= 0
        Syst.CUICommon:ufk[5]= 265  
     ...
     ELSE IF LOOKUP(Syst.CUICommon:nap,"enter,return,5,f5") > 0 THEN  DO WITH FRAME lis:
       ...
       ASSIGN
          Syst.CUICommon:ufk = 0 Syst.CUICommon:ufk[8] = 8 Syst.CUICommon:ehto = 0 ufkey = TRUE. 
       RUN Syst/ufkey.p.
       HIDE FRAME lis NO-PAUSE.
       NEXT loop.
