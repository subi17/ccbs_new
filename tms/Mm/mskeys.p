...
find first mobsub no-lock where mobsub.cli = "0468384600".
...
find mobsub no-lock where mobsub.msseq = ipMsseq.
...
ADD-ROW:
      ...
      /* is there ANY record ? */
      FIND FIRST userkeys
      WHERE userkeys.key = mobsub.cli NO-LOCK NO-ERROR.
...
BROWSE:
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.CUICommon:ccc) userkeys.usercode WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW userkeys.keytype {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.CUICommon:ccc) userkeys.keytype WITH FRAME sel.
      END.
     ...
     ELSE IF LOOKUP(nap,"1,f1") > 0 THEN DO ON ENDKEY UNDO, NEXT LOOP:
       ...
       IF usercode ENTERED THEN DO:
          ...
          AND userkeys.key = mobsub.cli NO-LOCK NO-ERROR.
          IF NOT AVAILABLE userkeys THEN DO:
             BELL.
             MESSAGE "NOT FOUND !".
             PAUSE 1 NO-MESSAGE.
     ...
     ELSE IF LOOKUP(nap,"2,f2") > 0 THEN DO ON ENDKEY UNDO, NEXT LOOP:
       ...
       IF keytype ENTERED THEN DO:
          ...
          AND userkeys.key = mobsub.cli USE-INDEX keytype NO-LOCK NO-ERROR.
          IF NOT AVAILABLE userkeys THEN DO:
     ...
     ELSE IF LOOKUP(nap,"6,f6") > 0 THEN DO TRANSACTION:  /* DELETE */
       ...
       IF ok THEN DO:
           ...
           WHERE userkeys.key = mobsub.cli) THEN DO:
