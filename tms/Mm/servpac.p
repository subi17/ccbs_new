...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ...
        Syst.Var:ufk[5]= (IF lcRight = "RW" AND icCLIType = "" THEN 5 ELSE 0) 
        Syst.Var:ufk[6]= (IF lcRight = "RW" AND icCLIType = "" THEN 4 ELSE 0)
        Syst.Var:ufk[7]= 814
        Syst.Var:ufk[8]= 8
      ...
      ELSE IF order = 2 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) ServPac.SPName WITH FRAME sel.
      END.
     ...
     ELSE IF LOOKUP(Syst.Var:nap,"3,f3") > 0 THEN DO:  /* Package Contains */
       RUN local-find-this(FALSE).                                        
