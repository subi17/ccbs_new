...
/* ----------------------------------------------------------------------
  ...
  CHANGED ......: 07-10-99 jp urights added
                  ...
                  07.12.04/aam icCLIType,
                               ...
                               FeeModel removed
                  27.03.07/aam don't RUN Mm/ctservel.p from here
  Version ......: M15
  ---------------------------------------------------------------------- */
...
REPEAT WITH FRAME sel:
   ...
   REPEAT WITH FRAME sel ON ENDKEY UNDO, RETURN:
      ...
      IF ufkey THEN DO:
        ...
        Syst.CUICommon:ufk[5]= (IF lcRight = "RW" AND icCLIType = "" THEN 5 ELSE 0) 
        Syst.CUICommon:ufk[6]= (IF lcRight = "RW" AND icCLIType = "" THEN 4 ELSE 0)
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.CUICommon:ccc) ServPac.ServPac WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        CHOOSE ROW ServPac.SPName {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.CUICommon:ccc) ServPac.SPName WITH FRAME sel.
      END.
     ...
     ELSE IF LOOKUP(Syst.CUICommon:nap,"3,f3") > 0 THEN DO:  /* Package Contains */
       RUN local-find-this(FALSE).                                        
       
       /* either general elements */
       IF icCLIType = "" 
       THEN RUN Mm/servel.p(ServPac.ServPac).
     ...
     ELSE IF LOOKUP(Syst.CUICommon:nap,"7,f7") > 0 AND Syst.CUICommon:ufk[7] > 0 THEN DO:  
        ...
        RUN Mc/invlang.p(12,ServPac.ServPac).
