...
form /* seek PreselErr  by PSEName */
    ...
    WITH row 4 col 2 TITLE COLOR VALUE(Syst.Var:ctc) " FIND BankOffice "
...
BROWSE:
   REPEAT WITH FRAME sel on ENDkey undo, retuRN:
      ...
      IF order = 1 THEN DO:
        ...
        COLOR DISPLAY VALUE(Syst.Var:ccc) PreselErr.PSError WITH FRAME sel.
      END.
      ELSE IF order = 2 THEN DO:
        choose row PreselErr.PSEName {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) PreselErr.PSEName WITH FRAME sel.
      END.
/*    IF order = 3 THEN DO:
        choose row PreselErr.?? {Syst/uchoose.i} NO-ERROR WITH FRAME sel.
        COLOR DISPLAY VALUE(Syst.Var:ccc) PreselErr.?? WITH FRAME sel.
      END.
