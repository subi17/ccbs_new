/* -----------------------------------------------
  MODULE .......: NNMORA.P
  TEHTAVA ......: Maa/operaattori raportin print-linerajojen kysyminen
  APPLICATION ..: NN
  TEKIJA .......: TT
  CREATED ......: 06.09.96
  changePVM ....:
...
form
   skip(1)
"   INSTRUKTION: Detta program utskriver pA printern 'Land/operatOr" skip
"                rapport' med valda kriterier. (Ej kriterier = ALLT)."
   skip(14)
   WITH ROW 1 side-labels width 80
   title " " + Syst.CUICommon:ynimi + " LAND/OPERATOR RAPPORT " +
...
form
   ...
   "InstDuePeriod (AAMM) .....:"
   kausi1 TO 37 NO-LABEL
   help "Period, vilken listas ut" skip(1)
