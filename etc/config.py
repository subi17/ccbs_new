...
rpcs           = { 'cctool': 'topup', 'dextra': 'dextra', 'masmovil': 'dextra', 'heat': 'heat', 'mnp': 'mnp', 'newton': 'newton', 'selfservice': 'selfservice', 'topup': 'topup', 'viptool': 'topup', 'mnp_mock': 'mnp_mock', 'bss': 'bss'}
wwwrealm       = 'yes'
